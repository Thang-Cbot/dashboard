...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 23:01 ICT ngày 02/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$95.72 / thùng** | **+1.13%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$95.72` (+1.13%)** | DXY: **`99.55` (-0.12%)** | Lúa mì CBOT: **`784.50¢` (+2.75%)**.
...
*Cập nhật tự động lúc 23:01 ICT ngày 02/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **02/09/2026** | **ZC** | **545.00 ¢** | **547.15 ¢ (+2.15)** | 🐂 Bullish (540.14 > 538.74) | 4.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-02092026) |
| **02/09/2026** | **ZW** | **784.75 ¢** | **789.45 ¢ (+4.70)** | 🐂 Bullish (775.79 > 773.05) | 11.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-02092026) |
| **02/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **536.25 - 540.14 cents (Canh mua vùng hỗ trợ)** | **452.19 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `549.00 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **549.75 - 551.25 cents** | **469.80 cents (Chống quét SL tuyệt đối)** | **563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **563.25 - 564.75 cents** | **566.45 cents** | **474.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **443.75 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **775.79 - 773.05 cents (Canh bán hồi kỹ thuật H1)** | **805.77 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `774.75 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **772.75 - 774.75 cents** | **638.07 cents** | **789.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **789.75 - 791.75 cents** | **796.93 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **616.52 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 545.00 cents | **Dự báo Chốt Phiên:** **`547.15 cents`** (+2.15).
*   **Thanh khoản phiên chốt:** Volume: **`214,957`** (Chênh lệch: **`-66,361`**) | OI: **`1,005,007`** (Chênh lệch: **`+132`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$95.72** | **+1.13%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (540.14) > `EMA_50` (538.74).
*   **Động lượng & Dao động:** RSI (14) = **`61.56`** | ATR (14) = **`3.37`** cents | Volatility = **`4.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`536.25`** | S2: **`457.25`** || Kháng cự R1: **`549.00`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`536.25 - 540.14 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.19 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `549.00 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`549.75 - 551.25 cents`** | SL: **`469.80 cents (Chống quét SL tuyệt đối)`** | TP: **`563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`563.25 - 564.75 cents`** | SL: **`566.45 cents`** | TP: **`474.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`443.75 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 784.75 cents | **Dự báo Chốt Phiên:** **`789.45 cents`** (+4.70).
*   **Thanh khoản phiên chốt:** Volume: **`67,558`** (Chênh lệch: **`-48,042`**) | OI: **`274,173`** (Chênh lệch: **`-8`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$95.72** | **+1.13%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (775.79) > `EMA_50` (773.05).
*   **Động lượng & Dao động:** RSI (14) = **`62.74`** | ATR (14) = **`7.18`** cents | Volatility = **`11.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`774.75`** | S2: **`645.25`** || Kháng cự R1: **`789.75`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`775.79 - 773.05 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`805.77 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `774.75 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`772.75 - 774.75 cents`** | SL: **`638.07 cents`** | TP: **`789.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`789.75 - 791.75 cents`** | SL: **`796.93 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`616.52 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 784.75 | 796.00 | 779.25 | **784.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | Asia 11-15 | 784.00 | 791.50 | 778.00 | **783.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 783.50 | 797.25 | 768.75 | **785.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 785.50 | 798.75 | 777.25 | **786.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 786.75 | 803.25 | 776.25 | **791.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 791.25 | 799.00 | 780.25 | **792.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 792.50 | 800.75 | 782.00 | **794.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 794.25 | 806.50 | 784.50 | **793.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 793.25 | 803.75 | 778.50 | **795.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 795.50 | 806.00 | 789.25 | **796.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 796.25 | 810.50 | 781.50 | **798.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 798.25 | 804.75 | 791.50 | **798.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 798.50 | 808.75 | 790.50 | **799.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 11-15 | 799.00 | 806.00 | 793.00 | **798.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 798.25 | 811.75 | 785.25 | **800.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 800.00 | 809.25 | 789.25 | **800.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 800.50 | 812.75 | 786.25 | **799.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | NY Close 23-01 | 799.00 | 806.00 | 789.50 | **799.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Asia 07-11 | 799.50 | 810.00 | 792.25 | **799.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 799.25 | 809.00 | 789.50 | **799.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 799.75 | 810.50 | 792.50 | **800.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 800.50 | 807.00 | 792.00 | **801.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 801.00 | 812.00 | 789.25 | **804.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 804.50 | 810.00 | 796.75 | **805.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 805.25 | 814.50 | 798.75 | **804.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 804.50 | 812.00 | 798.50 | **803.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 803.50 | 810.50 | 790.00 | **804.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 804.25 | 813.50 | 797.00 | **804.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 804.00 | 812.50 | 790.00 | **805.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 805.75 | 812.00 | 799.25 | **805.00** | **-0.75¢** 🔴 | 🔴 BEAR |
