...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 12:01 ICT ngày 07/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$83.87 / thùng** | **+1.67%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$83.87` (+1.67%)** | DXY: **`99.95` (-0.02%)** | Lúa mì CBOT: **`632.00¢` (+0.12%)**.
...
*Cập nhật tự động lúc 12:01 ICT ngày 07/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **07/08/2026** | **ZC** | **441.75 ¢** | **442.71 ¢ (+0.96)** | 🐻 Bearish (438.53 < 439.65) | 0.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-07082026) |
| **07/08/2026** | **ZW** | **632.00 ¢** | **633.33 ¢ (+1.33)** | 🐻 Bearish (636.39 < 640.13) | 1.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-07082026) |
| **07/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **440.50 - 438.53 cents (Canh mua vùng hỗ trợ)** | **421.85 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `444.50 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **439.00 - 440.50 cents** | **422.90 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **444.50 - 446.00 cents** | **446.60 cents** | **426.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **435.79 - 444.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **636.39 - 640.13 cents (Canh bán hồi kỹ thuật H1)** | **716.79 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `629.25 cents` \| TP2: `600.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **647.00 - 649.00 cents** | **610.83 cents** | **653.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **653.50 - 655.50 cents** | **657.17 cents** | **614.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **599.81 - 614.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 441.75 cents | **Dự báo Chốt Phiên:** **`442.71 cents`** (+0.96).
*   **Thanh khoản phiên chốt:** Volume: **`2,967`** (Chênh lệch: **`+401`**) | OI: **`479,387`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$83.87** | **+1.67%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (438.53) < `EMA_50` (439.65).
*   **Động lượng & Dao động:** RSI (14) = **`63.43`** | ATR (14) = **`2.10`** cents | Volatility = **`0.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`440.50`** | S2: **`425.00`** || Kháng cự R1: **`444.50`** | R2: **`468.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`440.50 - 438.53 cents (Canh mua vùng hỗ trợ)`** | SL: **`421.85 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `444.50 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`439.00 - 440.50 cents`** | SL: **`422.90 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`444.50 - 446.00 cents`** | SL: **`446.60 cents`** | TP: **`426.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`435.79 - 444.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 632.00 cents | **Dự báo Chốt Phiên:** **`633.33 cents`** (+1.33).
*   **Thanh khoản phiên chốt:** Volume: **`5,187`** (Chênh lệch: **`+1,446`**) | OI: **`175,453`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$83.87** | **+1.67%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (636.39) < `EMA_50` (640.13).
*   **Động lượng & Dao động:** RSI (14) = **`41.06`** | ATR (14) = **`3.69`** cents | Volatility = **`1.75 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`636.39 - 640.13 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`716.79 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `629.25 cents` / `600.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`647.00 - 649.00 cents`** | SL: **`610.83 cents`** | TP: **`653.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`653.50 - 655.50 cents`** | SL: **`657.17 cents`** | TP: **`614.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`599.81 - 614.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 632.00 | 643.25 | 626.50 | **631.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 631.25 | 638.75 | 625.25 | **630.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 630.75 | 644.50 | 616.00 | **632.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 632.75 | 646.00 | 624.50 | **634.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 634.00 | 650.50 | 623.50 | **638.50** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 638.50 | 646.25 | 627.50 | **639.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 639.75 | 648.00 | 629.25 | **641.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 641.50 | 653.75 | 631.75 | **640.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 640.50 | 651.00 | 625.75 | **642.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 642.75 | 653.25 | 636.50 | **643.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 643.50 | 657.75 | 628.75 | **645.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 645.50 | 652.00 | 638.75 | **645.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 645.75 | 656.00 | 637.75 | **646.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 646.25 | 653.25 | 640.25 | **645.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 645.50 | 659.00 | 632.50 | **647.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 647.25 | 656.50 | 636.50 | **647.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 647.75 | 660.00 | 633.50 | **646.25** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 646.25 | 653.25 | 636.75 | **646.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 646.75 | 657.25 | 639.50 | **646.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 646.50 | 656.25 | 636.75 | **647.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 647.00 | 657.75 | 639.75 | **647.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 647.75 | 654.25 | 639.25 | **648.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 648.25 | 659.25 | 636.50 | **651.75** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 651.75 | 657.25 | 644.00 | **652.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 652.50 | 661.75 | 646.00 | **651.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 651.75 | 659.25 | 645.75 | **650.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 650.75 | 657.75 | 637.25 | **651.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 651.50 | 660.75 | 644.25 | **651.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 651.25 | 659.75 | 637.25 | **653.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 653.00 | 659.25 | 646.50 | **652.25** | **-0.75¢** 🔴 | 🔴 BEAR |
