...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 12:22 ICT ngày 01/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$89.16 / thùng** | **-1.47%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.49** | **+0.06%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$89.16` (-1.47%)** | DXY: **`99.49` (+0.06%)** | Lúa mì CBOT: **`774.50¢` (+2.61%)**.
...
*Cập nhật tự động lúc 12:22 ICT ngày 01/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **01/09/2026** | **ZC** | **537.50 ¢** | **538.86 ¢ (+1.36)** | 🐂 Bullish (536.80 > 535.49) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-01092026) |
| **01/09/2026** | **ZW** | **774.50 ¢** | **779.31 ¢ (+4.81)** | 🐂 Bullish (770.94 > 765.14) | 2.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-01092026) |
| **01/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **535.00 - 536.80 cents (Canh mua vùng hỗ trợ)** | **453.09 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `539.75 cents` \| TP2: `542.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **533.50 - 535.00 cents** | **454.48 cents (Chống quét SL tuyệt đối)** | **541.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **539.75 - 541.25 cents** | **542.52 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **446.17 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **770.94 - 765.14 cents (Canh bán hồi kỹ thuật H1)** | **800.18 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `770.00 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **768.00 - 770.00 cents** | **638.63 cents** | **780.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **780.00 - 782.00 cents** | **786.62 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **618.77 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 537.50 cents | **Dự báo Chốt Phiên:** **`538.86 cents`** (+1.36).
*   **Thanh khoản phiên chốt:** Volume: **`16,021`** (Chênh lệch: **`-420,455`**) | OI: **`996,298`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$89.16** | **-1.47%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.49** | **+0.06%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (536.80) > `EMA_50` (535.49).
*   **Động lượng & Dao động:** RSI (14) = **`52.05`** | ATR (14) = **`2.77`** cents | Volatility = **`0.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`535.00`** | S2: **`457.25`** || Kháng cự R1: **`539.75`** | R2: **`542.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`535.00 - 536.80 cents (Canh mua vùng hỗ trợ)`** | SL: **`453.09 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `539.75 cents` / `542.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`533.50 - 535.00 cents`** | SL: **`454.48 cents (Chống quét SL tuyệt đối)`** | TP: **`541.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`539.75 - 541.25 cents`** | SL: **`542.52 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`446.17 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 774.50 cents | **Dự báo Chốt Phiên:** **`779.31 cents`** (+4.81).
*   **Thanh khoản phiên chốt:** Volume: **`6,271`** (Chênh lệch: **`-130,195`**) | OI: **`268,175`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$89.16** | **-1.47%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.49** | **+0.06%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (770.94) > `EMA_50` (765.14).
*   **Động lượng & Dao động:** RSI (14) = **`54.04`** | ATR (14) = **`6.62`** cents | Volatility = **`2.75 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`770.94 - 765.14 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`800.18 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `770.00 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`768.00 - 770.00 cents`** | SL: **`638.63 cents`** | TP: **`780.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`780.00 - 782.00 cents`** | SL: **`786.62 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`618.77 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 774.50 | 785.75 | 769.00 | **773.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | Asia 11-15 | 773.75 | 781.25 | 767.75 | **773.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 773.25 | 787.00 | 758.50 | **775.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 775.25 | 788.50 | 767.00 | **776.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 776.50 | 793.00 | 766.00 | **781.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 781.00 | 788.75 | 770.00 | **782.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 782.25 | 790.50 | 771.75 | **784.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 784.00 | 796.25 | 774.25 | **783.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 783.00 | 793.50 | 768.25 | **785.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 785.25 | 795.75 | 779.00 | **786.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 786.00 | 800.25 | 771.25 | **788.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 788.00 | 794.50 | 781.25 | **788.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 788.25 | 798.50 | 780.25 | **788.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 11-15 | 788.75 | 795.75 | 782.75 | **788.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 788.00 | 801.50 | 775.00 | **789.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 789.75 | 799.00 | 779.00 | **790.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 790.25 | 802.50 | 776.00 | **788.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | NY Close 23-01 | 788.75 | 795.75 | 779.25 | **789.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Asia 07-11 | 789.25 | 799.75 | 782.00 | **789.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 789.00 | 798.75 | 779.25 | **789.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 789.50 | 800.25 | 782.25 | **790.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 790.25 | 796.75 | 781.75 | **790.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 790.75 | 801.75 | 779.00 | **794.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 794.25 | 799.75 | 786.50 | **795.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 795.00 | 804.25 | 788.50 | **794.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 794.25 | 801.75 | 788.25 | **793.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 793.25 | 800.25 | 779.75 | **794.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 794.00 | 803.25 | 786.75 | **793.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 793.75 | 802.25 | 779.75 | **795.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 795.50 | 801.75 | 789.00 | **794.75** | **-0.75¢** 🔴 | 🔴 BEAR |
