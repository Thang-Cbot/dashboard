...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 19:01 ICT ngày 26/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$85.49 / thùng** | **-3.49%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.01** | **+0.09%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$85.49` (-3.49%)** | DXY: **`99.01` (+0.09%)** | Lúa mì CBOT: **`718.75¢` (+4.81%)**.
...
*Cập nhật tự động lúc 19:01 ICT ngày 26/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **26/08/2026** | **ZC** | **529.25 ¢** | **530.51 ¢ (+1.26)** | 🐂 Bullish (524.90 > 519.61) | 2.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-26082026) |
| **26/08/2026** | **ZW** | **718.75 ¢** | **721.71 ¢ (+2.96)** | 🐂 Bullish (709.40 > 705.37) | 6.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-26082026) |
| **26/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **526.75 - 524.90 cents (Canh mua vùng hỗ trợ)** | **454.06 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `528.94 cents` \| TP2: `530.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **525.25 - 526.75 cents** | **455.12 cents (Chống quét SL tuyệt đối)** | **529.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **528.94 - 530.44 cents** | **531.06 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **709.40 - 705.37 cents (Canh bán hồi kỹ thuật H1)** | **735.01 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `715.25 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **713.25 - 715.25 cents** | **640.74 cents** | **726.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **726.50 - 728.50 cents** | **731.01 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **627.23 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 529.25 cents | **Dự báo Chốt Phiên:** **`530.51 cents`** (+1.26).
*   **Thanh khoản phiên chốt:** Volume: **`68,170`** (Chênh lệch: **`-441,602`**) | OI: **`949,574`** (Chênh lệch: **`+2,476`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$85.49** | **-3.49%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.01** | **+0.09%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (524.90) > `EMA_50` (519.61).
*   **Động lượng & Dao động:** RSI (14) = **`66.96`** | ATR (14) = **`2.13`** cents | Volatility = **`2.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`526.75`** | S2: **`457.25`** || Kháng cự R1: **`528.94`** | R2: **`530.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`526.75 - 524.90 cents (Canh mua vùng hỗ trợ)`** | SL: **`454.06 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `528.94 cents` / `530.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`525.25 - 526.75 cents`** | SL: **`455.12 cents (Chống quét SL tuyệt đối)`** | TP: **`529.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`528.94 - 530.44 cents`** | SL: **`531.06 cents`** | TP: **`458.25 cents`**.
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 24/08** | Asia 07-11 | 529.25 | 533.00 | 526.00 | **529.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Asia 11-15 | 529.50 | 532.25 | 525.75 | **529.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 24/08** | London 15-19 | 529.00 | 532.00 | 525.00 | **529.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Pre-NY 19-21 | 529.75 | 534.25 | 524.75 | **530.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Open 21-23 | 530.50 | 536.00 | 524.25 | **532.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Close 23-01 | 532.75 | 535.75 | 528.50 | **533.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 07-11 | 533.00 | 536.25 | 526.50 | **533.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 11-15 | 533.75 | 536.75 | 529.25 | **533.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 25/08** | London 15-19 | 533.25 | 537.25 | 527.50 | **533.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Pre-NY 19-21 | 533.75 | 536.25 | 530.50 | **534.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Open 21-23 | 534.25 | 537.75 | 528.25 | **535.25** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Close 23-01 | 535.25 | 538.00 | 532.75 | **535.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Asia 07-11 | 535.25 | 538.00 | 532.75 | **534.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | Asia 11-15 | 534.75 | 537.75 | 531.50 | **534.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | London 15-19 | 534.50 | 538.50 | 529.25 | **535.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Pre-NY 19-21 | 535.00 | 539.75 | 528.00 | **537.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Open 21-23 | 537.00 | 545.00 | 530.00 | **538.50** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Close 23-01 | 538.50 | 543.00 | 534.25 | **538.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 07-11 | 538.00 | 540.25 | 535.25 | **537.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 11-15 | 537.75 | 539.75 | 533.25 | **538.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | London 15-19 | 538.00 | 541.75 | 535.25 | **538.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | Pre-NY 19-21 | 538.50 | 541.50 | 534.00 | **538.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Open 21-23 | 538.75 | 543.00 | 535.50 | **539.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Close 23-01 | 539.50 | 543.00 | 537.25 | **539.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Asia 07-11 | 539.50 | 543.25 | 536.00 | **539.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | Asia 11-15 | 539.25 | 542.75 | 536.00 | **539.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | London 15-19 | 539.00 | 542.00 | 536.25 | **539.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Pre-NY 19-21 | 539.25 | 542.25 | 536.50 | **539.25** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 28/08** | NY Open 21-23 | 539.25 | 543.25 | 535.75 | **539.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | NY Close 23-01 | 539.75 | 543.75 | 538.00 | **539.50** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 718.75 cents | **Dự báo Chốt Phiên:** **`721.71 cents`** (+2.96).
*   **Thanh khoản phiên chốt:** Volume: **`19,486`** (Chênh lệch: **`-73,849`**) | OI: **`256,877`** (Chênh lệch: **`+1,046`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
*   **Dòng tiền (Volume + OI):** **`Tăng nhẹ tích lũy (Accumulation Rally)`**
*   **Đánh giá xu hướng kết hợp:** 📈 **TÍCH LŨY TÍCH CỰC (Accumulation):** Nến đi ngang nhưng dòng tiền âm thầm gia tăng (OI tăng), báo hiệu chuẩn bị có nhịp bứt phá tăng.
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$85.49** | **-3.49%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.01** | **+0.09%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (709.40) > `EMA_50` (705.37).
*   **Động lượng & Dao động:** RSI (14) = **`65.68`** | ATR (14) = **`4.51`** cents | Volatility = **`6.25 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`709.40 - 705.37 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`735.01 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `715.25 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`713.25 - 715.25 cents`** | SL: **`640.74 cents`** | TP: **`726.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`726.50 - 728.50 cents`** | SL: **`731.01 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`627.23 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 24/08** | Asia 07-11 | 718.75 | 730.00 | 713.25 | **718.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 24/08** | Asia 11-15 | 718.00 | 725.50 | 712.00 | **717.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 24/08** | London 15-19 | 717.50 | 731.25 | 702.75 | **719.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Pre-NY 19-21 | 719.50 | 732.75 | 711.25 | **720.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Open 21-23 | 720.75 | 737.25 | 710.25 | **725.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Close 23-01 | 725.25 | 733.00 | 714.25 | **726.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 07-11 | 726.50 | 734.75 | 716.00 | **728.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 11-15 | 728.25 | 740.50 | 718.50 | **727.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 25/08** | London 15-19 | 727.25 | 737.75 | 712.50 | **729.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Pre-NY 19-21 | 729.50 | 740.00 | 723.25 | **730.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Open 21-23 | 730.25 | 744.50 | 715.50 | **732.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Close 23-01 | 732.25 | 738.75 | 725.50 | **732.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Asia 07-11 | 732.50 | 742.75 | 724.50 | **733.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Asia 11-15 | 733.00 | 740.00 | 727.00 | **732.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | London 15-19 | 732.25 | 745.75 | 719.25 | **734.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Pre-NY 19-21 | 734.00 | 743.25 | 723.25 | **734.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Open 21-23 | 734.50 | 746.75 | 720.25 | **733.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | NY Close 23-01 | 733.00 | 740.00 | 723.50 | **733.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | Asia 07-11 | 733.50 | 744.00 | 726.25 | **733.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 11-15 | 733.25 | 743.00 | 723.50 | **733.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | London 15-19 | 733.75 | 744.50 | 726.50 | **734.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | Pre-NY 19-21 | 734.50 | 741.00 | 726.00 | **735.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Open 21-23 | 735.00 | 746.00 | 723.25 | **738.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Close 23-01 | 738.50 | 744.00 | 730.75 | **739.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Asia 07-11 | 739.25 | 748.50 | 732.75 | **738.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | Asia 11-15 | 738.50 | 746.00 | 732.50 | **737.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | London 15-19 | 737.50 | 744.50 | 724.00 | **738.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Pre-NY 19-21 | 738.25 | 747.50 | 731.00 | **738.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | NY Open 21-23 | 738.00 | 746.50 | 724.00 | **739.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | NY Close 23-01 | 739.75 | 746.00 | 733.25 | **739.00** | **-0.75¢** 🔴 | 🔴 BEAR |
