...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 16:47 ICT ngày 13/08/2026*
...
| **Chỉ số DXY (USD Index)** | **99.93** | **-0.08%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$87.34` (-1.84%)** | DXY: **`99.93` (-0.08%)** | Lúa mì CBOT: **`658.25¢` (+0.88%)**.
...
*Cập nhật tự động lúc 16:47 ICT ngày 13/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **13/08/2026** | **ZC** | **456.00 ¢** | **456.35 ¢ (+0.35)** | 🐂 Bullish (450.62 > 445.89) | 2.25 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-13082026) |
| **13/08/2026** | **ZW** | **658.25 ¢** | **660.64 ¢ (+2.39)** | 🐂 Bullish (650.69 > 646.85) | 8.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-13082026) |
| **13/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **453.50 - 450.62 cents (Canh mua vùng hỗ trợ)** | **423.84 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `457.75 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **452.00 - 453.50 cents** | **424.81 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **457.75 - 459.25 cents** | **459.69 cents** | **427.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **439.41 - 447.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **650.69 - 646.85 cents (Canh bán hồi kỹ thuật H1)** | **717.87 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `655.50 cents` \| TP2: `614.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **653.50 - 655.50 cents** | **609.58 cents** | **661.25 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **661.25 - 663.25 cents** | **665.67 cents** | **614.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **611.17 - 628.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 456.00 cents | **Dự báo Chốt Phiên:** **`456.35 cents`** (+0.35).
*   **Thanh khoản phiên chốt:** Volume: **`9,179`** (Chênh lệch: **`-200,979`**) | OI: **`320,226`** (Chênh lệch: **`+0`**)
...
| **USD Index** | **99.93** | **-0.08%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (450.62) > `EMA_50` (445.89).
*   **Động lượng & Dao động:** RSI (14) = **`72.05`** | ATR (14) = **`1.94`** cents | Volatility = **`2.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`453.50`** | S2: **`426.75`** || Kháng cự R1: **`457.75`** | R2: **`468.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`453.50 - 450.62 cents (Canh mua vùng hỗ trợ)`** | SL: **`423.84 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `457.75 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`452.00 - 453.50 cents`** | SL: **`424.81 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`457.75 - 459.25 cents`** | SL: **`459.69 cents`** | TP: **`427.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`439.41 - 447.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 658.25 cents | **Dự báo Chốt Phiên:** **`660.64 cents`** (+2.39).
*   **Thanh khoản phiên chốt:** Volume: **`7,928`** (Chênh lệch: **`-116,708`**) | OI: **`113,806`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| **USD Index** | **99.93** | **-0.08%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (650.69) > `EMA_50` (646.85).
*   **Động lượng & Dao động:** RSI (14) = **`65.46`** | ATR (14) = **`4.42`** cents | Volatility = **`8.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`655.50`** | S2: **`614.00`** || Kháng cự R1: **`661.25`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`650.69 - 646.85 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`717.87 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `655.50 cents` / `614.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`653.50 - 655.50 cents`** | SL: **`609.58 cents`** | TP: **`661.25 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`661.25 - 663.25 cents`** | SL: **`665.67 cents`** | TP: **`614.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`611.17 - 628.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 658.25 | 669.50 | 652.75 | **657.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 657.50 | 665.00 | 651.50 | **657.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 657.00 | 670.75 | 642.25 | **659.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 659.00 | 672.25 | 650.75 | **660.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 660.25 | 676.75 | 649.75 | **664.75** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 664.75 | 672.50 | 653.75 | **666.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 666.00 | 674.25 | 655.50 | **667.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 667.75 | 680.00 | 658.00 | **666.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 666.75 | 677.25 | 652.00 | **669.00** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 669.00 | 679.50 | 662.75 | **669.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 669.75 | 684.00 | 655.00 | **671.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 671.75 | 678.25 | 665.00 | **672.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 672.00 | 682.25 | 664.00 | **672.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 672.50 | 679.50 | 666.50 | **671.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 671.75 | 685.25 | 658.75 | **673.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 673.50 | 682.75 | 662.75 | **674.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 674.00 | 686.25 | 659.75 | **672.50** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 672.50 | 679.50 | 663.00 | **673.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 673.00 | 683.50 | 665.75 | **672.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 672.75 | 682.50 | 663.00 | **673.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 673.25 | 684.00 | 666.00 | **674.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 674.00 | 680.50 | 665.50 | **674.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 674.50 | 685.50 | 662.75 | **678.00** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 678.00 | 683.50 | 670.25 | **678.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 678.75 | 688.00 | 672.25 | **678.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 678.00 | 685.50 | 672.00 | **677.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 677.00 | 684.00 | 663.50 | **677.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 677.75 | 687.00 | 670.50 | **677.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 677.50 | 686.00 | 663.50 | **679.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 679.25 | 685.50 | 672.75 | **678.50** | **-0.75¢** 🔴 | 🔴 BEAR |
