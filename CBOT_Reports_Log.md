...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 08:24 ICT ngày 01/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.72 / thùng** | **+0.00%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.45** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.72` (+0.00%)** | DXY: **`99.45` (+0.00%)** | Lúa mì CBOT: **`770.75¢` (+0.00%)**.
...
*Cập nhật tự động lúc 08:24 ICT ngày 01/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **01/09/2026** | **ZC** | **537.00 ¢** | **538.91 ¢ (+1.91)** | 🐂 Bullish (536.80 > 535.34) | 1.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-01092026) |
| **01/09/2026** | **ZW** | **770.75 ¢** | **776.28 ¢ (+5.53)** | 🐂 Bullish (770.47 > 764.24) | 2.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-01092026) |
| **01/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **534.25 - 536.80 cents (Canh mua vùng hỗ trợ)** | **452.21 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `538.75 cents` \| TP2: `542.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **532.75 - 534.25 cents** | **453.89 cents (Chống quét SL tuyệt đối)** | **541.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **538.75 - 540.25 cents** | **542.11 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **443.81 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **770.47 - 764.24 cents (Canh bán hồi kỹ thuật H1)** | **801.74 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `758.00 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **771.00 - 773.00 cents** | **655.22 cents** | **796.25 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **796.25 - 798.25 cents** | **803.53 cents** | **662.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **614.62 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 537.00 cents | **Dự báo Chốt Phiên:** **`538.91 cents`** (+1.91).
*   **Thanh khoản phiên chốt:** Volume: **`11,720`** (Chênh lệch: **`-323,647`**) | OI: **`990,329`** (Chênh lệch: **`+31,013`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.72** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.45** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (536.80) > `EMA_50` (535.34).
*   **Động lượng & Dao động:** RSI (14) = **`50.74`** | ATR (14) = **`3.36`** cents | Volatility = **`1.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`534.25`** | S2: **`457.25`** || Kháng cự R1: **`538.75`** | R2: **`542.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`534.25 - 536.80 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.21 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `538.75 cents` / `542.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`532.75 - 534.25 cents`** | SL: **`453.89 cents (Chống quét SL tuyệt đối)`** | TP: **`541.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`538.75 - 540.25 cents`** | SL: **`542.11 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`443.81 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 770.75 cents | **Dự báo Chốt Phiên:** **`776.28 cents`** (+5.53).
*   **Thanh khoản phiên chốt:** Volume: **`3,366`** (Chênh lệch: **`-129,762`**) | OI: **`269,745`** (Chênh lệch: **`+972`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.72** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.45** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (770.47) > `EMA_50` (764.24).
*   **Động lượng & Dao động:** RSI (14) = **`50.73`** | ATR (14) = **`7.66`** cents | Volatility = **`2.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`758.00`** | S2: **`645.25`** || Kháng cự R1: **`782.75`** | R2: **`790.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`770.47 - 764.24 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`801.74 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `758.00 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`771.00 - 773.00 cents`** | SL: **`655.22 cents`** | TP: **`796.25 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`796.25 - 798.25 cents`** | SL: **`803.53 cents`** | TP: **`662.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`614.62 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 770.75 | 782.00 | 765.25 | **770.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | Asia 11-15 | 770.00 | 777.50 | 764.00 | **769.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 769.50 | 783.25 | 754.75 | **771.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 771.50 | 784.75 | 763.25 | **772.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 772.75 | 789.25 | 762.25 | **777.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 777.25 | 785.00 | 766.25 | **778.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 778.50 | 786.75 | 768.00 | **780.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 780.25 | 792.50 | 770.50 | **779.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 779.25 | 789.75 | 764.50 | **781.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 781.50 | 792.00 | 775.25 | **782.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 782.25 | 796.50 | 767.50 | **784.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 784.25 | 790.75 | 777.50 | **784.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 784.50 | 794.75 | 776.50 | **785.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 11-15 | 785.00 | 792.00 | 779.00 | **784.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 784.25 | 797.75 | 771.25 | **786.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 786.00 | 795.25 | 775.25 | **786.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 786.50 | 798.75 | 772.25 | **785.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | NY Close 23-01 | 785.00 | 792.00 | 775.50 | **785.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Asia 07-11 | 785.50 | 796.00 | 778.25 | **785.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 785.25 | 795.00 | 775.50 | **785.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 785.75 | 796.50 | 778.50 | **786.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 786.50 | 793.00 | 778.00 | **787.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 787.00 | 798.00 | 775.25 | **790.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 790.50 | 796.00 | 782.75 | **791.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 791.25 | 800.50 | 784.75 | **790.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 790.50 | 798.00 | 784.50 | **789.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 789.50 | 796.50 | 776.00 | **790.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 790.25 | 799.50 | 783.00 | **790.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 790.00 | 798.50 | 776.00 | **791.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 791.75 | 798.00 | 785.25 | **791.00** | **-0.75¢** 🔴 | 🔴 BEAR |
