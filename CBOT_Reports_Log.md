...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 10:16 ICT ngày 07/07/2026*
...
| :--- | :--- | :---: | :---: | :--- | :---: |
| **002602** | ZC | **-120,000** | **-10,000** | **Q3 (DO DAM) - NHOI SHORT**<br>*Uu tien SHORT thuan xu huong.* | 🔴 **-1.5** |
| **001602** | ZW | **-45,000** | **+5,000** | **Q4 (CAM) - COVER SHORT**<br>*Cam Short duoi. Canh LONG bat hoi.* | 🟢 **+1.0** |




### ✅ TƯƠNG QUAN VĨ MÔ ỔN ĐỊNH (NORMAL CORRELATION)
*   **Giá trị biến động 24h:** Dầu Brent: **`$71.65` (-0.21%)** | DXY: **`100.89` (+0.04%)** | Lúa mì CBOT: **`611.50¢` (+0.00%)**.
...
*Cập nhật tự động lúc 10:16 ICT ngày 07/07/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **07/07/2026** | **ZC** | **438.25 ¢** | **439.88 ¢ (+1.63)** | 🐂 Bullish (435.03 > 429.79) | 0.25 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-07072026) |
| **07/07/2026** | **ZW** | **611.50 ¢** | **613.90 ¢ (+2.40)** | 🐂 Bullish (609.63 > 604.91) | 0.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-07072026) |
| **07/07/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **434.00 - 435.03 cents (Canh mua vùng hỗ trợ)** | **403.51 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `439.25 cents` \| TP2: `458.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **453.50 - 455.00 cents** | **423.84 cents (Chống quét SL tuyệt đối)** | **476.25 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **467.25 - 468.75 cents** | **469.16 cents** | **426.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **418.10 - 425.75 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **609.63 - 604.91 cents (Canh bán hồi kỹ thuật H1)** | **635.94 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `609.75 cents` \| TP2: `574.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **607.75 - 609.75 cents** | **571.37 cents** | **613.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **613.00 - 615.00 cents** | **615.63 cents** | **574.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **579.20 - 590.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 438.25 cents | **Dự báo Chốt Phiên:** **`439.88 cents`** (+1.63).
*   **Thanh khoản phiên chốt:** Volume: **`6,196`** (Chênh lệch: **`-16,033`**) | OI: **`641,122`** (Chênh lệch: **`-4,331`**)
...
| :--- | :---: | :--- |
| **Ngày Báo Cáo** | **2026-06-16** | Cập nhật mới nhất từ CFTC |
| **Trạng Thái Matrix** | **Q3 (DO DAM) - NHOI SHORT** | *Uu tien SHORT thuan xu huong.* |
| **Net Position** | **-120,000** | Hợp đồng (Long - Short) |
| **Thay đổi Tuần qua** | **-10,000** | Hợp đồng thay đổi so với tuần trước |


---

### C. Phân Tích Kỹ Thuật H1/M15 (HĐ ZCU26)
*   **Chỉ báo EMA H1:** `EMA_21` (435.03) > `EMA_50` (429.79).
*   **Động lượng & Dao động:** RSI (14) = **`66.44`** | ATR (14) = **`1.83`** cents | Volatility = **`0.25 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`434.00 - 435.03 cents (Canh mua vùng hỗ trợ)`** | SL: **`403.51 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `439.25 cents` / `458.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`453.50 - 455.00 cents`** | SL: **`423.84 cents (Chống quét SL tuyệt đối)`** | TP: **`476.25 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`467.25 - 468.75 cents`** | SL: **`469.16 cents`** | TP: **`426.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`418.10 - 425.75 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 06/07** | Asia 07-11 | 438.25 | 442.00 | 435.00 | **438.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | Asia 11-15 | 438.50 | 441.25 | 434.75 | **438.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 06/07** | London 15-19 | 438.00 | 441.00 | 434.00 | **438.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | Pre-NY 19-21 | 438.75 | 443.25 | 433.75 | **439.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | NY Open 21-23 | 439.50 | 445.00 | 433.25 | **441.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | NY Close 23-01 | 441.75 | 444.75 | 437.50 | **442.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | Asia 07-11 | 442.00 | 445.25 | 435.50 | **442.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | Asia 11-15 | 442.75 | 445.75 | 438.25 | **442.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 07/07** | London 15-19 | 442.25 | 446.25 | 436.50 | **442.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | Pre-NY 19-21 | 442.75 | 445.25 | 439.50 | **443.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | NY Open 21-23 | 443.25 | 446.75 | 437.25 | **444.25** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | NY Close 23-01 | 444.25 | 447.00 | 441.75 | **444.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | Asia 07-11 | 444.25 | 447.00 | 441.75 | **443.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 08/07** | Asia 11-15 | 443.75 | 446.75 | 440.50 | **443.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 08/07** | London 15-19 | 443.50 | 447.50 | 438.25 | **444.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | Pre-NY 19-21 | 444.00 | 448.75 | 437.00 | **446.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | NY Open 21-23 | 446.00 | 454.00 | 439.00 | **447.50** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | NY Close 23-01 | 447.50 | 452.00 | 443.25 | **447.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 09/07** | Asia 07-11 | 447.00 | 449.25 | 444.25 | **446.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 09/07** | Asia 11-15 | 446.75 | 448.75 | 442.25 | **447.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | London 15-19 | 447.00 | 450.75 | 444.25 | **447.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | Pre-NY 19-21 | 447.50 | 450.50 | 443.00 | **447.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | NY Open 21-23 | 447.75 | 452.00 | 444.50 | **448.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | NY Close 23-01 | 448.50 | 452.00 | 446.25 | **448.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 10/07** | Asia 07-11 | 448.50 | 452.25 | 445.00 | **448.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 10/07** | Asia 11-15 | 448.25 | 451.75 | 445.00 | **448.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 10/07** | London 15-19 | 448.00 | 451.00 | 445.25 | **448.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 10/07** | Pre-NY 19-21 | 448.25 | 451.25 | 445.50 | **448.25** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 10/07** | NY Open 21-23 | 448.25 | 452.25 | 444.75 | **448.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 10/07** | NY Close 23-01 | 448.75 | 452.75 | 447.00 | **448.50** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 611.50 cents | **Dự báo Chốt Phiên:** **`613.90 cents`** (+2.40).
*   **Thanh khoản phiên chốt:** Volume: **`2,124`** (Chênh lệch: **`-771`**) | OI: **`215,146`** (Chênh lệch: **`-235`**)
...
| **Net Position** | **-45,000** | Hợp đồng (Long - Short) |
| **Thay đổi Tuần qua** | **+5,000** | Hợp đồng thay đổi so với tuần trước |


---

### C. Phân Tích Kỹ Thuật H1/M15 (HĐ ZWU26)
*   **Chỉ báo EMA H1:** `EMA_21` (609.63) > `EMA_50` (604.91).
*   **Động lượng & Dao động:** RSI (14) = **`58.53`** | ATR (14) = **`2.63`** cents | Volatility = **`0.00 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`609.63 - 604.91 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`635.94 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `609.75 cents` / `574.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`607.75 - 609.75 cents`** | SL: **`571.37 cents`** | TP: **`613.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`613.00 - 615.00 cents`** | SL: **`615.63 cents`** | TP: **`574.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`579.20 - 590.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 06/07** | Asia 07-11 | 611.50 | 622.75 | 606.00 | **610.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 06/07** | Asia 11-15 | 610.75 | 618.25 | 604.75 | **610.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 06/07** | London 15-19 | 610.25 | 624.00 | 595.50 | **612.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | Pre-NY 19-21 | 612.25 | 625.50 | 604.00 | **613.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | NY Open 21-23 | 613.50 | 630.00 | 603.00 | **618.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 06/07** | NY Close 23-01 | 618.00 | 625.75 | 607.00 | **619.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | Asia 07-11 | 619.25 | 627.50 | 608.75 | **621.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | Asia 11-15 | 621.00 | 633.25 | 611.25 | **620.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 07/07** | London 15-19 | 620.00 | 630.50 | 605.25 | **622.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | Pre-NY 19-21 | 622.25 | 632.75 | 616.00 | **623.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | NY Open 21-23 | 623.00 | 637.25 | 608.25 | **625.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 07/07** | NY Close 23-01 | 625.00 | 631.50 | 618.25 | **625.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | Asia 07-11 | 625.25 | 635.50 | 617.25 | **625.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | Asia 11-15 | 625.75 | 632.75 | 619.75 | **625.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 08/07** | London 15-19 | 625.00 | 638.50 | 612.00 | **626.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | Pre-NY 19-21 | 626.75 | 636.00 | 616.00 | **627.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 08/07** | NY Open 21-23 | 627.25 | 639.50 | 613.00 | **625.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 08/07** | NY Close 23-01 | 625.75 | 632.75 | 616.25 | **626.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | Asia 07-11 | 626.25 | 636.75 | 619.00 | **626.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 09/07** | Asia 11-15 | 626.00 | 635.75 | 616.25 | **626.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | London 15-19 | 626.50 | 637.25 | 619.25 | **627.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | Pre-NY 19-21 | 627.25 | 633.75 | 618.75 | **627.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | NY Open 21-23 | 627.75 | 638.75 | 616.00 | **631.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 09/07** | NY Close 23-01 | 631.25 | 636.75 | 623.50 | **632.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 10/07** | Asia 07-11 | 632.00 | 641.25 | 625.50 | **631.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 10/07** | Asia 11-15 | 631.25 | 638.75 | 625.25 | **630.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 10/07** | London 15-19 | 630.25 | 637.25 | 616.75 | **631.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 10/07** | Pre-NY 19-21 | 631.00 | 640.25 | 623.75 | **630.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 10/07** | NY Open 21-23 | 630.75 | 639.25 | 616.75 | **632.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 10/07** | NY Close 23-01 | 632.50 | 638.75 | 626.00 | **631.75** | **-0.75¢** 🔴 | 🔴 BEAR |
