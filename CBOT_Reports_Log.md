...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 07:11 ICT ngày 15/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$106.53 / thùng** | **+0.00%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.50** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$106.53` (+0.00%)** | DXY: **`99.50` (+0.00%)** | Lúa mì CBOT: **`720.50¢` (+0.00%)**.
...
*Cập nhật tự động lúc 07:11 ICT ngày 15/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **15/09/2026** | **ZC** | **532.00 ¢** | **533.59 ¢ (+1.59)** | 🐂 Bullish (530.78 > 530.52) | 1.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-15092026) |
| **15/09/2026** | **ZW** | **720.50 ¢** | **722.06 ¢ (+1.56)** | 🐻 Bearish (725.21 < 729.21) | 3.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-15092026) |
| **15/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **528.00 - 530.78 cents (Canh mua vùng hỗ trợ)** | **452.71 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `534.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **526.50 - 528.00 cents** | **454.30 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **534.50 - 536.00 cents** | **537.70 cents** | **458.50 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **444.72 - 457.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **725.21 - 729.21 cents (Canh bán hồi kỹ thuật H1)** | **803.84 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `716.25 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **730.75 - 732.75 cents** | **657.14 cents** | **749.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **749.00 - 751.00 cents** | **754.61 cents** | **662.75 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **621.69 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 532.00 cents | **Dự báo Chốt Phiên:** **`533.59 cents`** (+1.59).
*   **Thanh khoản phiên chốt:** Volume: **`2,367`** (Chênh lệch: **`-10,884`**) | OI: **`951,842`** (Chênh lệch: **`-8,666`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$106.53** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.50** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (530.78) > `EMA_50` (530.52).
*   **Động lượng & Dao động:** RSI (14) = **`53.64`** | ATR (14) = **`3.20`** cents | Volatility = **`1.50 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`528.00 - 530.78 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.71 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `534.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`526.50 - 528.00 cents`** | SL: **`454.30 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`534.50 - 536.00 cents`** | SL: **`537.70 cents`** | TP: **`458.50 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`444.72 - 457.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 720.50 cents | **Dự báo Chốt Phiên:** **`722.06 cents`** (+1.56).
*   **Thanh khoản phiên chốt:** Volume: **`463`** (Chênh lệch: **`-2,861`**) | OI: **`259,790`** (Chênh lệch: **`-98`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$106.53** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.50** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (725.21) < `EMA_50` (729.21).
*   **Động lượng & Dao động:** RSI (14) = **`41.50`** | ATR (14) = **`5.89`** cents | Volatility = **`3.25 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`725.21 - 729.21 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`803.84 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `716.25 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`730.75 - 732.75 cents`** | SL: **`657.14 cents`** | TP: **`749.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`749.00 - 751.00 cents`** | SL: **`754.61 cents`** | TP: **`662.75 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`621.69 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 14/09** | Asia 07-11 | 720.50 | 731.75 | 715.00 | **719.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | Asia 11-15 | 719.75 | 727.25 | 713.75 | **719.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | London 15-19 | 719.25 | 733.00 | 704.50 | **721.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | Pre-NY 19-21 | 721.25 | 734.50 | 713.00 | **722.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Open 21-23 | 722.50 | 739.00 | 712.00 | **727.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Close 23-01 | 727.00 | 734.75 | 716.00 | **728.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 07-11 | 728.25 | 736.50 | 717.75 | **730.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 11-15 | 730.00 | 742.25 | 720.25 | **729.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 15/09** | London 15-19 | 729.00 | 739.50 | 714.25 | **731.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Pre-NY 19-21 | 731.25 | 741.75 | 725.00 | **732.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Open 21-23 | 732.00 | 746.25 | 717.25 | **734.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Close 23-01 | 734.00 | 740.50 | 727.25 | **734.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 07-11 | 734.25 | 744.50 | 726.25 | **734.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 11-15 | 734.75 | 741.75 | 728.75 | **734.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | London 15-19 | 734.00 | 747.50 | 721.00 | **735.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Pre-NY 19-21 | 735.75 | 745.00 | 725.00 | **736.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | NY Open 21-23 | 736.25 | 748.50 | 722.00 | **734.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | NY Close 23-01 | 734.75 | 741.75 | 725.25 | **735.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Asia 07-11 | 735.25 | 745.75 | 728.00 | **735.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 17/09** | Asia 11-15 | 735.00 | 744.75 | 725.25 | **735.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | London 15-19 | 735.50 | 746.25 | 728.25 | **736.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Pre-NY 19-21 | 736.25 | 742.75 | 727.75 | **736.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Open 21-23 | 736.75 | 747.75 | 725.00 | **740.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Close 23-01 | 740.25 | 745.75 | 732.50 | **741.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Asia 07-11 | 741.00 | 750.25 | 734.50 | **740.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | Asia 11-15 | 740.25 | 747.75 | 734.25 | **739.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | London 15-19 | 739.25 | 746.25 | 725.75 | **740.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Pre-NY 19-21 | 740.00 | 749.25 | 732.75 | **739.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | NY Open 21-23 | 739.75 | 748.25 | 725.75 | **741.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | NY Close 23-01 | 741.50 | 747.75 | 735.00 | **740.75** | **-0.75¢** 🔴 | 🔴 BEAR |
