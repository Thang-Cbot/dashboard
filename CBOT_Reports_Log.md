...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 18:00 ICT ngày 07/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$81.79 / thùng** | **-0.85%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.91** | **-0.06%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$81.79` (-0.85%)** | DXY: **`99.91` (-0.06%)** | Lúa mì CBOT: **`633.75¢` (+0.40%)**.
...
*Cập nhật tự động lúc 18:00 ICT ngày 07/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **07/08/2026** | **ZC** | **442.75 ¢** | **443.42 ¢ (+0.67)** | 🐂 Bullish (440.20 > 440.18) | 0.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-07082026) |
| **07/08/2026** | **ZW** | **633.75 ¢** | **635.22 ¢ (+1.47)** | 🐻 Bearish (634.77 < 638.23) | 5.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-07082026) |
| **07/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **441.25 - 440.20 cents (Canh mua vùng hỗ trợ)** | **422.77 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `444.50 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **439.75 - 441.25 cents** | **423.51 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **444.50 - 446.00 cents** | **445.99 cents** | **426.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **438.08 - 444.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **634.77 - 638.23 cents (Canh bán hồi kỹ thuật H1)** | **716.96 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `631.50 cents` \| TP2: `600.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **629.50 - 631.50 cents** | **596.44 cents** | **638.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **638.75 - 640.75 cents** | **642.56 cents** | **600.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **599.99 - 614.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 442.75 cents | **Dự báo Chốt Phiên:** **`443.42 cents`** (+0.67).
*   **Thanh khoản phiên chốt:** Volume: **`6,316`** (Chênh lệch: **`-105,929`**) | OI: **`479,387`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$81.79** | **-0.85%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.91** | **-0.06%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (440.20) > `EMA_50` (440.18).
*   **Động lượng & Dao động:** RSI (14) = **`64.54`** | ATR (14) = **`1.49`** cents | Volatility = **`0.50 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`441.25 - 440.20 cents (Canh mua vùng hỗ trợ)`** | SL: **`422.77 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `444.50 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`439.75 - 441.25 cents`** | SL: **`423.51 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`444.50 - 446.00 cents`** | SL: **`445.99 cents`** | TP: **`426.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`438.08 - 444.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 633.75 cents | **Dự báo Chốt Phiên:** **`635.22 cents`** (+1.47).
*   **Thanh khoản phiên chốt:** Volume: **`12,662`** (Chênh lệch: **`-46,782`**) | OI: **`175,453`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$81.79** | **-0.85%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.91** | **-0.06%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (634.77) < `EMA_50` (638.23).
*   **Động lượng & Dao động:** RSI (14) = **`46.51`** | ATR (14) = **`3.81`** cents | Volatility = **`5.50 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`634.77 - 638.23 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`716.96 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `631.50 cents` / `600.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`629.50 - 631.50 cents`** | SL: **`596.44 cents`** | TP: **`638.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`638.75 - 640.75 cents`** | SL: **`642.56 cents`** | TP: **`600.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`599.99 - 614.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 633.75 | 645.00 | 628.25 | **633.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 633.00 | 640.50 | 627.00 | **632.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 632.50 | 646.25 | 617.75 | **634.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 634.50 | 647.75 | 626.25 | **635.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 635.75 | 652.25 | 625.25 | **640.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 640.25 | 648.00 | 629.25 | **641.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 641.50 | 649.75 | 631.00 | **643.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 643.25 | 655.50 | 633.50 | **642.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 642.25 | 652.75 | 627.50 | **644.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 644.50 | 655.00 | 638.25 | **645.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 645.25 | 659.50 | 630.50 | **647.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 647.25 | 653.75 | 640.50 | **647.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 647.50 | 657.75 | 639.50 | **648.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 648.00 | 655.00 | 642.00 | **647.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 647.25 | 660.75 | 634.25 | **649.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 649.00 | 658.25 | 638.25 | **649.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 649.50 | 661.75 | 635.25 | **648.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 648.00 | 655.00 | 638.50 | **648.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 648.50 | 659.00 | 641.25 | **648.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 648.25 | 658.00 | 638.50 | **648.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 648.75 | 659.50 | 641.50 | **649.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 649.50 | 656.00 | 641.00 | **650.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 650.00 | 661.00 | 638.25 | **653.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 653.50 | 659.00 | 645.75 | **654.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 654.25 | 663.50 | 647.75 | **653.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 653.50 | 661.00 | 647.50 | **652.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 652.50 | 659.50 | 639.00 | **653.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 653.25 | 662.50 | 646.00 | **653.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 653.00 | 661.50 | 639.00 | **654.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 654.75 | 661.00 | 648.25 | **654.00** | **-0.75¢** 🔴 | 🔴 BEAR |
