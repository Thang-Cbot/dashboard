...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 12:00 ICT ngày 10/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$101.07 / thùng** | **-0.14%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **98.74** | **-0.03%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$101.07` (-0.14%)** | DXY: **`98.74` (-0.03%)** | Lúa mì CBOT: **`726.00¢` (+2.07%)**.
...
*Cập nhật tự động lúc 12:00 ICT ngày 10/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **10/09/2026** | **ZC** | **528.25 ¢** | **529.06 ¢ (+0.81)** | 🐻 Bearish (530.70 < 533.41) | 0.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-10092026) |
| **10/09/2026** | **ZW** | **726.00 ¢** | **728.46 ¢ (+2.46)** | 🐻 Bearish (738.33 < 744.60) | 1.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-10092026) |
| **10/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **526.75 - 530.70 cents (Canh mua vùng hỗ trợ)** | **453.00 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `530.00 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **525.25 - 526.75 cents** | **454.42 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **530.00 - 531.50 cents** | **532.83 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **445.93 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **738.33 - 744.60 cents (Canh bán hồi kỹ thuật H1)** | **804.18 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `710.50 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **726.50 - 728.50 cents** | **656.68 cents** | **763.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **763.50 - 765.50 cents** | **769.32 cents** | **662.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **620.78 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 528.25 cents | **Dự báo Chốt Phiên:** **`529.06 cents`** (+0.81).
*   **Thanh khoản phiên chốt:** Volume: **`8,638`** (Chênh lệch: **`-237,094`**) | OI: **`965,821`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$101.07** | **-0.14%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **98.74** | **-0.03%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (530.70) < `EMA_50` (533.41).
*   **Động lượng & Dao động:** RSI (14) = **`41.49`** | ATR (14) = **`2.83`** cents | Volatility = **`0.50 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`526.75 - 530.70 cents (Canh mua vùng hỗ trợ)`** | SL: **`453.00 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `530.00 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`525.25 - 526.75 cents`** | SL: **`454.42 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`530.00 - 531.50 cents`** | SL: **`532.83 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`445.93 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 726.00 cents | **Dự báo Chốt Phiên:** **`728.46 cents`** (+2.46).
*   **Thanh khoản phiên chốt:** Volume: **`3,728`** (Chênh lệch: **`-94,822`**) | OI: **`262,844`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$101.07** | **-0.14%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **98.74** | **-0.03%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (738.33) < `EMA_50` (744.60).
*   **Động lượng & Dao động:** RSI (14) = **`34.57`** | ATR (14) = **`6.12`** cents | Volatility = **`1.75 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`738.33 - 744.60 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`804.18 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `710.50 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`726.50 - 728.50 cents`** | SL: **`656.68 cents`** | TP: **`763.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`763.50 - 765.50 cents`** | SL: **`769.32 cents`** | TP: **`662.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`620.78 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 07/09** | Asia 07-11 | 726.00 | 737.25 | 720.50 | **725.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 07/09** | Asia 11-15 | 725.25 | 732.75 | 719.25 | **724.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 07/09** | London 15-19 | 724.75 | 738.50 | 710.00 | **726.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | Pre-NY 19-21 | 726.75 | 740.00 | 718.50 | **728.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | NY Open 21-23 | 728.00 | 744.50 | 717.50 | **732.50** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | NY Close 23-01 | 732.50 | 740.25 | 721.50 | **733.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Asia 07-11 | 733.75 | 742.00 | 723.25 | **735.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Asia 11-15 | 735.50 | 747.75 | 725.75 | **734.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 08/09** | London 15-19 | 734.50 | 745.00 | 719.75 | **736.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Pre-NY 19-21 | 736.75 | 747.25 | 730.50 | **737.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | NY Open 21-23 | 737.50 | 751.75 | 722.75 | **739.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | NY Close 23-01 | 739.50 | 746.00 | 732.75 | **739.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Asia 07-11 | 739.75 | 750.00 | 731.75 | **740.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Asia 11-15 | 740.25 | 747.25 | 734.25 | **739.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 09/09** | London 15-19 | 739.50 | 753.00 | 726.50 | **741.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Pre-NY 19-21 | 741.25 | 750.50 | 730.50 | **741.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | NY Open 21-23 | 741.75 | 754.00 | 727.50 | **740.25** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 09/09** | NY Close 23-01 | 740.25 | 747.25 | 730.75 | **740.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | Asia 07-11 | 740.75 | 751.25 | 733.50 | **740.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 10/09** | Asia 11-15 | 740.50 | 750.25 | 730.75 | **741.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | London 15-19 | 741.00 | 751.75 | 733.75 | **741.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | Pre-NY 19-21 | 741.75 | 748.25 | 733.25 | **742.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | NY Open 21-23 | 742.25 | 753.25 | 730.50 | **745.75** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | NY Close 23-01 | 745.75 | 751.25 | 738.00 | **746.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | Asia 07-11 | 746.50 | 755.75 | 740.00 | **745.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | Asia 11-15 | 745.75 | 753.25 | 739.75 | **744.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | London 15-19 | 744.75 | 751.75 | 731.25 | **745.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | Pre-NY 19-21 | 745.50 | 754.75 | 738.25 | **745.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | NY Open 21-23 | 745.25 | 753.75 | 731.25 | **747.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | NY Close 23-01 | 747.00 | 753.25 | 740.50 | **746.25** | **-0.75¢** 🔴 | 🔴 BEAR |
