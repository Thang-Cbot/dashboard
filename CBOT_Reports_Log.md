...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 12:00 ICT ngày 17/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$105.69 / thùng** | **-0.13%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.28** | **-0.03%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$105.69` (-0.13%)** | DXY: **`100.28` (-0.03%)** | Lúa mì CBOT: **`733.75¢` (+0.41%)**.
...
*Cập nhật tự động lúc 12:00 ICT ngày 17/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **17/09/2026** | **ZC** | **535.50 ¢** | **536.91 ¢ (+1.41)** | 🐂 Bullish (533.90 > 533.16) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-17092026) |
| **17/09/2026** | **ZW** | **733.75 ¢** | **736.15 ¢ (+2.40)** | 🐂 Bullish (728.65 > 727.65) | 4.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-17092026) |
| **17/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **532.00 - 533.90 cents (Canh mua vùng hỗ trợ)** | **466.55 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `537.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **530.50 - 532.00 cents** | **467.87 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **537.50 - 539.00 cents** | **540.13 cents** | **471.50 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **459.96 - 470.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **728.65 - 727.65 cents (Canh bán hồi kỹ thuật H1)** | **803.14 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `730.50 cents` \| TP2: `661.75 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **728.50 - 730.50 cents** | **656.32 cents** | **741.25 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **741.25 - 743.25 cents** | **746.68 cents** | **661.75 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **640.03 - 661.75 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 535.50 cents | **Dự báo Chốt Phiên:** **`536.91 cents`** (+1.41).
*   **Thanh khoản phiên chốt:** Volume: **`10,642`** (Chênh lệch: **`-191,666`**) | OI: **`949,969`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$105.69** | **-0.13%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.28** | **-0.03%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (533.90) > `EMA_50` (533.16).
*   **Động lượng & Dao động:** RSI (14) = **`54.94`** | ATR (14) = **`2.63`** cents | Volatility = **`0.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`532.00`** | S2: **`470.50`** || Kháng cự R1: **`537.50`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`532.00 - 533.90 cents (Canh mua vùng hỗ trợ)`** | SL: **`466.55 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `537.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`530.50 - 532.00 cents`** | SL: **`467.87 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`537.50 - 539.00 cents`** | SL: **`540.13 cents`** | TP: **`471.50 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`459.96 - 470.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 733.75 cents | **Dự báo Chốt Phiên:** **`736.15 cents`** (+2.40).
*   **Thanh khoản phiên chốt:** Volume: **`2,914`** (Chênh lệch: **`-67,895`**) | OI: **`259,397`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
*   **Dòng tiền (Volume + OI):** **`Tăng yếu / Rủi ro đảo chiều (Short Covering Rally)`**
*   **Đánh giá xu hướng kết hợp:** 📈 **TÍCH LŨY TÍCH CỰC (Accumulation):** Nến đi ngang nhưng dòng tiền âm thầm gia tăng (OI tăng), báo hiệu chuẩn bị có nhịp bứt phá tăng.
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$105.69** | **-0.13%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.28** | **-0.03%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (728.65) > `EMA_50` (727.65).
*   **Động lượng & Dao động:** RSI (14) = **`56.80`** | ATR (14) = **`5.43`** cents | Volatility = **`4.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`730.50`** | S2: **`661.75`** || Kháng cự R1: **`741.25`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`728.65 - 727.65 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`803.14 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `730.50 cents` / `661.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`728.50 - 730.50 cents`** | SL: **`656.32 cents`** | TP: **`741.25 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`741.25 - 743.25 cents`** | SL: **`746.68 cents`** | TP: **`661.75 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`640.03 - 661.75 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 14/09** | Asia 07-11 | 733.75 | 745.00 | 728.25 | **733.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | Asia 11-15 | 733.00 | 740.50 | 727.00 | **732.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | London 15-19 | 732.50 | 746.25 | 717.75 | **734.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | Pre-NY 19-21 | 734.50 | 747.75 | 726.25 | **735.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Open 21-23 | 735.75 | 752.25 | 725.25 | **740.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Close 23-01 | 740.25 | 748.00 | 729.25 | **741.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 07-11 | 741.50 | 749.75 | 731.00 | **743.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 11-15 | 743.25 | 755.50 | 733.50 | **742.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 15/09** | London 15-19 | 742.25 | 752.75 | 727.50 | **744.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Pre-NY 19-21 | 744.50 | 755.00 | 738.25 | **745.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Open 21-23 | 745.25 | 759.50 | 730.50 | **747.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Close 23-01 | 747.25 | 753.75 | 740.50 | **747.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 07-11 | 747.50 | 757.75 | 739.50 | **748.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 11-15 | 748.00 | 755.00 | 742.00 | **747.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | London 15-19 | 747.25 | 760.75 | 734.25 | **749.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Pre-NY 19-21 | 749.00 | 758.25 | 738.25 | **749.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | NY Open 21-23 | 749.50 | 761.75 | 735.25 | **748.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | NY Close 23-01 | 748.00 | 755.00 | 738.50 | **748.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Asia 07-11 | 748.50 | 759.00 | 741.25 | **748.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 17/09** | Asia 11-15 | 748.25 | 758.00 | 738.50 | **748.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | London 15-19 | 748.75 | 759.50 | 741.50 | **749.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Pre-NY 19-21 | 749.50 | 756.00 | 741.00 | **750.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Open 21-23 | 750.00 | 761.00 | 738.25 | **753.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Close 23-01 | 753.50 | 759.00 | 745.75 | **754.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Asia 07-11 | 754.25 | 763.50 | 747.75 | **753.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | Asia 11-15 | 753.50 | 761.00 | 747.50 | **752.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | London 15-19 | 752.50 | 759.50 | 739.00 | **753.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Pre-NY 19-21 | 753.25 | 762.50 | 746.00 | **753.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | NY Open 21-23 | 753.00 | 761.50 | 739.00 | **754.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | NY Close 23-01 | 754.75 | 761.00 | 748.25 | **754.00** | **-0.75¢** 🔴 | 🔴 BEAR |
