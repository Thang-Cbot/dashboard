...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 06:33 ICT ngày 03/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$95.30 / thùng** | **+0.69%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$95.30` (+0.69%)** | DXY: **`99.58` (-0.09%)** | Lúa mì CBOT: **`774.75¢` (+1.41%)**.
...
*Cập nhật tự động lúc 06:33 ICT ngày 03/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$95.30** | **+0.69%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$95.30** | **+0.69%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
