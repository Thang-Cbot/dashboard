...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 05:01 ICT ngày 21/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$93.15 / thùng** | **+1.67%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **98.87** | **+0.04%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$93.15` (+1.67%)** | DXY: **`98.87` (+0.04%)** | Lúa mì CBOT: **`699.50¢` (+2.83%)**.
...
*Cập nhật tự động lúc 05:01 ICT ngày 21/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **21/08/2026** | **ZC** | **502.50 ¢** | **504.72 ¢ (+2.22)** | 🐂 Bullish (501.19 > 496.38) | 1.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-21082026) |
| **21/08/2026** | **ZW** | **699.50 ¢** | **702.40 ¢ (+2.90)** | 🐂 Bullish (698.94 > 694.05) | 2.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-21082026) |
| **21/08/2026** 
---
...
*   **Giá Chốt Phiên (Close):** 502.50 cents | **Dự báo Chốt Phiên:** **`504.72 cents`** (+2.22).
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$93.15** | **+1.67%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **98.87** | **+0.04%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Giá Chốt Phiên (Close):** 699.50 cents | **Dự báo Chốt Phiên:** **`702.40 cents`** (+2.90).
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$93.15** | **+1.67%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **98.87** | **+0.04%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
