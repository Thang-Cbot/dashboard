...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 14:41 ICT ngày 13/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.29 / thùng** | **-0.78%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.00** | **-0.01%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.29` (-0.78%)** | DXY: **`100.00` (-0.01%)** | Lúa mì CBOT: **`653.50¢` (+0.12%)**.
...
*Cập nhật tự động lúc 14:41 ICT ngày 13/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **13/08/2026** | **ZC** | **454.00 ¢** | **454.70 ¢ (+0.70)** | 🐂 Bullish (449.71 > 445.14) | 1.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-13082026) |
| **13/08/2026** | **ZW** | **653.50 ¢** | **655.50 ¢ (+2.00)** | 🐂 Bullish (649.99 > 646.28) | 2.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-13082026) |
| **13/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **451.50 - 449.71 cents (Canh mua vùng hỗ trợ)** | **424.14 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `455.00 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **450.00 - 451.50 cents** | **425.01 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **455.00 - 456.50 cents** | **456.74 cents** | **427.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **439.98 - 447.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **649.99 - 646.28 cents (Canh bán hồi kỹ thuật H1)** | **715.94 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `650.50 cents` \| TP2: `614.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **648.50 - 650.50 cents** | **610.87 cents** | **656.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **656.50 - 658.50 cents** | **659.63 cents** | **614.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **616.33 - 628.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 454.00 cents | **Dự báo Chốt Phiên:** **`454.70 cents`** (+0.70).
*   **Thanh khoản phiên chốt:** Volume: **`7,274`** (Chênh lệch: **`-202,884`**) | OI: **`320,226`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.29** | **-0.78%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.00** | **-0.01%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (449.71) > `EMA_50` (445.14).
*   **Động lượng & Dao động:** RSI (14) = **`70.64`** | ATR (14) = **`1.74`** cents | Volatility = **`1.00 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`451.50 - 449.71 cents (Canh mua vùng hỗ trợ)`** | SL: **`424.14 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `455.00 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`450.00 - 451.50 cents`** | SL: **`425.01 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`455.00 - 456.50 cents`** | SL: **`456.74 cents`** | TP: **`427.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`439.98 - 447.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 653.50 cents | **Dự báo Chốt Phiên:** **`655.50 cents`** (+2.00).
*   **Thanh khoản phiên chốt:** Volume: **`4,603`** (Chênh lệch: **`-120,033`**) | OI: **`113,806`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.29** | **-0.78%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.00** | **-0.01%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (649.99) > `EMA_50` (646.28).
*   **Động lượng & Dao động:** RSI (14) = **`61.22`** | ATR (14) = **`3.13`** cents | Volatility = **`2.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`650.50`** | S2: **`614.00`** || Kháng cự R1: **`656.50`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`649.99 - 646.28 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`715.94 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `650.50 cents` / `614.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`648.50 - 650.50 cents`** | SL: **`610.87 cents`** | TP: **`656.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`656.50 - 658.50 cents`** | SL: **`659.63 cents`** | TP: **`614.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`616.33 - 628.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 653.50 | 664.75 | 648.00 | **652.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 652.75 | 660.25 | 646.75 | **652.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 652.25 | 666.00 | 637.50 | **654.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 654.25 | 667.50 | 646.00 | **655.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 655.50 | 672.00 | 645.00 | **660.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 660.00 | 667.75 | 649.00 | **661.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 661.25 | 669.50 | 650.75 | **663.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 663.00 | 675.25 | 653.25 | **662.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 662.00 | 672.50 | 647.25 | **664.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 664.25 | 674.75 | 658.00 | **665.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 665.00 | 679.25 | 650.25 | **667.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 667.00 | 673.50 | 660.25 | **667.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 667.25 | 677.50 | 659.25 | **667.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 667.75 | 674.75 | 661.75 | **667.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 667.00 | 680.50 | 654.00 | **668.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 668.75 | 678.00 | 658.00 | **669.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 669.25 | 681.50 | 655.00 | **667.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 667.75 | 674.75 | 658.25 | **668.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 668.25 | 678.75 | 661.00 | **668.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 668.00 | 677.75 | 658.25 | **668.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 668.50 | 679.25 | 661.25 | **669.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 669.25 | 675.75 | 660.75 | **669.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 669.75 | 680.75 | 658.00 | **673.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 673.25 | 678.75 | 665.50 | **674.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 674.00 | 683.25 | 667.50 | **673.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 673.25 | 680.75 | 667.25 | **672.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 672.25 | 679.25 | 658.75 | **673.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 673.00 | 682.25 | 665.75 | **672.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 672.75 | 681.25 | 658.75 | **674.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 674.50 | 680.75 | 668.00 | **673.75** | **-0.75¢** 🔴 | 🔴 BEAR |
