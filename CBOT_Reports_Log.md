...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 17:00 ICT ngày 06/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$79.64 / thùng** | **+0.24%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.74** | **+0.05%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$79.64` (+0.24%)** | DXY: **`99.74` (+0.05%)** | Lúa mì CBOT: **`639.75¢` (-0.39%)**.
...
*Cập nhật tự động lúc 17:00 ICT ngày 06/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **06/08/2026** | **ZC** | **437.25 ¢** | **437.49 ¢ (+0.24)** | 🐻 Bearish (438.48 < 440.68) | 0.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-06082026) |
| **06/08/2026** | **ZW** | **639.75 ¢** | **641.38 ¢ (+1.63)** | 🐻 Bearish (642.45 < 643.65) | 1.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-06082026) |
| **06/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **436.00 - 438.48 cents (Canh mua vùng hỗ trợ)** | **419.64 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `438.50 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **434.50 - 436.00 cents** | **420.35 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **438.50 - 440.00 cents** | **439.90 cents** | **422.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **434.16 - 440.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **642.45 - 643.65 cents (Canh bán hồi kỹ thuật H1)** | **716.34 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `636.50 cents` \| TP2: `598.50 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **634.50 - 636.50 cents** | **595.11 cents** | **642.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **642.00 - 644.00 cents** | **645.39 cents** | **598.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
...
*   **Giá Chốt Phiên (Close):** 437.25 cents | **Dự báo Chốt Phiên:** **`437.49 cents`** (+0.24).
*   **Thanh khoản phiên chốt:** Volume: **`3,429`** (Chênh lệch: **`-133,233`**) | OI: **`497,935`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$79.64** | **+0.24%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.74** | **+0.05%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (438.48) < `EMA_50` (440.68).
*   **Động lượng & Dao động:** RSI (14) = **`40.46`** | ATR (14) = **`1.40`** cents | Volatility = **`0.50 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`436.00 - 438.48 cents (Canh mua vùng hỗ trợ)`** | SL: **`419.64 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `438.50 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`434.50 - 436.00 cents`** | SL: **`420.35 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`438.50 - 440.00 cents`** | SL: **`439.90 cents`** | TP: **`422.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`434.16 - 440.50 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 03/08** | Asia 07-11 | 437.25 | 441.00 | 434.00 | **437.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | Asia 11-15 | 437.50 | 440.25 | 433.75 | **437.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 03/08** | London 15-19 | 437.00 | 440.00 | 433.00 | **437.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | Pre-NY 19-21 | 437.75 | 442.25 | 432.75 | **438.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | NY Open 21-23 | 438.50 | 444.00 | 432.25 | **440.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | NY Close 23-01 | 440.75 | 443.75 | 436.50 | **441.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Asia 07-11 | 441.00 | 444.25 | 434.50 | **441.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Asia 11-15 | 441.75 | 444.75 | 437.25 | **441.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 04/08** | London 15-19 | 441.25 | 445.25 | 435.50 | **441.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Pre-NY 19-21 | 441.75 | 444.25 | 438.50 | **442.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | NY Open 21-23 | 442.25 | 445.75 | 436.25 | **443.25** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | NY Close 23-01 | 443.25 | 446.00 | 440.75 | **443.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Asia 07-11 | 443.25 | 446.00 | 440.75 | **442.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 05/08** | Asia 11-15 | 442.75 | 445.75 | 439.50 | **442.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 05/08** | London 15-19 | 442.50 | 446.50 | 437.25 | **443.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Pre-NY 19-21 | 443.00 | 447.75 | 436.00 | **445.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | NY Open 21-23 | 445.00 | 453.00 | 438.00 | **446.50** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | NY Close 23-01 | 446.50 | 451.00 | 442.25 | **446.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 06/08** | Asia 07-11 | 446.00 | 448.25 | 443.25 | **445.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 06/08** | Asia 11-15 | 445.75 | 447.75 | 441.25 | **446.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | London 15-19 | 446.00 | 449.75 | 443.25 | **446.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | Pre-NY 19-21 | 446.50 | 449.50 | 442.00 | **446.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | NY Open 21-23 | 446.75 | 451.00 | 443.50 | **447.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | NY Close 23-01 | 447.50 | 451.00 | 445.25 | **447.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | Asia 07-11 | 447.50 | 451.25 | 444.00 | **447.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | Asia 11-15 | 447.25 | 450.75 | 444.00 | **447.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | London 15-19 | 447.00 | 450.00 | 444.25 | **447.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | Pre-NY 19-21 | 447.25 | 450.25 | 444.50 | **447.25** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 07/08** | NY Open 21-23 | 447.25 | 451.25 | 443.75 | **447.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | NY Close 23-01 | 447.75 | 451.75 | 446.00 | **447.50** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 639.75 cents | **Dự báo Chốt Phiên:** **`641.38 cents`** (+1.63).
*   **Thanh khoản phiên chốt:** Volume: **`2,999`** (Chênh lệch: **`-65,849`**) | OI: **`188,160`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$79.64** | **+0.24%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.74** | **+0.05%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (642.45) < `EMA_50` (643.65).
*   **Động lượng & Dao động:** RSI (14) = **`44.11`** | ATR (14) = **`3.39`** cents | Volatility = **`1.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`636.50`** | S2: **`598.50`** || Kháng cự R1: **`642.00`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`642.45 - 643.65 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`716.34 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `636.50 cents` / `598.50 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`634.50 - 636.50 cents`** | SL: **`595.11 cents`** | TP: **`642.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`642.00 - 644.00 cents`** | SL: **`645.39 cents`** | TP: **`598.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 03/08** | Asia 07-11 | 639.75 | 651.00 | 634.25 | **639.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 03/08** | Asia 11-15 | 639.00 | 646.50 | 633.00 | **638.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 03/08** | London 15-19 | 638.50 | 652.25 | 623.75 | **640.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | Pre-NY 19-21 | 640.50 | 653.75 | 632.25 | **641.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | NY Open 21-23 | 641.75 | 658.25 | 631.25 | **646.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | NY Close 23-01 | 646.25 | 654.00 | 635.25 | **647.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Asia 07-11 | 647.50 | 655.75 | 637.00 | **649.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Asia 11-15 | 649.25 | 661.50 | 639.50 | **648.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 04/08** | London 15-19 | 648.25 | 658.75 | 633.50 | **650.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Pre-NY 19-21 | 650.50 | 661.00 | 644.25 | **651.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | NY Open 21-23 | 651.25 | 665.50 | 636.50 | **653.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | NY Close 23-01 | 653.25 | 659.75 | 646.50 | **653.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Asia 07-11 | 653.50 | 663.75 | 645.50 | **654.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Asia 11-15 | 654.00 | 661.00 | 648.00 | **653.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 05/08** | London 15-19 | 653.25 | 666.75 | 640.25 | **655.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Pre-NY 19-21 | 655.00 | 664.25 | 644.25 | **655.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | NY Open 21-23 | 655.50 | 667.75 | 641.25 | **654.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 05/08** | NY Close 23-01 | 654.00 | 661.00 | 644.50 | **654.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | Asia 07-11 | 654.50 | 665.00 | 647.25 | **654.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 06/08** | Asia 11-15 | 654.25 | 664.00 | 644.50 | **654.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | London 15-19 | 654.75 | 665.50 | 647.50 | **655.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | Pre-NY 19-21 | 655.50 | 662.00 | 647.00 | **656.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | NY Open 21-23 | 656.00 | 667.00 | 644.25 | **659.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | NY Close 23-01 | 659.50 | 665.00 | 651.75 | **660.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | Asia 07-11 | 660.25 | 669.50 | 653.75 | **659.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | Asia 11-15 | 659.50 | 667.00 | 653.50 | **658.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | London 15-19 | 658.50 | 665.50 | 645.00 | **659.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | Pre-NY 19-21 | 659.25 | 668.50 | 652.00 | **659.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | NY Open 21-23 | 659.00 | 667.50 | 645.00 | **660.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | NY Close 23-01 | 660.75 | 667.00 | 654.25 | **660.00** | **-0.75¢** 🔴 | 🔴 BEAR |
