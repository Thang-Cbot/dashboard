...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 21:01 ICT ngày 21/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$100.63 / thùng** | **+0.00%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.34** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$100.63` (+0.00%)** | DXY: **`100.34` (+0.00%)** | Lúa mì CBOT: **`724.50¢` (+0.00%)**.
...
*Cập nhật tự động lúc 21:01 ICT ngày 21/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **21/09/2026** | **ZC** | **538.00 ¢** | **538.19 ¢ (+0.19)** | 🐂 Bullish (532.64 > 532.02) | 5.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-21092026) |
| **21/09/2026** | **ZW** | **724.50 ¢** | **725.96 ¢ (+1.46)** | 🐻 Bearish (722.97 < 723.77) | 4.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-21092026) |
| **21/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **536.75 - 532.64 cents (Canh mua vùng hỗ trợ)** | **480.03 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `539.25 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **535.25 - 536.75 cents** | **481.10 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **539.25 - 540.75 cents** | **541.40 cents** | **484.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **474.66 - 483.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **722.97 - 723.77 cents (Canh bán hồi kỹ thuật H1)** | **801.07 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `720.00 cents` \| TP2: `677.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **718.00 - 720.00 cents** | **672.96 cents** | **728.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **728.50 - 730.50 cents** | **732.54 cents** | **677.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **660.83 - 677.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 538.00 cents | **Dự báo Chốt Phiên:** **`538.19 cents`** (+0.19).
*   **Thanh khoản phiên chốt:** Volume: **`73,968`** (Chênh lệch: **`+48,688`**) | OI: **`942,310`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$100.63** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **100.34** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (532.64) > `EMA_50` (532.02).
*   **Động lượng & Dao động:** RSI (14) = **`69.50`** | ATR (14) = **`2.15`** cents | Volatility = **`5.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`536.75`** | S2: **`483.25`** || Kháng cự R1: **`539.25`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`536.75 - 532.64 cents (Canh mua vùng hỗ trợ)`** | SL: **`480.03 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `539.25 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`535.25 - 536.75 cents`** | SL: **`481.10 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`539.25 - 540.75 cents`** | SL: **`541.40 cents`** | TP: **`484.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`474.66 - 483.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 21/09** | Asia 07-11 | 538.00 | 541.75 | 534.75 | **538.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | Asia 11-15 | 538.25 | 541.00 | 534.50 | **537.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 21/09** | London 15-19 | 537.75 | 540.75 | 533.75 | **538.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | Pre-NY 19-21 | 538.50 | 543.00 | 533.50 | **539.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Open 21-23 | 539.25 | 544.75 | 533.00 | **541.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Close 23-01 | 541.50 | 544.50 | 537.25 | **541.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 07-11 | 541.75 | 545.00 | 535.25 | **542.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 11-15 | 542.50 | 545.50 | 538.00 | **542.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 22/09** | London 15-19 | 542.00 | 546.00 | 536.25 | **542.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Pre-NY 19-21 | 542.50 | 545.00 | 539.25 | **543.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Open 21-23 | 543.00 | 546.50 | 537.00 | **544.00** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Close 23-01 | 544.00 | 546.75 | 541.50 | **544.00** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Asia 07-11 | 544.00 | 546.75 | 541.50 | **543.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | Asia 11-15 | 543.50 | 546.50 | 540.25 | **543.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | London 15-19 | 543.25 | 547.25 | 538.00 | **543.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Pre-NY 19-21 | 543.75 | 548.50 | 536.75 | **545.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | NY Open 21-23 | 545.75 | 553.75 | 538.75 | **547.25** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | NY Close 23-01 | 547.25 | 551.75 | 543.00 | **546.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 24/09** | Asia 07-11 | 546.75 | 549.00 | 544.00 | **546.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 24/09** | Asia 11-15 | 546.50 | 548.50 | 542.00 | **546.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | London 15-19 | 546.75 | 550.50 | 544.00 | **547.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | Pre-NY 19-21 | 547.25 | 550.25 | 542.75 | **547.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Open 21-23 | 547.50 | 551.75 | 544.25 | **548.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Close 23-01 | 548.25 | 551.75 | 546.00 | **548.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Asia 07-11 | 548.25 | 552.00 | 544.75 | **548.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | Asia 11-15 | 548.00 | 551.50 | 544.75 | **547.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | London 15-19 | 547.75 | 550.75 | 545.00 | **548.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Pre-NY 19-21 | 548.00 | 551.00 | 545.25 | **548.00** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 25/09** | NY Open 21-23 | 548.00 | 552.00 | 544.50 | **548.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | NY Close 23-01 | 548.50 | 552.50 | 546.75 | **548.25** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 724.50 cents | **Dự báo Chốt Phiên:** **`725.96 cents`** (+1.46).
*   **Thanh khoản phiên chốt:** Volume: **`27,608`** (Chênh lệch: **`+21,439`**) | OI: **`257,967`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Bullish Engulfing (Nhấn chìm tăng trưởng)`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$100.63** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **100.34** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (722.97) < `EMA_50` (723.77).
*   **Động lượng & Dao động:** RSI (14) = **`53.18`** | ATR (14) = **`4.04`** cents | Volatility = **`4.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`720.00`** | S2: **`677.00`** || Kháng cự R1: **`728.50`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`722.97 - 723.77 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`801.07 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `720.00 cents` / `677.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`718.00 - 720.00 cents`** | SL: **`672.96 cents`** | TP: **`728.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`728.50 - 730.50 cents`** | SL: **`732.54 cents`** | TP: **`677.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`660.83 - 677.00 cents`**
