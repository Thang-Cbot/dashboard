...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 22:01 ICT ngày 17/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$103.33 / thùng** | **-2.36%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.11** | **-0.20%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$103.33` (-2.36%)** | DXY: **`100.11` (-0.20%)** | Lúa mì CBOT: **`723.50¢` (-0.92%)**.
...
*Cập nhật tự động lúc 22:01 ICT ngày 17/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **17/09/2026** | **ZC** | **528.25 ¢** | **529.48 ¢ (+1.23)** | 🐻 Bearish (533.03 < 533.11) | 3.25 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-17092026) |
| **17/09/2026** | **ZW** | **723.50 ¢** | **725.94 ¢ (+2.44)** | 🐻 Bearish (726.60 < 727.12) | 4.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-17092026) |
| **17/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **526.75 - 533.03 cents (Canh mua vùng hỗ trợ)** | **466.70 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `530.00 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **525.25 - 526.75 cents** | **467.97 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **530.00 - 531.50 cents** | **532.53 cents** | **471.50 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **460.38 - 470.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **726.60 - 727.12 cents (Canh bán hồi kỹ thuật H1)** | **803.87 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `719.25 cents` \| TP2: `661.75 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **717.25 - 719.25 cents** | **655.84 cents** | **731.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **731.00 - 733.00 cents** | **736.91 cents** | **661.75 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **638.11 - 661.75 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 528.25 cents | **Dự báo Chốt Phiên:** **`529.48 cents`** (+1.23).
*   **Thanh khoản phiên chốt:** Volume: **`95,091`** (Chênh lệch: **`-107,217`**) | OI: **`949,969`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$103.33** | **-2.36%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.11** | **-0.20%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (533.03) < `EMA_50` (533.11).
*   **Động lượng & Dao động:** RSI (14) = **`34.01`** | ATR (14) = **`2.53`** cents | Volatility = **`3.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`526.75`** | S2: **`470.50`** || Kháng cự R1: **`530.00`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`526.75 - 533.03 cents (Canh mua vùng hỗ trợ)`** | SL: **`466.70 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `530.00 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`525.25 - 526.75 cents`** | SL: **`467.97 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`530.00 - 531.50 cents`** | SL: **`532.53 cents`** | TP: **`471.50 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`460.38 - 470.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 723.50 cents | **Dự báo Chốt Phiên:** **`725.94 cents`** (+2.44).
*   **Thanh khoản phiên chốt:** Volume: **`29,831`** (Chênh lệch: **`-40,978`**) | OI: **`259,398`** (Chênh lệch: **`+1`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$103.33** | **-2.36%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.11** | **-0.20%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (726.60) < `EMA_50` (727.12).
*   **Động lượng & Dao động:** RSI (14) = **`45.49`** | ATR (14) = **`5.91`** cents | Volatility = **`4.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`719.25`** | S2: **`661.75`** || Kháng cự R1: **`731.00`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`726.60 - 727.12 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`803.87 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `719.25 cents` / `661.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`717.25 - 719.25 cents`** | SL: **`655.84 cents`** | TP: **`731.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`731.00 - 733.00 cents`** | SL: **`736.91 cents`** | TP: **`661.75 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`638.11 - 661.75 cents`**
