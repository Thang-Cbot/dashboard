...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 18:39 ICT ngày 21/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$96.95 / thùng** | **+0.00%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$96.95` (+0.00%)** | DXY: **`100.27` (+0.00%)** | Lúa mì CBOT: **`721.50¢` (+0.00%)**.
...
*Cập nhật tự động lúc 18:39 ICT ngày 21/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **21/09/2026** | **ZC** | **533.25 ¢** | **533.95 ¢ (+0.70)** | 🐂 Bullish (531.92 > 531.68) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-21092026) |
| **21/09/2026** | **ZW** | **721.50 ¢** | **722.49 ¢ (+0.99)** | 🐻 Bearish (722.72 < 723.74) | 1.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-21092026) |
| **21/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **532.00 - 531.92 cents (Canh mua vùng hỗ trợ)** | **481.22 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `534.00 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **530.50 - 532.00 cents** | **481.89 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **534.00 - 535.50 cents** | **535.36 cents** | **484.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **477.83 - 483.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **722.72 - 723.74 cents (Canh bán hồi kỹ thuật H1)** | **799.46 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `720.00 cents` \| TP2: `677.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **718.00 - 720.00 cents** | **674.02 cents** | **725.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **725.75 - 727.75 cents** | **728.73 cents** | **677.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **665.10 - 677.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 533.25 cents | **Dự báo Chốt Phiên:** **`533.95 cents`** (+0.70).
*   **Thanh khoản phiên chốt:** Volume: **`34,978`** (Chênh lệch: **`+9,698`**) | OI: **`942,310`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$96.95** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (531.92) > `EMA_50` (531.68).
*   **Động lượng & Dao động:** RSI (14) = **`57.31`** | ATR (14) = **`1.36`** cents | Volatility = **`0.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`532.00`** | S2: **`483.25`** || Kháng cự R1: **`534.00`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`532.00 - 531.92 cents (Canh mua vùng hỗ trợ)`** | SL: **`481.22 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `534.00 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`530.50 - 532.00 cents`** | SL: **`481.89 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`534.00 - 535.50 cents`** | SL: **`535.36 cents`** | TP: **`484.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`477.83 - 483.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 21/09** | Asia 07-11 | 533.25 | 537.00 | 530.00 | **533.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | Asia 11-15 | 533.50 | 536.25 | 529.75 | **533.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 21/09** | London 15-19 | 533.00 | 536.00 | 529.00 | **533.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | Pre-NY 19-21 | 533.75 | 538.25 | 528.75 | **534.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Open 21-23 | 534.50 | 540.00 | 528.25 | **536.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Close 23-01 | 536.75 | 539.75 | 532.50 | **537.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 07-11 | 537.00 | 540.25 | 530.50 | **537.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 11-15 | 537.75 | 540.75 | 533.25 | **537.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 22/09** | London 15-19 | 537.25 | 541.25 | 531.50 | **537.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Pre-NY 19-21 | 537.75 | 540.25 | 534.50 | **538.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Open 21-23 | 538.25 | 541.75 | 532.25 | **539.25** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Close 23-01 | 539.25 | 542.00 | 536.75 | **539.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Asia 07-11 | 539.25 | 542.00 | 536.75 | **538.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | Asia 11-15 | 538.75 | 541.75 | 535.50 | **538.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | London 15-19 | 538.50 | 542.50 | 533.25 | **539.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Pre-NY 19-21 | 539.00 | 543.75 | 532.00 | **541.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | NY Open 21-23 | 541.00 | 549.00 | 534.00 | **542.50** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | NY Close 23-01 | 542.50 | 547.00 | 538.25 | **542.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 24/09** | Asia 07-11 | 542.00 | 544.25 | 539.25 | **541.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 24/09** | Asia 11-15 | 541.75 | 543.75 | 537.25 | **542.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | London 15-19 | 542.00 | 545.75 | 539.25 | **542.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | Pre-NY 19-21 | 542.50 | 545.50 | 538.00 | **542.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Open 21-23 | 542.75 | 547.00 | 539.50 | **543.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Close 23-01 | 543.50 | 547.00 | 541.25 | **543.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Asia 07-11 | 543.50 | 547.25 | 540.00 | **543.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | Asia 11-15 | 543.25 | 546.75 | 540.00 | **543.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | London 15-19 | 543.00 | 546.00 | 540.25 | **543.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Pre-NY 19-21 | 543.25 | 546.25 | 540.50 | **543.25** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 25/09** | NY Open 21-23 | 543.25 | 547.25 | 539.75 | **543.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | NY Close 23-01 | 543.75 | 547.75 | 542.00 | **543.50** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 721.50 cents | **Dự báo Chốt Phiên:** **`722.49 cents`** (+0.99).
*   **Thanh khoản phiên chốt:** Volume: **`12,920`** (Chênh lệch: **`+6,751`**) | OI: **`257,967`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$96.95** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (722.72) < `EMA_50` (723.74).
*   **Động lượng & Dao động:** RSI (14) = **`46.59`** | ATR (14) = **`2.98`** cents | Volatility = **`1.75 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`722.72 - 723.74 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`799.46 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `720.00 cents` / `677.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`718.00 - 720.00 cents`** | SL: **`674.02 cents`** | TP: **`725.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`725.75 - 727.75 cents`** | SL: **`728.73 cents`** | TP: **`677.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`665.10 - 677.00 cents`**
