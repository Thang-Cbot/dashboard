...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 13:44 ICT ngày 11/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.89 / thùng** | **+1.33%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.86** | **+0.05%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.89` (+1.33%)** | DXY: **`99.86` (+0.05%)** | Lúa mì CBOT: **`643.50¢` (+0.51%)**.
...
*Cập nhật tự động lúc 13:44 ICT ngày 11/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **11/08/2026** | **ZC** | **438.75 ¢** | **439.36 ¢ (+0.61)** | 🐻 Bearish (439.35 < 439.96) | 1.25 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-11082026) |
| **11/08/2026** | **ZW** | **643.50 ¢** | **644.89 ¢ (+1.39)** | 🐂 Bullish (644.15 > 643.42) | 3.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-11082026) |
| **11/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **437.75 - 439.35 cents (Canh mua vùng hỗ trợ)** | **424.73 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `439.50 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **436.25 - 437.75 cents** | **425.40 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **439.50 - 441.00 cents** | **440.85 cents** | **427.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **441.76 - 447.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **644.15 - 643.42 cents (Canh bán hồi kỹ thuật H1)** | **716.00 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `641.75 cents` \| TP2: `602.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **639.75 - 641.75 cents** | **599.09 cents** | **646.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **646.00 - 648.00 cents** | **649.16 cents** | **602.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **606.04 - 618.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 438.75 cents | **Dự báo Chốt Phiên:** **`439.36 cents`** (+0.61).
*   **Thanh khoản phiên chốt:** Volume: **`4,860`** (Chênh lệch: **`-147,885`**) | OI: **`394,941`** (Chênh lệch: **`-43,920`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.89** | **+1.33%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.86** | **+0.05%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (439.35) < `EMA_50` (439.96).
*   **Động lượng & Dao động:** RSI (14) = **`45.20`** | ATR (14) = **`1.35`** cents | Volatility = **`1.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`437.75`** | S2: **`426.75`** || Kháng cự R1: **`439.50`** | R2: **`468.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`437.75 - 439.35 cents (Canh mua vùng hỗ trợ)`** | SL: **`424.73 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `439.50 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`436.25 - 437.75 cents`** | SL: **`425.40 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`439.50 - 441.00 cents`** | SL: **`440.85 cents`** | TP: **`427.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`441.76 - 447.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 643.50 cents | **Dự báo Chốt Phiên:** **`644.89 cents`** (+1.39).
*   **Thanh khoản phiên chốt:** Volume: **`2,305`** (Chênh lệch: **`-84,412`**) | OI: **`146,652`** (Chênh lệch: **`-18,038`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.89** | **+1.33%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.86** | **+0.05%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (644.15) > `EMA_50` (643.42).
*   **Động lượng & Dao động:** RSI (14) = **`48.64`** | ATR (14) = **`3.16`** cents | Volatility = **`3.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`641.75`** | S2: **`602.25`** || Kháng cự R1: **`646.00`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`644.15 - 643.42 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`716.00 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `641.75 cents` / `602.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`639.75 - 641.75 cents`** | SL: **`599.09 cents`** | TP: **`646.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`646.00 - 648.00 cents`** | SL: **`649.16 cents`** | TP: **`602.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`606.04 - 618.00 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 643.50 | 654.75 | 638.00 | **642.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 642.75 | 650.25 | 636.75 | **642.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 642.25 | 656.00 | 627.50 | **644.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 644.25 | 657.50 | 636.00 | **645.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 645.50 | 662.00 | 635.00 | **650.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 650.00 | 657.75 | 639.00 | **651.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 651.25 | 659.50 | 640.75 | **653.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 653.00 | 665.25 | 643.25 | **652.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 652.00 | 662.50 | 637.25 | **654.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 654.25 | 664.75 | 648.00 | **655.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 655.00 | 669.25 | 640.25 | **657.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 657.00 | 663.50 | 650.25 | **657.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 657.25 | 667.50 | 649.25 | **657.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 657.75 | 664.75 | 651.75 | **657.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 657.00 | 670.50 | 644.00 | **658.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 658.75 | 668.00 | 648.00 | **659.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 659.25 | 671.50 | 645.00 | **657.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 657.75 | 664.75 | 648.25 | **658.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 658.25 | 668.75 | 651.00 | **658.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 658.00 | 667.75 | 648.25 | **658.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 658.50 | 669.25 | 651.25 | **659.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 659.25 | 665.75 | 650.75 | **659.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 659.75 | 670.75 | 648.00 | **663.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 663.25 | 668.75 | 655.50 | **664.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 664.00 | 673.25 | 657.50 | **663.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 663.25 | 670.75 | 657.25 | **662.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 662.25 | 669.25 | 648.75 | **663.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 663.00 | 672.25 | 655.75 | **662.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 662.75 | 671.25 | 648.75 | **664.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 664.50 | 670.75 | 658.00 | **663.75** | **-0.75¢** 🔴 | 🔴 BEAR |
