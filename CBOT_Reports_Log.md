...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 14:01 ICT ngày 22/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$97.49 / thùng** | **-2.84%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.44** | **+0.01%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$97.49` (-2.84%)** | DXY: **`100.44` (+0.01%)** | Lúa mì CBOT: **`723.25¢` (-0.48%)**.
...
*Cập nhật tự động lúc 14:01 ICT ngày 22/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **22/09/2026** | **ZC** | **542.75 ¢** | **543.42 ¢ (+0.67)** | 🐂 Bullish (539.24 > 535.82) | 1.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-22092026) |
| **22/09/2026** | **ZW** | **723.25 ¢** | **724.88 ¢ (+1.63)** | 🐂 Bullish (724.67 > 724.45) | 4.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-22092026) |
| **22/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **539.75 - 539.24 cents (Canh mua vùng hỗ trợ)** | **483.38 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `543.75 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **553.50 - 555.00 cents** | **500.39 cents (Chống quét SL tuyệt đối)** | **563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **558.00 - 559.50 cents** | **559.61 cents** | **503.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **478.61 - 486.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **724.67 - 724.45 cents (Canh bán hồi kỹ thuật H1)** | **800.97 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `720.00 cents` \| TP2: `677.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **718.00 - 720.00 cents** | **673.02 cents** | **725.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **725.75 - 727.75 cents** | **729.73 cents** | **677.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **661.08 - 677.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 542.75 cents | **Dự báo Chốt Phiên:** **`543.42 cents`** (+0.67).
*   **Thanh khoản phiên chốt:** Volume: **`14,323`** (Chênh lệch: **`-172,035`**) | OI: **`941,835`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$97.49** | **-2.84%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.44** | **+0.01%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (539.24) > `EMA_50` (535.82).
*   **Động lượng & Dao động:** RSI (14) = **`68.46`** | ATR (14) = **`1.91`** cents | Volatility = **`1.75 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`539.75 - 539.24 cents (Canh mua vùng hỗ trợ)`** | SL: **`483.38 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `543.75 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`553.50 - 555.00 cents`** | SL: **`500.39 cents (Chống quét SL tuyệt đối)`** | TP: **`563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`558.00 - 559.50 cents`** | SL: **`559.61 cents`** | TP: **`503.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`478.61 - 486.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 723.25 cents | **Dự báo Chốt Phiên:** **`724.88 cents`** (+1.63).
*   **Thanh khoản phiên chốt:** Volume: **`4,144`** (Chênh lệch: **`-44,556`**) | OI: **`256,242`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
*   **Dòng tiền (Volume + OI):** **`Giảm suy yếu / Đáy ngắn hạn (Long Liquidation Decline)`**
*   **Đánh giá xu hướng kết hợp:** 📉 **TÍCH LŨY TIÊU CỰC (Distribution):** Nến đi ngang nhưng dòng tiền rút dần (OI giảm), cảnh báo rủi ro suy sụt sắp tới.
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$97.49** | **-2.84%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.44** | **+0.01%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (724.67) > `EMA_50` (724.45).
*   **Động lượng & Dao động:** RSI (14) = **`47.47`** | ATR (14) = **`3.98`** cents | Volatility = **`4.00 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`724.67 - 724.45 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`800.97 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `720.00 cents` / `677.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`718.00 - 720.00 cents`** | SL: **`673.02 cents`** | TP: **`725.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`725.75 - 727.75 cents`** | SL: **`729.73 cents`** | TP: **`677.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`661.08 - 677.00 cents`**
