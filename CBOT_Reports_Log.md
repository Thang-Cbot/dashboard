...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 11:38 ICT ngày 20/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$91.95 / thùng** | **+0.36%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **98.82** | **-0.01%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$91.95` (+0.36%)** | DXY: **`98.82` (-0.01%)** | Lúa mì CBOT: **`699.00¢` (+2.76%)**.
...
*Cập nhật tự động lúc 11:38 ICT ngày 20/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **20/08/2026** | **ZC** | **501.75 ¢** | **499.36 ¢ (-2.39)** | 🐂 Bullish (493.63 > 490.06) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-20082026) |
| **20/08/2026** | **ZW** | **699.00 ¢** | **701.31 ¢ (+2.31)** | 🐂 Bullish (690.36 > 687.35) | 1.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-20082026) |
| **20/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **490.50 - 493.63 cents (Canh mua vùng hỗ trợ)** | **453.65 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `500.80 cents` \| TP2: `502.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **504.75 - 506.25 cents** | **470.84 cents (Chống quét SL tuyệt đối)** | **516.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **515.92 - 517.42 cents** | **518.08 cents** | **474.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **447.66 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **690.36 - 687.35 cents (Canh bán hồi kỹ thuật H1)** | **734.86 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `695.25 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
...
*   **Giá Chốt Phiên (Close):** 501.75 cents | **Dự báo Chốt Phiên:** **`499.36 cents`** (-2.39).
*   **Thanh khoản phiên chốt:** Volume: **`63,448`** (Chênh lệch: **`-156,630`**) | OI: **`925,389`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$91.95** | **+0.36%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **98.82** | **-0.01%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (493.63) > `EMA_50` (490.06).
*   **Động lượng & Dao động:** RSI (14) = **`82.95`** | ATR (14) = **`2.40`** cents | Volatility = **`0.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`490.50`** | S2: **`457.25`** || Kháng cự R1: **`500.80`** | R2: **`502.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`490.50 - 493.63 cents (Canh mua vùng hỗ trợ)`** | SL: **`453.65 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `500.80 cents` / `502.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`504.75 - 506.25 cents`** | SL: **`470.84 cents (Chống quét SL tuyệt đối)`** | TP: **`516.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`515.92 - 517.42 cents`** | SL: **`518.08 cents`** | TP: **`474.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`447.66 - 457.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 17/08** | Asia 07-11 | 501.75 | 505.50 | 498.50 | **502.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | Asia 11-15 | 502.00 | 504.75 | 498.25 | **501.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 17/08** | London 15-19 | 501.50 | 504.50 | 497.50 | **502.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | Pre-NY 19-21 | 502.25 | 506.75 | 497.25 | **503.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Open 21-23 | 503.00 | 508.50 | 496.75 | **505.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Close 23-01 | 505.25 | 508.25 | 501.00 | **505.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 07-11 | 505.50 | 508.75 | 499.00 | **506.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 11-15 | 506.25 | 509.25 | 501.75 | **505.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 18/08** | London 15-19 | 505.75 | 509.75 | 500.00 | **506.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Pre-NY 19-21 | 506.25 | 508.75 | 503.00 | **506.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Open 21-23 | 506.75 | 510.25 | 500.75 | **507.75** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Close 23-01 | 507.75 | 510.50 | 505.25 | **507.75** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Asia 07-11 | 507.75 | 510.50 | 505.25 | **507.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | Asia 11-15 | 507.25 | 510.25 | 504.00 | **507.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | London 15-19 | 507.00 | 511.00 | 501.75 | **507.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Pre-NY 19-21 | 507.50 | 512.25 | 500.50 | **509.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | NY Open 21-23 | 509.50 | 517.50 | 502.50 | **511.00** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | NY Close 23-01 | 511.00 | 515.50 | 506.75 | **510.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 20/08** | Asia 07-11 | 510.50 | 512.75 | 507.75 | **510.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 20/08** | Asia 11-15 | 510.25 | 512.25 | 505.75 | **510.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | London 15-19 | 510.50 | 514.25 | 507.75 | **511.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | Pre-NY 19-21 | 511.00 | 514.00 | 506.50 | **511.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Open 21-23 | 511.25 | 515.50 | 508.00 | **512.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Close 23-01 | 512.00 | 515.50 | 509.75 | **512.00** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Asia 07-11 | 512.00 | 515.75 | 508.50 | **511.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | Asia 11-15 | 511.75 | 515.25 | 508.50 | **511.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | London 15-19 | 511.50 | 514.50 | 508.75 | **511.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Pre-NY 19-21 | 511.75 | 514.75 | 509.00 | **511.75** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 21/08** | NY Open 21-23 | 511.75 | 515.75 | 508.25 | **512.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | NY Close 23-01 | 512.25 | 516.25 | 510.50 | **512.00** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 699.00 cents | **Dự báo Chốt Phiên:** **`701.31 cents`** (+2.31).
*   **Thanh khoản phiên chốt:** Volume: **`2,219`** (Chênh lệch: **`-92,419`**) | OI: **`236,087`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$91.95** | **+0.36%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **98.82** | **-0.01%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (690.36) > `EMA_50` (687.35).
*   **Động lượng & Dao động:** RSI (14) = **`65.14`** | ATR (14) = **`4.41`** cents | Volatility = **`1.50 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`690.36 - 687.35 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`734.86 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `695.25 cents` / `645.25 cents`.
