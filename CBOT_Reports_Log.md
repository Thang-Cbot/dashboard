...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 07:01 ICT ngày 11/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$87.68 / thùng** | **+0.00%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$87.68` (+0.00%)** | DXY: **`99.79` (+0.00%)** | Lúa mì CBOT: **`639.50¢` (+0.00%)**.
...
*Cập nhật tự động lúc 07:01 ICT ngày 11/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$87.68** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$87.68** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
