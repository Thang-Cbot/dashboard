...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 11:01 ICT ngày 13/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.23 / thùng** | **+0.00%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.01** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.23` (+0.00%)** | DXY: **`100.01` (+0.00%)** | Lúa mì CBOT: **`652.75¢` (+0.00%)**.
...
*Cập nhật tự động lúc 11:01 ICT ngày 13/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **13/08/2026** | **ZC** | **454.00 ¢** | **454.09 ¢ (+0.09)** | 🐂 Bullish (446.33 > 442.71) | 0.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-13082026) |
| **13/08/2026** | **ZW** | **652.00 ¢** | **654.31 ¢ (+2.31)** | 🐂 Bullish (647.88 > 644.55) | 0.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-13082026) |
| **13/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **451.50 - 446.33 cents (Canh mua vùng hỗ trợ)** | **422.52 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `455.75 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **450.00 - 451.50 cents** | **423.93 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **455.75 - 457.25 cents** | **458.57 cents** | **427.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **436.38 - 447.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **647.88 - 644.55 cents (Canh bán hồi kỹ thuật H1)** | **717.42 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `647.00 cents` \| TP2: `614.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **645.00 - 647.00 cents** | **609.89 cents** | **656.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **656.50 - 658.50 cents** | **660.61 cents** | **614.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **613.02 - 628.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 454.00 cents | **Dự báo Chốt Phiên:** **`454.09 cents`** (+0.09).
*   **Thanh khoản phiên chốt:** Volume: **`210,158`** (Chênh lệch: **`+0`**) | OI: **`320,226`** (Chênh lệch: **`-34,424`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.23** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **100.01** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (446.33) > `EMA_50` (442.71).
*   **Động lượng & Dao động:** RSI (14) = **`72.06`** | ATR (14) = **`2.82`** cents | Volatility = **`0.00 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`451.50 - 446.33 cents (Canh mua vùng hỗ trợ)`** | SL: **`422.52 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `455.75 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`450.00 - 451.50 cents`** | SL: **`423.93 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`455.75 - 457.25 cents`** | SL: **`458.57 cents`** | TP: **`427.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`436.38 - 447.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 652.00 cents | **Dự báo Chốt Phiên:** **`654.31 cents`** (+2.31).
*   **Thanh khoản phiên chốt:** Volume: **`124,636`** (Chênh lệch: **`+0`**) | OI: **`113,806`** (Chênh lệch: **`-24,410`**)
*   **Mô hình nến H1:** **`Doji (Nến lưỡng lự thế trận)`**
*   **Dòng tiền (Volume + OI):** **`Tăng yếu / Rủi ro đảo chiều (Short Covering Rally)`**
*   **Đánh giá xu hướng kết hợp:** 📈 **TÍCH LŨY TÍCH CỰC (Accumulation):** Nến đi ngang nhưng dòng tiền âm thầm gia tăng (OI tăng), báo hiệu chuẩn bị có nhịp bứt phá tăng.
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.23** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **100.01** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (647.88) > `EMA_50` (644.55).
*   **Động lượng & Dao động:** RSI (14) = **`59.97`** | ATR (14) = **`4.11`** cents | Volatility = **`0.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`647.00`** | S2: **`614.00`** || Kháng cự R1: **`656.50`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`647.88 - 644.55 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`717.42 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `647.00 cents` / `614.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`645.00 - 647.00 cents`** | SL: **`609.89 cents`** | TP: **`656.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`656.50 - 658.50 cents`** | SL: **`660.61 cents`** | TP: **`614.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`613.02 - 628.50 cents`**
