...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 23:05 ICT ngày 11/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.74 / thùng** | **+1.16%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.74` (+1.16%)** | DXY: **`99.83` (+0.02%)** | Lúa mì CBOT: **`630.50¢` (-1.52%)**.
...
*Cập nhật tự động lúc 23:05 ICT ngày 11/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **11/08/2026** | **ZC** | **436.00 ¢** | **436.81 ¢ (+0.81)** | 🐻 Bearish (438.23 < 439.24) | 2.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-11082026) |
| **11/08/2026** | **ZW** | **630.75 ¢** | **634.03 ¢ (+3.28)** | 🐻 Bearish (639.49 < 641.42) | 3.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-11082026) |
| **11/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **434.75 - 438.23 cents (Canh mua vùng hỗ trợ)** | **423.93 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `438.50 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **433.25 - 434.75 cents** | **424.87 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **438.50 - 440.00 cents** | **440.38 cents** | **427.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **439.83 - 447.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **639.49 - 641.42 cents (Canh bán hồi kỹ thuật H1)** | **718.14 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `626.75 cents` \| TP2: `602.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **644.00 - 646.00 cents** | **613.67 cents** | **653.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **653.50 - 655.50 cents** | **657.83 cents** | **618.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **600.67 - 618.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 436.00 cents | **Dự báo Chốt Phiên:** **`436.81 cents`** (+0.81).
*   **Thanh khoản phiên chốt:** Volume: **`63,747`** (Chênh lệch: **`-88,998`**) | OI: **`394,941`** (Chênh lệch: **`-43,920`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.74** | **+1.16%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (438.23) < `EMA_50` (439.24).
*   **Động lượng & Dao động:** RSI (14) = **`37.32`** | ATR (14) = **`1.88`** cents | Volatility = **`2.75 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`434.75 - 438.23 cents (Canh mua vùng hỗ trợ)`** | SL: **`423.93 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `438.50 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`433.25 - 434.75 cents`** | SL: **`424.87 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`438.50 - 440.00 cents`** | SL: **`440.38 cents`** | TP: **`427.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`439.83 - 447.50 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 436.00 | 439.75 | 432.75 | **436.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Asia 11-15 | 436.25 | 439.00 | 432.50 | **435.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 435.75 | 438.75 | 431.75 | **436.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 436.50 | 441.00 | 431.50 | **437.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 437.25 | 442.75 | 431.00 | **439.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 439.50 | 442.50 | 435.25 | **439.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 439.75 | 443.00 | 433.25 | **440.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 440.50 | 443.50 | 436.00 | **440.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 440.00 | 444.00 | 434.25 | **440.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 440.50 | 443.00 | 437.25 | **441.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 441.00 | 444.50 | 435.00 | **442.00** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 442.00 | 444.75 | 439.50 | **442.00** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 442.00 | 444.75 | 439.50 | **441.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | Asia 11-15 | 441.50 | 444.50 | 438.25 | **441.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 441.25 | 445.25 | 436.00 | **441.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 441.75 | 446.50 | 434.75 | **443.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 443.75 | 451.75 | 436.75 | **445.25** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Close 23-01 | 445.25 | 449.75 | 441.00 | **444.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 07-11 | 444.75 | 447.00 | 442.00 | **444.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 444.50 | 446.50 | 440.00 | **444.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 444.75 | 448.50 | 442.00 | **445.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 445.25 | 448.25 | 440.75 | **445.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 445.50 | 449.75 | 442.25 | **446.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 446.25 | 449.75 | 444.00 | **446.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 446.25 | 450.00 | 442.75 | **446.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 446.00 | 449.50 | 442.75 | **445.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 445.75 | 448.75 | 443.00 | **446.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 446.00 | 449.00 | 443.25 | **446.00** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 446.00 | 450.00 | 442.50 | **446.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 446.50 | 450.50 | 444.75 | **446.25** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 630.75 cents | **Dự báo Chốt Phiên:** **`634.03 cents`** (+3.28).
*   **Thanh khoản phiên chốt:** Volume: **`68,615`** (Chênh lệch: **`-18,102`**) | OI: **`146,654`** (Chênh lệch: **`-18,036`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.74** | **+1.16%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (639.49) < `EMA_50` (641.42).
*   **Động lượng & Dao động:** RSI (14) = **`31.00`** | ATR (14) = **`4.59`** cents | Volatility = **`3.50 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`639.49 - 641.42 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`718.14 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `626.75 cents` / `602.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`644.00 - 646.00 cents`** | SL: **`613.67 cents`** | TP: **`653.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`653.50 - 655.50 cents`** | SL: **`657.83 cents`** | TP: **`618.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`600.67 - 618.00 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 630.75 | 642.00 | 625.25 | **630.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 630.00 | 637.50 | 624.00 | **629.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 629.50 | 643.25 | 614.75 | **631.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 631.50 | 644.75 | 623.25 | **632.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 632.75 | 649.25 | 622.25 | **637.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 637.25 | 645.00 | 626.25 | **638.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 638.50 | 646.75 | 628.00 | **640.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 640.25 | 652.50 | 630.50 | **639.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 639.25 | 649.75 | 624.50 | **641.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 641.50 | 652.00 | 635.25 | **642.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 642.25 | 656.50 | 627.50 | **644.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 644.25 | 650.75 | 637.50 | **644.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 644.50 | 654.75 | 636.50 | **645.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 645.00 | 652.00 | 639.00 | **644.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 644.25 | 657.75 | 631.25 | **646.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 646.00 | 655.25 | 635.25 | **646.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 646.50 | 658.75 | 632.25 | **645.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 645.00 | 652.00 | 635.50 | **645.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 645.50 | 656.00 | 638.25 | **645.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 645.25 | 655.00 | 635.50 | **645.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 645.75 | 656.50 | 638.50 | **646.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 646.50 | 653.00 | 638.00 | **647.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 647.00 | 658.00 | 635.25 | **650.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 650.50 | 656.00 | 642.75 | **651.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 651.25 | 660.50 | 644.75 | **650.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 650.50 | 658.00 | 644.50 | **649.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 649.50 | 656.50 | 636.00 | **650.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 650.25 | 659.50 | 643.00 | **650.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 650.00 | 658.50 | 636.00 | **651.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 651.75 | 658.00 | 645.25 | **651.00** | **-0.75¢** 🔴 | 🔴 BEAR |
