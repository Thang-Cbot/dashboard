...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 19:53 ICT ngày 28/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$87.77 / thùng** | **-2.15%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.23** | **+0.08%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$87.77` (-2.15%)** | DXY: **`99.23` (+0.08%)** | Lúa mì CBOT: **`771.00¢` (+3.77%)**.
...
*Cập nhật tự động lúc 19:53 ICT ngày 28/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **28/08/2026** | **ZC** | **538.50 ¢** | **540.32 ¢ (+1.82)** | 🐂 Bullish (535.96 > 532.07) | 2.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-28082026) |
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **534.25 - 535.96 cents (Canh mua vùng hỗ trợ)** | **452.91 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `539.80 cents` \| TP2: `541.25 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **532.75 - 534.25 cents** | **454.36 cents (Chống quét SL tuyệt đối)** | **540.25 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **539.80 - 541.30 cents** | **542.70 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
...
*   **Giá Chốt Phiên (Close):** 538.50 cents | **Dự báo Chốt Phiên:** **`540.32 cents`** (+1.82).
*   **Thanh khoản phiên chốt:** Volume: **`62,854`** (Chênh lệch: **`-390,957`**) | OI: **`959,357`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$87.77** | **-2.15%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.23** | **+0.08%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (535.96) > `EMA_50` (532.07).
*   **Động lượng & Dao động:** RSI (14) = **`59.04`** | ATR (14) = **`2.89`** cents | Volatility = **`2.75 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`534.25 - 535.96 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.91 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `539.80 cents` / `541.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`532.75 - 534.25 cents`** | SL: **`454.36 cents (Chống quét SL tuyệt đối)`** | TP: **`540.25 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`539.80 - 541.30 cents`** | SL: **`542.70 cents`** | TP: **`458.25 cents`**.
...
*   **Thanh khoản phiên chốt:** Volume: **`26,463`** (Chênh lệch: **`-114,945`**) | OI: **`268,777`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$87.77** | **-2.15%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.23** | **+0.08%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
