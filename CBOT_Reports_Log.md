...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 12:00 ICT ngày 06/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$79.06 / thùng** | **-0.49%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.73** | **+0.04%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$79.06` (-0.49%)** | DXY: **`99.73` (+0.04%)** | Lúa mì CBOT: **`641.75¢` (-0.08%)**.
...
*Cập nhật tự động lúc 12:00 ICT ngày 06/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **06/08/2026** | **ZC** | **437.50 ¢** | **437.87 ¢ (+0.37)** | 🐻 Bearish (438.99 < 441.43) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-06082026) |
| **06/08/2026** | **ZW** | **641.75 ¢** | **643.74 ¢ (+1.99)** | 🐻 Bearish (642.58 < 643.97) | 1.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-06082026) |
| **06/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **436.00 - 438.99 cents (Canh mua vùng hỗ trợ)** | **418.87 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `438.50 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **434.50 - 436.00 cents** | **419.83 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **438.50 - 440.00 cents** | **440.42 cents** | **422.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **432.60 - 440.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **642.58 - 643.97 cents (Canh bán hồi kỹ thuật H1)** | **717.38 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `636.50 cents` \| TP2: `598.50 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **634.50 - 636.50 cents** | **594.41 cents** | **647.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **647.50 - 649.50 cents** | **651.59 cents** | **598.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **596.51 - 613.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 437.50 cents | **Dự báo Chốt Phiên:** **`437.87 cents`** (+0.37).
*   **Thanh khoản phiên chốt:** Volume: **`2,753`** (Chênh lệch: **`-133,909`**) | OI: **`497,935`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$79.06** | **-0.49%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.73** | **+0.04%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (438.99) < `EMA_50` (441.43).
*   **Động lượng & Dao động:** RSI (14) = **`38.55`** | ATR (14) = **`1.92`** cents | Volatility = **`0.75 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`436.00 - 438.99 cents (Canh mua vùng hỗ trợ)`** | SL: **`418.87 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `438.50 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`434.50 - 436.00 cents`** | SL: **`419.83 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`438.50 - 440.00 cents`** | SL: **`440.42 cents`** | TP: **`422.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`432.60 - 440.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 641.75 cents | **Dự báo Chốt Phiên:** **`643.74 cents`** (+1.99).
*   **Thanh khoản phiên chốt:** Volume: **`1,914`** (Chênh lệch: **`-66,934`**) | OI: **`188,160`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$79.06** | **-0.49%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.73** | **+0.04%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (642.58) < `EMA_50` (643.97).
*   **Động lượng & Dao động:** RSI (14) = **`48.07`** | ATR (14) = **`4.09`** cents | Volatility = **`1.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`636.50`** | S2: **`598.50`** || Kháng cự R1: **`647.50`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`642.58 - 643.97 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`717.38 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `636.50 cents` / `598.50 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`634.50 - 636.50 cents`** | SL: **`594.41 cents`** | TP: **`647.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`647.50 - 649.50 cents`** | SL: **`651.59 cents`** | TP: **`598.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`596.51 - 613.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 03/08** | Asia 07-11 | 641.75 | 653.00 | 636.25 | **641.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 03/08** | Asia 11-15 | 641.00 | 648.50 | 635.00 | **640.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 03/08** | London 15-19 | 640.50 | 654.25 | 625.75 | **642.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | Pre-NY 19-21 | 642.50 | 655.75 | 634.25 | **643.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | NY Open 21-23 | 643.75 | 660.25 | 633.25 | **648.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 03/08** | NY Close 23-01 | 648.25 | 656.00 | 637.25 | **649.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Asia 07-11 | 649.50 | 657.75 | 639.00 | **651.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Asia 11-15 | 651.25 | 663.50 | 641.50 | **650.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 04/08** | London 15-19 | 650.25 | 660.75 | 635.50 | **652.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | Pre-NY 19-21 | 652.50 | 663.00 | 646.25 | **653.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | NY Open 21-23 | 653.25 | 667.50 | 638.50 | **655.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 04/08** | NY Close 23-01 | 655.25 | 661.75 | 648.50 | **655.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Asia 07-11 | 655.50 | 665.75 | 647.50 | **656.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Asia 11-15 | 656.00 | 663.00 | 650.00 | **655.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 05/08** | London 15-19 | 655.25 | 668.75 | 642.25 | **657.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | Pre-NY 19-21 | 657.00 | 666.25 | 646.25 | **657.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 05/08** | NY Open 21-23 | 657.50 | 669.75 | 643.25 | **656.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 05/08** | NY Close 23-01 | 656.00 | 663.00 | 646.50 | **656.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | Asia 07-11 | 656.50 | 667.00 | 649.25 | **656.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 06/08** | Asia 11-15 | 656.25 | 666.00 | 646.50 | **656.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | London 15-19 | 656.75 | 667.50 | 649.50 | **657.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | Pre-NY 19-21 | 657.50 | 664.00 | 649.00 | **658.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | NY Open 21-23 | 658.00 | 669.00 | 646.25 | **661.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 06/08** | NY Close 23-01 | 661.50 | 667.00 | 653.75 | **662.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | Asia 07-11 | 662.25 | 671.50 | 655.75 | **661.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | Asia 11-15 | 661.50 | 669.00 | 655.50 | **660.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | London 15-19 | 660.50 | 667.50 | 647.00 | **661.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | Pre-NY 19-21 | 661.25 | 670.50 | 654.00 | **661.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 07/08** | NY Open 21-23 | 661.00 | 669.50 | 647.00 | **662.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 07/08** | NY Close 23-01 | 662.75 | 669.00 | 656.25 | **662.00** | **-0.75¢** 🔴 | 🔴 BEAR |
