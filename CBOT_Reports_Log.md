...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 08:20 ICT ngày 10/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$101.36 / thùng** | **+3.51%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$101.36` (+3.51%)** | DXY: **`98.78` (-0.06%)** | Lúa mì CBOT: **`726.75¢` (-0.48%)**.
...
*Cập nhật tự động lúc 08:20 ICT ngày 10/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **10/09/2026** | **ZC** | **528.00 ¢** | **529.26 ¢ (+1.26)** | 🐻 Bearish (530.76 < 533.43) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-10092026) |
| **10/09/2026** | **ZW** | **726.75 ¢** | **728.98 ¢ (+2.23)** | 🐻 Bearish (738.40 < 744.63) | 1.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-10092026) |
| **10/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **526.50 - 530.76 cents (Canh mua vùng hỗ trợ)** | **453.20 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `530.00 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **525.00 - 526.50 cents** | **454.55 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **530.00 - 531.50 cents** | **532.70 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **446.46 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **738.40 - 744.63 cents (Canh bán hồi kỹ thuật H1)** | **804.16 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `710.50 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **726.50 - 728.50 cents** | **656.78 cents** | **763.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **763.50 - 765.50 cents** | **769.22 cents** | **662.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **620.83 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 528.00 cents | **Dự báo Chốt Phiên:** **`529.26 cents`** (+1.26).
*   **Thanh khoản phiên chốt:** Volume: **`5,787`** (Chênh lệch: **`-206,797`**) | OI: **`979,576`** (Chênh lệch: **`+3`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$101.36** | **+3.51%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (530.76) < `EMA_50` (533.43).
*   **Động lượng & Dao động:** RSI (14) = **`39.56`** | ATR (14) = **`2.70`** cents | Volatility = **`0.75 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`526.50 - 530.76 cents (Canh mua vùng hỗ trợ)`** | SL: **`453.20 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `530.00 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`525.00 - 526.50 cents`** | SL: **`454.55 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`530.00 - 531.50 cents`** | SL: **`532.70 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`446.46 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 726.75 cents | **Dự báo Chốt Phiên:** **`728.98 cents`** (+2.23).
*   **Thanh khoản phiên chốt:** Volume: **`1,969`** (Chênh lệch: **`-100,497`**) | OI: **`261,906`** (Chênh lệch: **`+1`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
*   **Dòng tiền (Volume + OI):** **`Giảm nhẹ tích lũy (Distribution Decline)`**
*   **Đánh giá xu hướng kết hợp:** 📉 **TÍCH LŨY TIÊU CỰC (Distribution):** Nến đi ngang nhưng dòng tiền rút dần (OI giảm), cảnh báo rủi ro suy sụt sắp tới.
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$101.36** | **+3.51%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (738.40) < `EMA_50` (744.63).
*   **Động lượng & Dao động:** RSI (14) = **`35.41`** | ATR (14) = **`6.11`** cents | Volatility = **`1.00 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`738.40 - 744.63 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`804.16 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `710.50 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`726.50 - 728.50 cents`** | SL: **`656.78 cents`** | TP: **`763.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`763.50 - 765.50 cents`** | SL: **`769.22 cents`** | TP: **`662.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`620.83 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 07/09** | Asia 07-11 | 726.75 | 738.00 | 721.25 | **726.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 07/09** | Asia 11-15 | 726.00 | 733.50 | 720.00 | **725.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 07/09** | London 15-19 | 725.50 | 739.25 | 710.75 | **727.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | Pre-NY 19-21 | 727.50 | 740.75 | 719.25 | **728.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | NY Open 21-23 | 728.75 | 745.25 | 718.25 | **733.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | NY Close 23-01 | 733.25 | 741.00 | 722.25 | **734.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Asia 07-11 | 734.50 | 742.75 | 724.00 | **736.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Asia 11-15 | 736.25 | 748.50 | 726.50 | **735.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 08/09** | London 15-19 | 735.25 | 745.75 | 720.50 | **737.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Pre-NY 19-21 | 737.50 | 748.00 | 731.25 | **738.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | NY Open 21-23 | 738.25 | 752.50 | 723.50 | **740.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | NY Close 23-01 | 740.25 | 746.75 | 733.50 | **740.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Asia 07-11 | 740.50 | 750.75 | 732.50 | **741.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Asia 11-15 | 741.00 | 748.00 | 735.00 | **740.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 09/09** | London 15-19 | 740.25 | 753.75 | 727.25 | **742.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Pre-NY 19-21 | 742.00 | 751.25 | 731.25 | **742.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | NY Open 21-23 | 742.50 | 754.75 | 728.25 | **741.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 09/09** | NY Close 23-01 | 741.00 | 748.00 | 731.50 | **741.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | Asia 07-11 | 741.50 | 752.00 | 734.25 | **741.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 10/09** | Asia 11-15 | 741.25 | 751.00 | 731.50 | **741.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | London 15-19 | 741.75 | 752.50 | 734.50 | **742.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | Pre-NY 19-21 | 742.50 | 749.00 | 734.00 | **743.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | NY Open 21-23 | 743.00 | 754.00 | 731.25 | **746.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | NY Close 23-01 | 746.50 | 752.00 | 738.75 | **747.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | Asia 07-11 | 747.25 | 756.50 | 740.75 | **746.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | Asia 11-15 | 746.50 | 754.00 | 740.50 | **745.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | London 15-19 | 745.50 | 752.50 | 732.00 | **746.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | Pre-NY 19-21 | 746.25 | 755.50 | 739.00 | **746.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | NY Open 21-23 | 746.00 | 754.50 | 732.00 | **747.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | NY Close 23-01 | 747.75 | 754.00 | 741.25 | **747.00** | **-0.75¢** 🔴 | 🔴 BEAR |
