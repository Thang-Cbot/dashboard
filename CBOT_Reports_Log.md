...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 06:52 ICT ngày 20/08/2026*
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$91.57` (+0.60%)** | DXY: **`98.77` (-0.89%)** | Lúa mì CBOT: **`696.50¢` (+4.82%)**.
...
*Cập nhật tự động lúc 06:52 ICT ngày 20/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
*   **Giá Chốt Phiên (Close):** 696.50 cents | **Dự báo Chốt Phiên:** **`699.24 cents`** (+2.74).
