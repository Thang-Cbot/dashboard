...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 22:47 ICT ngày 28/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.08 / thùng** | **-1.81%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.53** | **+0.37%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.08` (-1.81%)** | DXY: **`99.53` (+0.37%)** | Lúa mì CBOT: **`789.00¢` (+6.26%)**.
...
*Cập nhật tự động lúc 22:47 ICT ngày 28/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
## 📌 3. DANH MỤC LỊCH SỬ BÁO CÁO (CẬP NHẬT PHIÊN CHỐT 28/08/2026)
*Thời gian đóng cửa phiên giao dịch được đồng bộ chính xác vào lúc **1:20 AM ICT ngày 28/08/2026***

| Ngày Báo Cáo (ICT) | Mã | Giá Chốt (Close) | Dự báo Chốt Phiên | Tín Hiệu H1 (EMA 21/50) | Volatility | Intraday Bias | Xem Chi Tiết |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **28/08/2026** | **ZC** | **538.50 ¢** | **540.34 ¢ (+1.84)** | 🐂 Bullish (536.39 > 532.70) | 2.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-28082026) |
| **28/08/2026** | **ZW** | **789.00 ¢** | **786.88 ¢ (-2.12)** | 🐂 Bullish (766.38 > 751.26) | 7.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-28082026) |
| **28/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **534.25 - 536.39 cents (Canh mua vùng hỗ trợ)** | **452.31 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `539.60 cents` \| TP2: `541.25 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **532.75 - 534.25 cents** | **453.96 cents (Chống quét SL tuyệt đối)** | **540.25 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **539.60 - 541.10 cents** | **542.90 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **444.09 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **766.38 - 751.26 cents (Canh bán hồi kỹ thuật H1)** | **800.96 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `758.00 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **771.00 - 773.00 cents** | **655.33 cents** | **798.66 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **798.66 - 800.66 cents** | **805.84 cents** | **662.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **614.69 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
## 🌽 BÁO CÁO MÃ ZC (NGÔ) — HỒ SƠ ĐỘC LẬP | PHIÊN CHỐT 28/08/2026
...
*   **Giá Chốt Phiên (Close):** 538.50 cents | **Dự báo Chốt Phiên:** **`540.34 cents`** (+1.84).
*   **Thanh khoản phiên chốt:** Volume: **`208,870`** (Chênh lệch: **`-244,941`**) | OI: **`959,316`** (Chênh lệch: **`-41`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.08** | **-1.81%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.53** | **+0.37%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (536.39) > `EMA_50` (532.70).
*   **Động lượng & Dao động:** RSI (14) = **`57.30`** | ATR (14) = **`3.29`** cents | Volatility = **`2.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`534.25`** | S2: **`457.25`** || Kháng cự R1: **`539.60`** | R2: **`541.25`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`534.25 - 536.39 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.31 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `539.60 cents` / `541.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`532.75 - 534.25 cents`** | SL: **`453.96 cents (Chống quét SL tuyệt đối)`** | TP: **`540.25 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`539.60 - 541.10 cents`** | SL: **`542.90 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`444.09 - 457.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 538.50 | 542.25 | 535.25 | **538.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Asia 11-15 | 538.75 | 541.50 | 535.00 | **538.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 538.25 | 541.25 | 534.25 | **539.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 539.00 | 543.50 | 534.00 | **539.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 539.75 | 545.25 | 533.50 | **542.00** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 542.00 | 545.00 | 537.75 | **542.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 542.25 | 545.50 | 535.75 | **543.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 543.00 | 546.00 | 538.50 | **542.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 542.50 | 546.50 | 536.75 | **543.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 543.00 | 545.50 | 539.75 | **543.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 543.50 | 547.00 | 537.50 | **544.50** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 544.50 | 547.25 | 542.00 | **544.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 544.50 | 547.25 | 542.00 | **544.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | Asia 11-15 | 544.00 | 547.00 | 540.75 | **543.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 543.75 | 547.75 | 538.50 | **544.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 544.25 | 549.00 | 537.25 | **546.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 546.25 | 554.25 | 539.25 | **547.75** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Close 23-01 | 547.75 | 552.25 | 543.50 | **547.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 07-11 | 547.25 | 549.50 | 544.50 | **547.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 547.00 | 549.00 | 542.50 | **547.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 547.25 | 551.00 | 544.50 | **547.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 547.75 | 550.75 | 543.25 | **548.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 548.00 | 552.25 | 544.75 | **548.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 548.75 | 552.25 | 546.50 | **548.75** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 548.75 | 552.50 | 545.25 | **548.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 548.50 | 552.00 | 545.25 | **548.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 548.25 | 551.25 | 545.50 | **548.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 548.50 | 551.50 | 545.75 | **548.50** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 548.50 | 552.50 | 545.00 | **549.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 549.00 | 553.00 | 547.25 | **548.75** | **-0.25¢** 🔴 | 🔴 BEAR |
...
## 🌾 BÁO CÁO MÃ ZW (LÚA MÌ) — HỒ SƠ ĐỘC LẬP | PHIÊN CHỐT 28/08/2026
...
*   **Giá Chốt Phiên (Close):** 789.00 cents | **Dự báo Chốt Phiên:** **`786.88 cents`** (-2.12).
*   **Thanh khoản phiên chốt:** Volume: **`76,026`** (Chênh lệch: **`-65,382`**) | OI: **`268,773`** (Chênh lệch: **`-4`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
*   **Dòng tiền (Volume + OI):** **`Tăng yếu / Rủi ro đảo chiều (Short Covering Rally)`**
*   **Đánh giá xu hướng kết hợp:** 📈 **TÍCH LŨY TÍCH CỰC (Accumulation):** Nến đi ngang nhưng dòng tiền âm thầm gia tăng (OI tăng), báo hiệu chuẩn bị có nhịp bứt phá tăng.
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.08** | **-1.81%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.53** | **+0.37%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (766.38) > `EMA_50` (751.26).
*   **Động lượng & Dao động:** RSI (14) = **`76.77`** | ATR (14) = **`7.64`** cents | Volatility = **`7.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`758.00`** | S2: **`645.25`** || Kháng cự R1: **`785.68`** | R2: **`789.50`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`766.38 - 751.26 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`800.96 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `758.00 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`771.00 - 773.00 cents`** | SL: **`655.33 cents`** | TP: **`798.66 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`798.66 - 800.66 cents`** | SL: **`805.84 cents`** | TP: **`662.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`614.69 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 789.00 | 800.25 | 783.50 | **788.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | Asia 11-15 | 788.25 | 795.75 | 782.25 | **787.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 787.75 | 801.50 | 773.00 | **789.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 789.75 | 803.00 | 781.50 | **791.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 791.00 | 807.50 | 780.50 | **795.50** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 795.50 | 803.25 | 784.50 | **796.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 796.75 | 805.00 | 786.25 | **798.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 798.50 | 810.75 | 788.75 | **797.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 797.50 | 808.00 | 782.75 | **799.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 799.75 | 810.25 | 793.50 | **800.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 800.50 | 814.75 | 785.75 | **802.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 802.50 | 809.00 | 795.75 | **802.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 802.75 | 813.00 | 794.75 | **803.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 11-15 | 803.25 | 810.25 | 797.25 | **802.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 802.50 | 816.00 | 789.50 | **804.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 804.25 | 813.50 | 793.50 | **804.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 804.75 | 817.00 | 790.50 | **803.25** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | NY Close 23-01 | 803.25 | 810.25 | 793.75 | **803.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Asia 07-11 | 803.75 | 814.25 | 796.50 | **803.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 803.50 | 813.25 | 793.75 | **804.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 804.00 | 814.75 | 796.75 | **804.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 804.75 | 811.25 | 796.25 | **805.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 805.25 | 816.25 | 793.50 | **808.75** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 808.75 | 814.25 | 801.00 | **809.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 809.50 | 818.75 | 803.00 | **808.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 808.75 | 816.25 | 802.75 | **807.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 807.75 | 814.75 | 794.25 | **808.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 808.50 | 817.75 | 801.25 | **808.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 808.25 | 816.75 | 794.25 | **810.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 810.00 | 816.25 | 803.50 | **809.25** | **-0.75¢** 🔴 | 🔴 BEAR |
