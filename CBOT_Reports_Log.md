...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 11:01 ICT ngày 23/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$99.25 / thùng** | **+0.00%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.70** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$99.25` (+0.00%)** | DXY: **`100.70` (+0.00%)** | Lúa mì CBOT: **`717.25¢` (+0.00%)**.
...
*Cập nhật tự động lúc 11:01 ICT ngày 23/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **23/09/2026** | **ZC** | **532.50 ¢** | **534.57 ¢ (+2.07)** | 🐂 Bullish (537.89 > 535.10) | 0.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-23092026) |
| **23/09/2026** | **ZW** | **708.50 ¢** | **713.89 ¢ (+5.39)** | 🐻 Bearish (723.23 < 723.82) | 0.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-23092026) |
| **23/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **530.75 - 537.89 cents (Canh mua vùng hỗ trợ)** | **484.02 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `534.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **529.25 - 530.75 cents** | **485.60 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **534.50 - 536.00 cents** | **537.65 cents** | **489.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **476.14 - 488.75 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **723.23 - 723.82 cents (Canh bán hồi kỹ thuật H1)** | **803.53 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `698.50 cents` \| TP2: `680.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **696.50 - 698.50 cents** | **674.56 cents** | **713.25 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **713.25 - 715.25 cents** | **718.94 cents** | **680.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **657.51 - 680.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 532.50 cents | **Dự báo Chốt Phiên:** **`534.57 cents`** (+2.07).
*   **Thanh khoản phiên chốt:** Volume: **`247,541`** (Chênh lệch: **`+0`**) | OI: **`932,264`** (Chênh lệch: **`-9,571`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$99.25** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **100.70** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (537.89) > `EMA_50` (535.10).
*   **Động lượng & Dao động:** RSI (14) = **`39.10`** | ATR (14) = **`3.15`** cents | Volatility = **`0.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`530.75`** | S2: **`488.75`** || Kháng cự R1: **`534.50`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`530.75 - 537.89 cents (Canh mua vùng hỗ trợ)`** | SL: **`484.02 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `534.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`529.25 - 530.75 cents`** | SL: **`485.60 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`534.50 - 536.00 cents`** | SL: **`537.65 cents`** | TP: **`489.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`476.14 - 488.75 cents`**
...
*   **Giá Chốt Phiên (Close):** 708.50 cents | **Dự báo Chốt Phiên:** **`713.89 cents`** (+5.39).
*   **Thanh khoản phiên chốt:** Volume: **`60,641`** (Chênh lệch: **`+0`**) | OI: **`256,260`** (Chênh lệch: **`+18`**)
*   **Mô hình nến H1:** **`Doji (Nến lưỡng lự thế trận)`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$99.25** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **100.70** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (723.23) < `EMA_50` (723.82).
*   **Động lượng & Dao động:** RSI (14) = **`29.30`** | ATR (14) = **`5.69`** cents | Volatility = **`0.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`698.50`** | S2: **`680.25`** || Kháng cự R1: **`713.25`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`723.23 - 723.82 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`803.53 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `698.50 cents` / `680.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`696.50 - 698.50 cents`** | SL: **`674.56 cents`** | TP: **`713.25 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`713.25 - 715.25 cents`** | SL: **`718.94 cents`** | TP: **`680.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`657.51 - 680.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 21/09** | Asia 07-11 | 708.50 | 719.75 | 703.00 | **707.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 21/09** | Asia 11-15 | 707.75 | 715.25 | 701.75 | **707.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 21/09** | London 15-19 | 707.25 | 721.00 | 692.50 | **709.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | Pre-NY 19-21 | 709.25 | 722.50 | 701.00 | **710.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Open 21-23 | 710.50 | 727.00 | 700.00 | **715.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Close 23-01 | 715.00 | 722.75 | 704.00 | **716.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 07-11 | 716.25 | 724.50 | 705.75 | **718.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 11-15 | 718.00 | 730.25 | 708.25 | **717.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 22/09** | London 15-19 | 717.00 | 727.50 | 702.25 | **719.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Pre-NY 19-21 | 719.25 | 729.75 | 713.00 | **720.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Open 21-23 | 720.00 | 734.25 | 705.25 | **722.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Close 23-01 | 722.00 | 728.50 | 715.25 | **722.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Asia 07-11 | 722.25 | 732.50 | 714.25 | **722.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Asia 11-15 | 722.75 | 729.75 | 716.75 | **722.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | London 15-19 | 722.00 | 735.50 | 709.00 | **723.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Pre-NY 19-21 | 723.75 | 733.00 | 713.00 | **724.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | NY Open 21-23 | 724.25 | 736.50 | 710.00 | **722.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | NY Close 23-01 | 722.75 | 729.75 | 713.25 | **723.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | Asia 07-11 | 723.25 | 733.75 | 716.00 | **723.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 24/09** | Asia 11-15 | 723.00 | 732.75 | 713.25 | **723.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | London 15-19 | 723.50 | 734.25 | 716.25 | **724.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | Pre-NY 19-21 | 724.25 | 730.75 | 715.75 | **724.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Open 21-23 | 724.75 | 735.75 | 713.00 | **728.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Close 23-01 | 728.25 | 733.75 | 720.50 | **729.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Asia 07-11 | 729.00 | 738.25 | 722.50 | **728.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | Asia 11-15 | 728.25 | 735.75 | 722.25 | **727.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | London 15-19 | 727.25 | 734.25 | 713.75 | **728.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Pre-NY 19-21 | 728.00 | 737.25 | 720.75 | **727.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | NY Open 21-23 | 727.75 | 736.25 | 713.75 | **729.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | NY Close 23-01 | 729.50 | 735.75 | 723.00 | **728.75** | **-0.75¢** 🔴 | 🔴 BEAR |
