...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 06:33 ICT ngày 11/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$108.73 / thùng** | **+7.43%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.09** | **+0.32%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$108.73` (+7.43%)** | DXY: **`99.09` (+0.32%)** | Lúa mì CBOT: **`741.50¢` (+4.25%)**.
...
*Cập nhật tự động lúc 06:33 ICT ngày 11/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **11/09/2026** | **ZC** | **533.50 ¢** | **535.61 ¢ (+2.11)** | 🐻 Bearish (530.93 < 532.05) | 3.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-11092026) |
| **11/09/2026** | **ZW** | **741.50 ¢** | **743.63 ¢ (+2.13)** | 🐻 Bearish (734.13 < 738.34) | 5.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-11092026) |
| **11/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **532.00 - 530.93 cents (Canh mua vùng hỗ trợ)** | **452.89 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `536.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
...
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **536.50 - 538.00 cents** | **539.41 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **445.62 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **734.13 - 738.34 cents (Canh bán hồi kỹ thuật H1)** | **803.73 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `736.50 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **734.50 - 736.50 cents** | **639.43 cents** | **749.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **749.50 - 751.50 cents** | **755.32 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **621.97 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 533.50 cents | **Dự báo Chốt Phiên:** **`535.61 cents`** (+2.11).
*   **Thanh khoản phiên chốt:** Volume: **`224,965`** (Chênh lệch: **`-20,767`**) | OI: **`965,356`** (Chênh lệch: **`-465`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$108.73** | **+7.43%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.09** | **+0.32%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (530.93) < `EMA_50` (532.05).
*   **Động lượng & Dao động:** RSI (14) = **`57.62`** | ATR (14) = **`2.91`** cents | Volatility = **`3.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`532.00`** | S2: **`457.25`** || Kháng cự R1: **`536.50`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`532.00 - 530.93 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.89 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `536.50 cents` / `549.75 cents`.
...
*   **Giá Chốt Phiên (Close):** 741.50 cents | **Dự báo Chốt Phiên:** **`743.63 cents`** (+2.13).
*   **Thanh khoản phiên chốt:** Volume: **`64,126`** (Chênh lệch: **`-34,424`**) | OI: **`262,948`** (Chênh lệch: **`+104`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$108.73** | **+7.43%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.09** | **+0.32%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (734.13) < `EMA_50` (738.34).
*   **Động lượng & Dao động:** RSI (14) = **`59.12`** | ATR (14) = **`5.82`** cents | Volatility = **`5.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`736.50`** | S2: **`645.25`** || Kháng cự R1: **`749.50`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`734.13 - 738.34 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`803.73 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `736.50 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`734.50 - 736.50 cents`** | SL: **`639.43 cents`** | TP: **`749.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`749.50 - 751.50 cents`** | SL: **`755.32 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`621.97 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 14/09** | Asia 07-11 | 741.50 | 752.75 | 736.00 | **740.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | Asia 11-15 | 740.75 | 748.25 | 734.75 | **740.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | London 15-19 | 740.25 | 754.00 | 725.50 | **742.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | Pre-NY 19-21 | 742.25 | 755.50 | 734.00 | **743.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Open 21-23 | 743.50 | 760.00 | 733.00 | **748.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Close 23-01 | 748.00 | 755.75 | 737.00 | **749.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 07-11 | 749.25 | 757.50 | 738.75 | **751.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 11-15 | 751.00 | 763.25 | 741.25 | **750.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 15/09** | London 15-19 | 750.00 | 760.50 | 735.25 | **752.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Pre-NY 19-21 | 752.25 | 762.75 | 746.00 | **753.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Open 21-23 | 753.00 | 767.25 | 738.25 | **755.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Close 23-01 | 755.00 | 761.50 | 748.25 | **755.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 07-11 | 755.25 | 765.50 | 747.25 | **755.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 11-15 | 755.75 | 762.75 | 749.75 | **755.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | London 15-19 | 755.00 | 768.50 | 742.00 | **756.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Pre-NY 19-21 | 756.75 | 766.00 | 746.00 | **757.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | NY Open 21-23 | 757.25 | 769.50 | 743.00 | **755.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | NY Close 23-01 | 755.75 | 762.75 | 746.25 | **756.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Asia 07-11 | 756.25 | 766.75 | 749.00 | **756.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 17/09** | Asia 11-15 | 756.00 | 765.75 | 746.25 | **756.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | London 15-19 | 756.50 | 767.25 | 749.25 | **757.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Pre-NY 19-21 | 757.25 | 763.75 | 748.75 | **757.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Open 21-23 | 757.75 | 768.75 | 746.00 | **761.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Close 23-01 | 761.25 | 766.75 | 753.50 | **762.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Asia 07-11 | 762.00 | 771.25 | 755.50 | **761.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | Asia 11-15 | 761.25 | 768.75 | 755.25 | **760.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | London 15-19 | 760.25 | 767.25 | 746.75 | **761.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Pre-NY 19-21 | 761.00 | 770.25 | 753.75 | **760.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | NY Open 21-23 | 760.75 | 769.25 | 746.75 | **762.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | NY Close 23-01 | 762.50 | 768.75 | 756.00 | **761.75** | **-0.75¢** 🔴 | 🔴 BEAR |
