...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 07:16 ICT ngày 10/07/2026*
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$76.09` (-2.47%)** | DXY: **`100.94` (-0.11%)** | Lúa mì CBOT: **`617.75¢` (+3.25%)**.
...
*Cập nhật tự động lúc 07:16 ICT ngày 10/07/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **10/07/2026** | **ZC** | **429.50 ¢** | **430.41 ¢ (+0.91)** | 🐻 Bearish (432.25 < 433.77) | 1.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-10072026) |
| **10/07/2026** | **ZW** | **617.75 ¢** | **619.99 ¢ (+2.24)** | 🐂 Bullish (613.07 > 611.92) | 2.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-10072026) |
| **10/07/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **427.75 - 432.25 cents (Canh mua vùng hỗ trợ)** | **402.83 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `430.75 cents` \| TP2: `450.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **426.25 - 427.75 cents** | **403.97 cents (Chống quét SL tuyệt đối)** | **449.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **430.75 - 432.25 cents** | **433.03 cents** | **407.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **416.21 - 425.75 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **613.07 - 611.92 cents (Canh bán hồi kỹ thuật H1)** | **632.22 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `614.50 cents` \| TP2: `574.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **612.50 - 614.50 cents** | **570.52 cents** | **619.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **619.75 - 621.75 cents** | **623.23 cents** | **574.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **577.37 - 590.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 429.50 cents | **Dự báo Chốt Phiên:** **`430.41 cents`** (+0.91).
*   **Thanh khoản phiên chốt:** Volume: **`1,014`** (Chênh lệch: **`-163,982`**) | OI: **`633,345`** (Chênh lệch: **`+2`**)
...
*   **Chỉ báo EMA H1:** `EMA_21` (432.25) < `EMA_50` (433.77).
*   **Động lượng & Dao động:** RSI (14) = **`36.62`** | ATR (14) = **`2.28`** cents | Volatility = **`1.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`427.75`** | S2: **`406.25`** || Kháng cự R1: **`430.75`** | R2: **`450.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`427.75 - 432.25 cents (Canh mua vùng hỗ trợ)`** | SL: **`402.83 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `430.75 cents` / `450.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`426.25 - 427.75 cents`** | SL: **`403.97 cents (Chống quét SL tuyệt đối)`** | TP: **`449.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`430.75 - 432.25 cents`** | SL: **`433.03 cents`** | TP: **`407.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`416.21 - 425.75 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 13/07** | Asia 07-11 | 429.50 | 433.25 | 426.25 | **429.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | Asia 11-15 | 429.75 | 432.50 | 426.00 | **429.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 13/07** | London 15-19 | 429.25 | 432.25 | 425.25 | **430.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | Pre-NY 19-21 | 430.00 | 434.50 | 425.00 | **430.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | NY Open 21-23 | 430.75 | 436.25 | 424.50 | **433.00** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | NY Close 23-01 | 433.00 | 436.00 | 428.75 | **433.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | Asia 07-11 | 433.25 | 436.50 | 426.75 | **434.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | Asia 11-15 | 434.00 | 437.00 | 429.50 | **433.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 14/07** | London 15-19 | 433.50 | 437.50 | 427.75 | **434.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | Pre-NY 19-21 | 434.00 | 436.50 | 430.75 | **434.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | NY Open 21-23 | 434.50 | 438.00 | 428.50 | **435.50** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | NY Close 23-01 | 435.50 | 438.25 | 433.00 | **435.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | Asia 07-11 | 435.50 | 438.25 | 433.00 | **435.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 15/07** | Asia 11-15 | 435.00 | 438.00 | 431.75 | **434.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 15/07** | London 15-19 | 434.75 | 438.75 | 429.50 | **435.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | Pre-NY 19-21 | 435.25 | 440.00 | 428.25 | **437.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | NY Open 21-23 | 437.25 | 445.25 | 430.25 | **438.75** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | NY Close 23-01 | 438.75 | 443.25 | 434.50 | **438.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 16/07** | Asia 07-11 | 438.25 | 440.50 | 435.50 | **438.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 16/07** | Asia 11-15 | 438.00 | 440.00 | 433.50 | **438.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | London 15-19 | 438.25 | 442.00 | 435.50 | **438.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | Pre-NY 19-21 | 438.75 | 441.75 | 434.25 | **439.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | NY Open 21-23 | 439.00 | 443.25 | 435.75 | **439.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | NY Close 23-01 | 439.75 | 443.25 | 437.50 | **439.75** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 17/07** | Asia 07-11 | 439.75 | 443.50 | 436.25 | **439.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 17/07** | Asia 11-15 | 439.50 | 443.00 | 436.25 | **439.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 17/07** | London 15-19 | 439.25 | 442.25 | 436.50 | **439.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 17/07** | Pre-NY 19-21 | 439.50 | 442.50 | 436.75 | **439.50** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 17/07** | NY Open 21-23 | 439.50 | 443.50 | 436.00 | **440.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 17/07** | NY Close 23-01 | 440.00 | 444.00 | 438.25 | **439.75** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 617.75 cents | **Dự báo Chốt Phiên:** **`619.99 cents`** (+2.24).
*   **Thanh khoản phiên chốt:** Volume: **`464`** (Chênh lệch: **`-71,486`**) | OI: **`215,571`** (Chênh lệch: **`+23`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
*   **Chỉ báo EMA H1:** `EMA_21` (613.07) > `EMA_50` (611.92).
*   **Động lượng & Dao động:** RSI (14) = **`61.63`** | ATR (14) = **`3.48`** cents | Volatility = **`2.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`614.50`** | S2: **`574.00`** || Kháng cự R1: **`619.75`** | R2: **`627.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`613.07 - 611.92 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`632.22 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `614.50 cents` / `574.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`612.50 - 614.50 cents`** | SL: **`570.52 cents`** | TP: **`619.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`619.75 - 621.75 cents`** | SL: **`623.23 cents`** | TP: **`574.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`577.37 - 590.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 13/07** | Asia 07-11 | 617.75 | 629.00 | 612.25 | **617.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 13/07** | Asia 11-15 | 617.00 | 624.50 | 611.00 | **616.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 13/07** | London 15-19 | 616.50 | 630.25 | 601.75 | **618.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | Pre-NY 19-21 | 618.50 | 631.75 | 610.25 | **619.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | NY Open 21-23 | 619.75 | 636.25 | 609.25 | **624.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 13/07** | NY Close 23-01 | 624.25 | 632.00 | 613.25 | **625.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | Asia 07-11 | 625.50 | 633.75 | 615.00 | **627.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | Asia 11-15 | 627.25 | 639.50 | 617.50 | **626.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 14/07** | London 15-19 | 626.25 | 636.75 | 611.50 | **628.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | Pre-NY 19-21 | 628.50 | 639.00 | 622.25 | **629.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | NY Open 21-23 | 629.25 | 643.50 | 614.50 | **631.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 14/07** | NY Close 23-01 | 631.25 | 637.75 | 624.50 | **631.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | Asia 07-11 | 631.50 | 641.75 | 623.50 | **632.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | Asia 11-15 | 632.00 | 639.00 | 626.00 | **631.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 15/07** | London 15-19 | 631.25 | 644.75 | 618.25 | **633.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | Pre-NY 19-21 | 633.00 | 642.25 | 622.25 | **633.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 15/07** | NY Open 21-23 | 633.50 | 645.75 | 619.25 | **632.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 15/07** | NY Close 23-01 | 632.00 | 639.00 | 622.50 | **632.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | Asia 07-11 | 632.50 | 643.00 | 625.25 | **632.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 16/07** | Asia 11-15 | 632.25 | 642.00 | 622.50 | **632.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | London 15-19 | 632.75 | 643.50 | 625.50 | **633.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | Pre-NY 19-21 | 633.50 | 640.00 | 625.00 | **634.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | NY Open 21-23 | 634.00 | 645.00 | 622.25 | **637.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 16/07** | NY Close 23-01 | 637.50 | 643.00 | 629.75 | **638.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 17/07** | Asia 07-11 | 638.25 | 647.50 | 631.75 | **637.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 17/07** | Asia 11-15 | 637.50 | 645.00 | 631.50 | **636.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 17/07** | London 15-19 | 636.50 | 643.50 | 623.00 | **637.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 17/07** | Pre-NY 19-21 | 637.25 | 646.50 | 630.00 | **637.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 17/07** | NY Open 21-23 | 637.00 | 645.50 | 623.00 | **638.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 17/07** | NY Close 23-01 | 638.75 | 645.00 | 632.25 | **638.00** | **-0.75¢** 🔴 | 🔴 BEAR |
