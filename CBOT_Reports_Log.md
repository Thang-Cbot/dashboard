...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 03:01 ICT ngày 18/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$104.04 / thùng** | **-1.69%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.21** | **-0.10%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$104.04` (-1.69%)** | DXY: **`100.21` (-0.10%)** | Lúa mì CBOT: **`725.75¢` (-0.68%)**.
...
*Cập nhật tự động lúc 03:01 ICT ngày 18/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| **18/09/2026** | **ZW** | **725.75 ¢** | **727.77 ¢ (+2.02)** | 🐻 Bearish (726.76 < 727.12) | 4.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-18092026) |
| **18/09/2026** 
---
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$104.04** | **-1.69%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.21** | **-0.10%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Giá Chốt Phiên (Close):** 725.75 cents | **Dự báo Chốt Phiên:** **`727.77 cents`** (+2.02).
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$104.04** | **-1.69%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.21** | **-0.10%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
