...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 08:01 ICT ngày 24/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$93.13 / thùng** | **-1.33%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **98.79** | **-0.01%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$93.13` (-1.33%)** | DXY: **`98.79` (-0.01%)** | Lúa mì CBOT: **`709.00¢` (+3.92%)**.
...
*Cập nhật tự động lúc 08:01 ICT ngày 24/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **24/08/2026** | **ZC** | **521.00 ¢** | **515.24 ¢ (-5.76)** | 🐂 Bullish (505.62 > 501.19) | 10.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-24082026) |
| **24/08/2026** | **ZW** | **709.00 ¢** | **711.12 ¢ (+2.12)** | 🐂 Bullish (699.80 > 697.32) | 5.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-24082026) |
| **24/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **500.25 - 505.62 cents (Canh mua vùng hỗ trợ)** | **451.49 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `519.08 cents` \| TP2: `521.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **515.50 - 517.00 cents** | **469.24 cents (Chống quét SL tuyệt đối)** | **534.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **533.87 - 535.37 cents** | **537.63 cents** | **474.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **441.89 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **699.80 - 697.32 cents (Canh bán hồi kỹ thuật H1)** | **736.22 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `696.00 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **711.50 - 713.50 cents** | **657.53 cents** | **739.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **739.75 - 741.75 cents** | **744.72 cents** | **662.50 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **624.00 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 521.00 cents | **Dự báo Chốt Phiên:** **`515.24 cents`** (-5.76).
*   **Thanh khoản phiên chốt:** Volume: **`70,606`** (Chênh lệch: **`-338,343`**) | OI: **`925,509`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$93.13** | **-1.33%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **98.79** | **-0.01%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (505.62) > `EMA_50` (501.19).
*   **Động lượng & Dao động:** RSI (14) = **`85.22`** | ATR (14) = **`3.84`** cents | Volatility = **`10.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`500.25`** | S2: **`457.25`** || Kháng cự R1: **`519.08`** | R2: **`521.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`500.25 - 505.62 cents (Canh mua vùng hỗ trợ)`** | SL: **`451.49 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `519.08 cents` / `521.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`515.50 - 517.00 cents`** | SL: **`469.24 cents (Chống quét SL tuyệt đối)`** | TP: **`534.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`533.87 - 535.37 cents`** | SL: **`537.63 cents`** | TP: **`474.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`441.89 - 457.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 24/08** | Asia 07-11 | 521.00 | 524.75 | 517.75 | **521.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Asia 11-15 | 521.25 | 524.00 | 517.50 | **520.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 24/08** | London 15-19 | 520.75 | 523.75 | 516.75 | **521.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Pre-NY 19-21 | 521.50 | 526.00 | 516.50 | **522.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Open 21-23 | 522.25 | 527.75 | 516.00 | **524.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Close 23-01 | 524.50 | 527.50 | 520.25 | **524.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 07-11 | 524.75 | 528.00 | 518.25 | **525.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 11-15 | 525.50 | 528.50 | 521.00 | **525.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 25/08** | London 15-19 | 525.00 | 529.00 | 519.25 | **525.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Pre-NY 19-21 | 525.50 | 528.00 | 522.25 | **526.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Open 21-23 | 526.00 | 529.50 | 520.00 | **527.00** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Close 23-01 | 527.00 | 529.75 | 524.50 | **527.00** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Asia 07-11 | 527.00 | 529.75 | 524.50 | **526.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | Asia 11-15 | 526.50 | 529.50 | 523.25 | **526.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | London 15-19 | 526.25 | 530.25 | 521.00 | **526.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Pre-NY 19-21 | 526.75 | 531.50 | 519.75 | **528.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Open 21-23 | 528.75 | 536.75 | 521.75 | **530.25** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Close 23-01 | 530.25 | 534.75 | 526.00 | **529.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 07-11 | 529.75 | 532.00 | 527.00 | **529.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 11-15 | 529.50 | 531.50 | 525.00 | **529.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | London 15-19 | 529.75 | 533.50 | 527.00 | **530.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | Pre-NY 19-21 | 530.25 | 533.25 | 525.75 | **530.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Open 21-23 | 530.50 | 534.75 | 527.25 | **531.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Close 23-01 | 531.25 | 534.75 | 529.00 | **531.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Asia 07-11 | 531.25 | 535.00 | 527.75 | **531.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | Asia 11-15 | 531.00 | 534.50 | 527.75 | **530.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | London 15-19 | 530.75 | 533.75 | 528.00 | **531.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Pre-NY 19-21 | 531.00 | 534.00 | 528.25 | **531.00** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 28/08** | NY Open 21-23 | 531.00 | 535.00 | 527.50 | **531.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | NY Close 23-01 | 531.50 | 535.50 | 529.75 | **531.25** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 709.00 cents | **Dự báo Chốt Phiên:** **`711.12 cents`** (+2.12).
*   **Thanh khoản phiên chốt:** Volume: **`5,101`** (Chênh lệch: **`-84,805`**) | OI: **`240,733`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$93.13** | **-1.33%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **98.79** | **-0.01%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (699.80) > `EMA_50` (697.32).
*   **Động lượng & Dao động:** RSI (14) = **`65.95`** | ATR (14) = **`5.31`** cents | Volatility = **`5.50 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`699.80 - 697.32 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`736.22 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `696.00 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`711.50 - 713.50 cents`** | SL: **`657.53 cents`** | TP: **`739.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`739.75 - 741.75 cents`** | SL: **`744.72 cents`** | TP: **`662.50 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`624.00 - 645.25 cents`**
