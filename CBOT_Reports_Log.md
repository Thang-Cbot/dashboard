...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 16:01 ICT ngày 04/09/2026*
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$95.16` (-0.38%)** | DXY: **`99.06` (+0.06%)** | Lúa mì CBOT: **`747.25¢` (+1.53%)**.
...
*Cập nhật tự động lúc 16:01 ICT ngày 04/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **04/09/2026** | **ZC** | **538.00 ¢** | **539.45 ¢ (+1.45)** | 🐂 Bullish (538.42 > 538.31) | 2.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-04092026) |
| **04/09/2026** | **ZW** | **747.25 ¢** | **749.54 ¢ (+2.29)** | 🐻 Bearish (752.48 < 759.35) | 6.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-04092026) |
| **04/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **536.25 - 538.42 cents (Canh mua vùng hỗ trợ)** | **452.53 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `539.75 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **534.75 - 536.25 cents** | **454.10 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **539.75 - 541.25 cents** | **542.90 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **444.65 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **752.48 - 759.35 cents (Canh bán hồi kỹ thuật H1)** | **804.97 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `743.50 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
...
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **618.66 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 538.00 cents | **Dự báo Chốt Phiên:** **`539.45 cents`** (+1.45).
*   **Thanh khoản phiên chốt:** Volume: **`29,914`** (Chênh lệch: **`-298,514`**) | OI: **`992,969`** (Chênh lệch: **`+0`**)
...
*   **Chỉ báo EMA H1:** `EMA_21` (538.42) > `EMA_50` (538.31).
*   **Động lượng & Dao động:** RSI (14) = **`49.13`** | ATR (14) = **`3.15`** cents | Volatility = **`2.00 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`536.25 - 538.42 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.53 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `539.75 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`534.75 - 536.25 cents`** | SL: **`454.10 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`539.75 - 541.25 cents`** | SL: **`542.90 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`444.65 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 747.25 cents | **Dự báo Chốt Phiên:** **`749.54 cents`** (+2.29).
*   **Thanh khoản phiên chốt:** Volume: **`17,157`** (Chênh lệch: **`-83,542`**) | OI: **`268,323`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
*   **Dòng tiền (Volume + OI):** **`Giảm suy yếu / Đáy ngắn hạn (Long Liquidation Decline)`**
*   **Đánh giá xu hướng kết hợp:** 📉 **TÍCH LŨY TIÊU CỰC (Distribution):** Nến đi ngang nhưng dòng tiền rút dần (OI giảm), cảnh báo rủi ro suy sụt sắp tới.
...
*   **Chỉ báo EMA H1:** `EMA_21` (752.48) < `EMA_50` (759.35).
*   **Động lượng & Dao động:** RSI (14) = **`41.49`** | ATR (14) = **`6.65`** cents | Volatility = **`6.00 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`752.48 - 759.35 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`804.97 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `743.50 cents` / `645.25 cents`.
...
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`618.66 - 645.25 cents`**
