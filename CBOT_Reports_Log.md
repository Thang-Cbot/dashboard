...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 09:01 ICT ngày 09/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$99.28 / thùng** | **+0.00%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$99.28` (+0.00%)** | DXY: **`98.80` (+0.00%)** | Lúa mì CBOT: **`741.00¢` (+0.00%)**.
...
*Cập nhật tự động lúc 09:01 ICT ngày 09/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **09/09/2026** | **ZC** | **528.75 ¢** | **531.22 ¢ (+2.47)** | 🐻 Bearish (535.46 < 537.15) | 1.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-09092026) |
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **526.75 - 535.46 cents (Canh mua vùng hỗ trợ)** | **452.91 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `536.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **540.25 - 541.75 cents** | **470.31 cents (Chống quét SL tuyệt đối)** | **563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **549.25 - 550.75 cents** | **551.94 cents** | **474.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
...
*   **Giá Chốt Phiên (Close):** 528.75 cents | **Dự báo Chốt Phiên:** **`531.22 cents`** (+2.47).
*   **Thanh khoản phiên chốt:** Volume: **`18,446`** (Chênh lệch: **`+2,940`**) | OI: **`984,212`** (Chênh lệch: **`-8,728`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$99.28** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (535.46) < `EMA_50` (537.15).
*   **Động lượng & Dao động:** RSI (14) = **`30.09`** | ATR (14) = **`2.90`** cents | Volatility = **`1.50 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`526.75`** | S2: **`457.25`** || Kháng cự R1: **`536.50`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`526.75 - 535.46 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.91 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `536.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`540.25 - 541.75 cents`** | SL: **`470.31 cents (Chống quét SL tuyệt đối)`** | TP: **`563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`549.25 - 550.75 cents`** | SL: **`551.94 cents`** | TP: **`474.00 cents`**.
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 07/09** | Asia 07-11 | 528.75 | 532.50 | 525.50 | **529.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | Asia 11-15 | 529.00 | 531.75 | 525.25 | **528.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 07/09** | London 15-19 | 528.50 | 531.50 | 524.50 | **529.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | Pre-NY 19-21 | 529.25 | 533.75 | 524.25 | **530.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | NY Open 21-23 | 530.00 | 535.50 | 523.75 | **532.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 07/09** | NY Close 23-01 | 532.25 | 535.25 | 528.00 | **532.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Asia 07-11 | 532.50 | 535.75 | 526.00 | **533.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Asia 11-15 | 533.25 | 536.25 | 528.75 | **532.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 08/09** | London 15-19 | 532.75 | 536.75 | 527.00 | **533.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | Pre-NY 19-21 | 533.25 | 535.75 | 530.00 | **533.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | NY Open 21-23 | 533.75 | 537.25 | 527.75 | **534.75** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 08/09** | NY Close 23-01 | 534.75 | 537.50 | 532.25 | **534.75** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Asia 07-11 | 534.75 | 537.50 | 532.25 | **534.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 09/09** | Asia 11-15 | 534.25 | 537.25 | 531.00 | **534.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 09/09** | London 15-19 | 534.00 | 538.00 | 528.75 | **534.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | Pre-NY 19-21 | 534.50 | 539.25 | 527.50 | **536.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | NY Open 21-23 | 536.50 | 544.50 | 529.50 | **538.00** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 09/09** | NY Close 23-01 | 538.00 | 542.50 | 533.75 | **537.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 10/09** | Asia 07-11 | 537.50 | 539.75 | 534.75 | **537.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 10/09** | Asia 11-15 | 537.25 | 539.25 | 532.75 | **537.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | London 15-19 | 537.50 | 541.25 | 534.75 | **538.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | Pre-NY 19-21 | 538.00 | 541.00 | 533.50 | **538.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | NY Open 21-23 | 538.25 | 542.50 | 535.00 | **539.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 10/09** | NY Close 23-01 | 539.00 | 542.50 | 536.75 | **539.00** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | Asia 07-11 | 539.00 | 542.75 | 535.50 | **538.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | Asia 11-15 | 538.75 | 542.25 | 535.50 | **538.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 11/09** | London 15-19 | 538.50 | 541.50 | 535.75 | **538.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | Pre-NY 19-21 | 538.75 | 541.75 | 536.00 | **538.75** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 11/09** | NY Open 21-23 | 538.75 | 542.75 | 535.25 | **539.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 11/09** | NY Close 23-01 | 539.25 | 543.25 | 537.50 | **539.00** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Thanh khoản phiên chốt:** Volume: **`3,223`** (Chênh lệch: **`-5,753`**) | OI: **`261,571`** (Chênh lệch: **`+261,571`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$99.28** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
