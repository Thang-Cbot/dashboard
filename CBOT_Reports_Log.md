...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 21:01 ICT ngày 16/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$107.23 / thùng** | **-1.40%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.71** | **+0.06%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$107.23` (-1.40%)** | DXY: **`99.71` (+0.06%)** | Lúa mì CBOT: **`730.25¢` (+0.24%)**.
...
*Cập nhật tự động lúc 21:01 ICT ngày 16/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **16/09/2026** | **ZC** | **534.75 ¢** | **535.94 ¢ (+1.19)** | 🐂 Bullish (535.14 > 533.39) | 3.25 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-16092026) |
| **16/09/2026** | **ZW** | **730.00 ¢** | **731.98 ¢ (+1.98)** | 🐂 Bullish (728.36 > 727.28) | 8.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-16092026) |
| **16/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **532.00 - 535.14 cents (Canh mua vùng hỗ trợ)** | **458.37 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `536.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **530.50 - 532.00 cents** | **459.42 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **536.50 - 538.00 cents** | **538.58 cents** | **462.50 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **453.16 - 461.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **728.36 - 727.28 cents (Canh bán hồi kỹ thuật H1)** | **801.78 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `725.25 cents` \| TP2: `652.00 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **723.25 - 725.25 cents** | **647.48 cents** | **733.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **733.00 - 735.00 cents** | **737.52 cents** | **652.00 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **633.91 - 652.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 534.75 cents | **Dự báo Chốt Phiên:** **`535.94 cents`** (+1.19).
*   **Thanh khoản phiên chốt:** Volume: **`57,971`** (Chênh lệch: **`-180,907`**) | OI: **`953,275`** (Chênh lệch: **`-3,147`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$107.23** | **-1.40%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **99.71** | **+0.06%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (535.14) > `EMA_50` (533.39).
*   **Động lượng & Dao động:** RSI (14) = **`50.36`** | ATR (14) = **`2.08`** cents | Volatility = **`3.25 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`532.00 - 535.14 cents (Canh mua vùng hỗ trợ)`** | SL: **`458.37 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `536.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`530.50 - 532.00 cents`** | SL: **`459.42 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`536.50 - 538.00 cents`** | SL: **`538.58 cents`** | TP: **`462.50 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`453.16 - 461.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 730.00 cents | **Dự báo Chốt Phiên:** **`731.98 cents`** (+1.98).
*   **Thanh khoản phiên chốt:** Volume: **`22,559`** (Chênh lệch: **`-61,524`**) | OI: **`258,281`** (Chênh lệch: **`-1,957`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$107.23** | **-1.40%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **99.71** | **+0.06%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (728.36) > `EMA_50` (727.28).
*   **Động lượng & Dao động:** RSI (14) = **`53.64`** | ATR (14) = **`4.52`** cents | Volatility = **`8.00 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`728.36 - 727.28 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`801.78 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `725.25 cents` / `652.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`723.25 - 725.25 cents`** | SL: **`647.48 cents`** | TP: **`733.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`733.00 - 735.00 cents`** | SL: **`737.52 cents`** | TP: **`652.00 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`633.91 - 652.00 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 14/09** | Asia 07-11 | 730.00 | 741.25 | 724.50 | **729.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | Asia 11-15 | 729.25 | 736.75 | 723.25 | **728.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 14/09** | London 15-19 | 728.75 | 742.50 | 714.00 | **730.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | Pre-NY 19-21 | 730.75 | 744.00 | 722.50 | **732.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Open 21-23 | 732.00 | 748.50 | 721.50 | **736.50** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 14/09** | NY Close 23-01 | 736.50 | 744.25 | 725.50 | **737.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 07-11 | 737.75 | 746.00 | 727.25 | **739.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Asia 11-15 | 739.50 | 751.75 | 729.75 | **738.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 15/09** | London 15-19 | 738.50 | 749.00 | 723.75 | **740.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | Pre-NY 19-21 | 740.75 | 751.25 | 734.50 | **741.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Open 21-23 | 741.50 | 755.75 | 726.75 | **743.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 15/09** | NY Close 23-01 | 743.50 | 750.00 | 736.75 | **743.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 07-11 | 743.75 | 754.00 | 735.75 | **744.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Asia 11-15 | 744.25 | 751.25 | 738.25 | **743.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | London 15-19 | 743.50 | 757.00 | 730.50 | **745.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | Pre-NY 19-21 | 745.25 | 754.50 | 734.50 | **745.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 16/09** | NY Open 21-23 | 745.75 | 758.00 | 731.50 | **744.25** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 16/09** | NY Close 23-01 | 744.25 | 751.25 | 734.75 | **744.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Asia 07-11 | 744.75 | 755.25 | 737.50 | **744.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 17/09** | Asia 11-15 | 744.50 | 754.25 | 734.75 | **745.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | London 15-19 | 745.00 | 755.75 | 737.75 | **745.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | Pre-NY 19-21 | 745.75 | 752.25 | 737.25 | **746.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Open 21-23 | 746.25 | 757.25 | 734.50 | **749.75** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 17/09** | NY Close 23-01 | 749.75 | 755.25 | 742.00 | **750.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Asia 07-11 | 750.50 | 759.75 | 744.00 | **749.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | Asia 11-15 | 749.75 | 757.25 | 743.75 | **748.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | London 15-19 | 748.75 | 755.75 | 735.25 | **749.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | Pre-NY 19-21 | 749.50 | 758.75 | 742.25 | **749.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 18/09** | NY Open 21-23 | 749.25 | 757.75 | 735.25 | **751.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 18/09** | NY Close 23-01 | 751.00 | 757.25 | 744.50 | **750.25** | **-0.75¢** 🔴 | 🔴 BEAR |
