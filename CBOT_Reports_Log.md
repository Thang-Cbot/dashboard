...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 19:00 ICT ngày 18/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$98.64 / thùng** | **-5.90%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.51** | **+0.29%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$98.64` (-5.90%)** | DXY: **`100.51` (+0.29%)** | Lúa mì CBOT: **`724.25¢` (-0.34%)**.
...
*Cập nhật tự động lúc 19:00 ICT ngày 18/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **18/09/2026** | **ZC** | **529.75 ¢** | **529.79 ¢ (+0.04)** | 🐻 Bearish (530.80 < 531.79) | 2.25 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-18092026) |
| **18/09/2026** | **ZW** | **724.25 ¢** | **725.35 ¢ (+1.10)** | 🐻 Bearish (725.11 < 726.07) | 5.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-18092026) |
| **18/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **528.00 - 530.80 cents (Canh mua vùng hỗ trợ)** | **471.18 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `533.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **541.00 - 542.50 cents** | **488.20 cents (Chống quét SL tuyệt đối)** | **563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **544.50 - 546.00 cents** | **546.05 cents** | **490.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **466.91 - 473.75 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **725.11 - 726.07 cents (Canh bán hồi kỹ thuật H1)** | **800.43 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `720.00 cents` \| TP2: `671.50 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWH27)** | **734.25 - 736.25 cents** | **684.94 cents** | **742.75 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWH27)** | **742.75 - 744.75 cents** | **746.06 cents** | **688.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **657.03 - 671.50 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 529.75 cents | **Dự báo Chốt Phiên:** **`529.79 cents`** (+0.04).
*   **Thanh khoản phiên chốt:** Volume: **`26,100`** (Chênh lệch: **`-175,017`**) | OI: **`940,753`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$98.64** | **-5.90%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.51** | **+0.29%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (530.80) < `EMA_50` (531.79).
*   **Động lượng & Dao động:** RSI (14) = **`44.53`** | ATR (14) = **`1.71`** cents | Volatility = **`2.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`528.00`** | S2: **`473.75`** || Kháng cự R1: **`533.50`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`528.00 - 530.80 cents (Canh mua vùng hỗ trợ)`** | SL: **`471.18 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `533.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`541.00 - 542.50 cents`** | SL: **`488.20 cents (Chống quét SL tuyệt đối)`** | TP: **`563.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`544.50 - 546.00 cents`** | SL: **`546.05 cents`** | TP: **`490.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`466.91 - 473.75 cents`**
...
*   **Giá Chốt Phiên (Close):** 724.25 cents | **Dự báo Chốt Phiên:** **`725.35 cents`** (+1.10).
*   **Thanh khoản phiên chốt:** Volume: **`6,114`** (Chênh lệch: **`-51,738`**) | OI: **`257,744`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$98.64** | **-5.90%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.51** | **+0.29%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (725.11) < `EMA_50` (726.07).
*   **Động lượng & Dao động:** RSI (14) = **`47.87`** | ATR (14) = **`3.62`** cents | Volatility = **`5.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`720.00`** | S2: **`671.50`** || Kháng cự R1: **`730.00`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`725.11 - 726.07 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`800.43 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `720.00 cents` / `671.50 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWH27):**
    *   *Long:* Entry: **`734.25 - 736.25 cents`** | SL: **`684.94 cents`** | TP: **`742.75 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`742.75 - 744.75 cents`** | SL: **`746.06 cents`** | TP: **`688.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`657.03 - 671.50 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 21/09** | Asia 07-11 | 724.25 | 735.50 | 718.75 | **723.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 21/09** | Asia 11-15 | 723.50 | 731.00 | 717.50 | **723.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 21/09** | London 15-19 | 723.00 | 736.75 | 708.25 | **725.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | Pre-NY 19-21 | 725.00 | 738.25 | 716.75 | **726.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Open 21-23 | 726.25 | 742.75 | 715.75 | **730.75** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 21/09** | NY Close 23-01 | 730.75 | 738.50 | 719.75 | **732.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 07-11 | 732.00 | 740.25 | 721.50 | **733.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Asia 11-15 | 733.75 | 746.00 | 724.00 | **732.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 22/09** | London 15-19 | 732.75 | 743.25 | 718.00 | **735.00** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | Pre-NY 19-21 | 735.00 | 745.50 | 728.75 | **735.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Open 21-23 | 735.75 | 750.00 | 721.00 | **737.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 22/09** | NY Close 23-01 | 737.75 | 744.25 | 731.00 | **738.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Asia 07-11 | 738.00 | 748.25 | 730.00 | **738.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Asia 11-15 | 738.50 | 745.50 | 732.50 | **737.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | London 15-19 | 737.75 | 751.25 | 724.75 | **739.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | Pre-NY 19-21 | 739.50 | 748.75 | 728.75 | **740.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 23/09** | NY Open 21-23 | 740.00 | 752.25 | 725.75 | **738.50** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 23/09** | NY Close 23-01 | 738.50 | 745.50 | 729.00 | **739.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | Asia 07-11 | 739.00 | 749.50 | 731.75 | **738.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 24/09** | Asia 11-15 | 738.75 | 748.50 | 729.00 | **739.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | London 15-19 | 739.25 | 750.00 | 732.00 | **740.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | Pre-NY 19-21 | 740.00 | 746.50 | 731.50 | **740.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Open 21-23 | 740.50 | 751.50 | 728.75 | **744.00** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 24/09** | NY Close 23-01 | 744.00 | 749.50 | 736.25 | **744.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Asia 07-11 | 744.75 | 754.00 | 738.25 | **744.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | Asia 11-15 | 744.00 | 751.50 | 738.00 | **743.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | London 15-19 | 743.00 | 750.00 | 729.50 | **743.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | Pre-NY 19-21 | 743.75 | 753.00 | 736.50 | **743.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 25/09** | NY Open 21-23 | 743.50 | 752.00 | 729.50 | **745.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 25/09** | NY Close 23-01 | 745.25 | 751.50 | 738.75 | **744.50** | **-0.75¢** 🔴 | 🔴 BEAR |
