...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 15:54 ICT ngày 31/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$88.94 / thùng** | **+0.00%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.55** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$88.94` (+0.00%)** | DXY: **`99.55` (+0.00%)** | Lúa mì CBOT: **`780.00¢` (+0.00%)**.
...
*Cập nhật tự động lúc 15:54 ICT ngày 31/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **31/08/2026** | **ZC** | **539.25 ¢** | **541.18 ¢ (+1.93)** | 🐂 Bullish (537.48 > 534.69) | 2.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-31082026) |
| **31/08/2026** | **ZW** | **780.00 ¢** | **785.94 ¢ (+5.94)** | 🐂 Bullish (774.33 > 761.56) | 4.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-31082026) |
| **31/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **536.25 - 537.48 cents (Canh mua vùng hỗ trợ)** | **452.96 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `541.25 cents` \| TP2: `542.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **534.75 - 536.25 cents** | **454.39 cents (Chống quét SL tuyệt đối)** | **541.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **541.25 - 542.75 cents** | **544.11 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **445.81 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **774.33 - 761.56 cents (Canh bán hồi kỹ thuật H1)** | **799.32 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `774.25 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **772.25 - 774.25 cents** | **639.21 cents** | **787.23 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **787.23 - 789.23 cents** | **793.27 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
...
*   **Giá Chốt Phiên (Close):** 539.25 cents | **Dự báo Chốt Phiên:** **`541.18 cents`** (+1.93).
*   **Thanh khoản phiên chốt:** Volume: **`53,251`** (Chênh lệch: **`-282,116`**) | OI: **`959,316`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.94** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.55** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (537.48) > `EMA_50` (534.69).
*   **Động lượng & Dao động:** RSI (14) = **`56.61`** | ATR (14) = **`2.86`** cents | Volatility = **`2.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`536.25`** | S2: **`457.25`** || Kháng cự R1: **`541.25`** | R2: **`542.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`536.25 - 537.48 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.96 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `541.25 cents` / `542.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`534.75 - 536.25 cents`** | SL: **`454.39 cents (Chống quét SL tuyệt đối)`** | TP: **`541.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`541.25 - 542.75 cents`** | SL: **`544.11 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`445.81 - 457.25 cents`**
...
*   **Giá Chốt Phiên (Close):** 780.00 cents | **Dự báo Chốt Phiên:** **`785.94 cents`** (+5.94).
*   **Thanh khoản phiên chốt:** Volume: **`14,015`** (Chênh lệch: **`-119,113`**) | OI: **`268,773`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$88.94** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.55** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (774.33) > `EMA_50` (761.56).
*   **Động lượng & Dao động:** RSI (14) = **`59.26`** | ATR (14) = **`6.04`** cents | Volatility = **`4.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`774.25`** | S2: **`645.25`** || Kháng cự R1: **`787.23`** | R2: **`790.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`774.33 - 761.56 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`799.32 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `774.25 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`772.25 - 774.25 cents`** | SL: **`639.21 cents`** | TP: **`787.23 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`787.23 - 789.23 cents`** | SL: **`793.27 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 780.00 | 791.25 | 774.50 | **779.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | Asia 11-15 | 779.25 | 786.75 | 773.25 | **778.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 778.75 | 792.50 | 764.00 | **780.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 780.75 | 794.00 | 772.50 | **782.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 782.00 | 798.50 | 771.50 | **786.50** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 786.50 | 794.25 | 775.50 | **787.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 787.75 | 796.00 | 777.25 | **789.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 789.50 | 801.75 | 779.75 | **788.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 788.50 | 799.00 | 773.75 | **790.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 790.75 | 801.25 | 784.50 | **791.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 791.50 | 805.75 | 776.75 | **793.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 793.50 | 800.00 | 786.75 | **793.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 793.75 | 804.00 | 785.75 | **794.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 11-15 | 794.25 | 801.25 | 788.25 | **793.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 793.50 | 807.00 | 780.50 | **795.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 795.25 | 804.50 | 784.50 | **795.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 795.75 | 808.00 | 781.50 | **794.25** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | NY Close 23-01 | 794.25 | 801.25 | 784.75 | **794.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Asia 07-11 | 794.75 | 805.25 | 787.50 | **794.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 794.50 | 804.25 | 784.75 | **795.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 795.00 | 805.75 | 787.75 | **795.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 795.75 | 802.25 | 787.25 | **796.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 796.25 | 807.25 | 784.50 | **799.75** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 799.75 | 805.25 | 792.00 | **800.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 800.50 | 809.75 | 794.00 | **799.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 799.75 | 807.25 | 793.75 | **798.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 798.75 | 805.75 | 785.25 | **799.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 799.50 | 808.75 | 792.25 | **799.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 799.25 | 807.75 | 785.25 | **801.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 801.00 | 807.25 | 794.50 | **800.25** | **-0.75¢** 🔴 | 🔴 BEAR |
