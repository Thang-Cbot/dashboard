...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 13:32 ICT ngày 20/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$91.92 / thùng** | **+0.33%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$91.92` (+0.33%)** | DXY: **`98.82` (-0.01%)** | Lúa mì CBOT: **`697.75¢` (+2.54%)**.
...
*Cập nhật tự động lúc 13:32 ICT ngày 20/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **20/08/2026** | **ZC** | **501.75 ¢** | **500.81 ¢ (-0.94)** | 🐂 Bullish (496.54 > 492.09) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-20082026) |
| **20/08/2026** | **ZW** | **697.75 ¢** | **699.78 ¢ (+2.03)** | 🐂 Bullish (693.16 > 689.23) | 1.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-20082026) |
| **20/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **490.50 - 496.54 cents (Canh mua vùng hỗ trợ)** | **454.63 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `501.38 cents` \| TP2: `502.25 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **504.75 - 506.25 cents** | **471.53 cents (Chống quét SL tuyệt đối)** | **516.25 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **516.51 - 518.01 cents** | **517.99 cents** | **474.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **693.16 - 689.23 cents (Canh bán hồi kỹ thuật H1)** | **732.90 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `695.25 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **693.25 - 695.25 cents** | **642.15 cents** | **699.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **699.50 - 701.50 cents** | **702.60 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **632.86 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 501.75 cents | **Dự báo Chốt Phiên:** **`500.81 cents`** (-0.94).
*   **Thanh khoản phiên chốt:** Volume: **`68,648`** (Chênh lệch: **`-151,430`**) | OI: **`925,389`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$91.92** | **+0.33%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (496.54) > `EMA_50` (492.09).
*   **Động lượng & Dao động:** RSI (14) = **`80.45`** | ATR (14) = **`1.75`** cents | Volatility = **`0.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`490.50`** | S2: **`457.25`** || Kháng cự R1: **`501.38`** | R2: **`502.25`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`490.50 - 496.54 cents (Canh mua vùng hỗ trợ)`** | SL: **`454.63 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `501.38 cents` / `502.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`504.75 - 506.25 cents`** | SL: **`471.53 cents (Chống quét SL tuyệt đối)`** | TP: **`516.25 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`516.51 - 518.01 cents`** | SL: **`517.99 cents`** | TP: **`474.00 cents`**.
...
*   **Giá Chốt Phiên (Close):** 697.75 cents | **Dự báo Chốt Phiên:** **`699.78 cents`** (+2.03).
*   **Thanh khoản phiên chốt:** Volume: **`2,755`** (Chênh lệch: **`-91,883`**) | OI: **`236,087`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$91.92** | **+0.33%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (693.16) > `EMA_50` (689.23).
*   **Động lượng & Dao động:** RSI (14) = **`62.65`** | ATR (14) = **`3.10`** cents | Volatility = **`1.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`695.25`** | S2: **`645.25`** || Kháng cự R1: **`699.50`** | R2: **`728.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`693.16 - 689.23 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`732.90 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `695.25 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`693.25 - 695.25 cents`** | SL: **`642.15 cents`** | TP: **`699.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`699.50 - 701.50 cents`** | SL: **`702.60 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`632.86 - 645.25 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 17/08** | Asia 07-11 | 697.75 | 709.00 | 692.25 | **697.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 17/08** | Asia 11-15 | 697.00 | 704.50 | 691.00 | **696.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 17/08** | London 15-19 | 696.50 | 710.25 | 681.75 | **698.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | Pre-NY 19-21 | 698.50 | 711.75 | 690.25 | **699.75** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Open 21-23 | 699.75 | 716.25 | 689.25 | **704.25** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Close 23-01 | 704.25 | 712.00 | 693.25 | **705.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 07-11 | 705.50 | 713.75 | 695.00 | **707.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 11-15 | 707.25 | 719.50 | 697.50 | **706.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 18/08** | London 15-19 | 706.25 | 716.75 | 691.50 | **708.50** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Pre-NY 19-21 | 708.50 | 719.00 | 702.25 | **709.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Open 21-23 | 709.25 | 723.50 | 694.50 | **711.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Close 23-01 | 711.25 | 717.75 | 704.50 | **711.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Asia 07-11 | 711.50 | 721.75 | 703.50 | **712.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Asia 11-15 | 712.00 | 719.00 | 706.00 | **711.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | London 15-19 | 711.25 | 724.75 | 698.25 | **713.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Pre-NY 19-21 | 713.00 | 722.25 | 702.25 | **713.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | NY Open 21-23 | 713.50 | 725.75 | 699.25 | **712.00** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | NY Close 23-01 | 712.00 | 719.00 | 702.50 | **712.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | Asia 07-11 | 712.50 | 723.00 | 705.25 | **712.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 20/08** | Asia 11-15 | 712.25 | 722.00 | 702.50 | **712.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | London 15-19 | 712.75 | 723.50 | 705.50 | **713.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | Pre-NY 19-21 | 713.50 | 720.00 | 705.00 | **714.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Open 21-23 | 714.00 | 725.00 | 702.25 | **717.50** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Close 23-01 | 717.50 | 723.00 | 709.75 | **718.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Asia 07-11 | 718.25 | 727.50 | 711.75 | **717.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | Asia 11-15 | 717.50 | 725.00 | 711.50 | **716.50** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | London 15-19 | 716.50 | 723.50 | 703.00 | **717.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Pre-NY 19-21 | 717.25 | 726.50 | 710.00 | **717.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | NY Open 21-23 | 717.00 | 725.50 | 703.00 | **718.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | NY Close 23-01 | 718.75 | 725.00 | 712.25 | **718.00** | **-0.75¢** 🔴 | 🔴 BEAR |
