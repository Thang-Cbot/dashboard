...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 10:08 ICT ngày 03/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$95.43 / thùng** | **+0.82%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.47** | **-0.20%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$95.43` (+0.82%)** | DXY: **`99.47` (-0.20%)** | Lúa mì CBOT: **`772.25¢` (+1.08%)**.
...
*Cập nhật tự động lúc 10:08 ICT ngày 03/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **03/09/2026** | **ZC** | **540.50 ¢** | **542.55 ¢ (+2.05)** | 🐂 Bullish (541.27 > 539.64) | 2.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-03092026) |
| **03/09/2026** | **ZW** | **772.25 ¢** | **776.19 ¢ (+3.94)** | 🐂 Bullish (775.30 > 773.44) | 4.00 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-03092026) |
| **03/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **536.25 - 541.27 cents (Canh mua vùng hỗ trợ)** | **452.57 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `543.75 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **534.75 - 536.25 cents** | **454.13 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **543.75 - 545.25 cents** | **546.87 cents** | **458.25 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **444.76 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **775.30 - 773.44 cents (Canh bán hồi kỹ thuật H1)** | **804.06 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `765.75 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **763.75 - 765.75 cents** | **639.21 cents** | **780.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **780.00 - 782.00 cents** | **786.04 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **621.08 - 645.25 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 540.50 cents | **Dự báo Chốt Phiên:** **`542.55 cents`** (+2.05).
*   **Thanh khoản phiên chốt:** Volume: **`17,391`** (Chênh lệch: **`-284,129`**) | OI: **`1,001,249`** (Chênh lệch: **`-3,626`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$95.43** | **+0.82%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.47** | **-0.20%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (541.27) > `EMA_50` (539.64).
*   **Động lượng & Dao động:** RSI (14) = **`48.99`** | ATR (14) = **`3.12`** cents | Volatility = **`2.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`536.25`** | S2: **`457.25`** || Kháng cự R1: **`543.75`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`536.25 - 541.27 cents (Canh mua vùng hỗ trợ)`** | SL: **`452.57 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `543.75 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`534.75 - 536.25 cents`** | SL: **`454.13 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`543.75 - 545.25 cents`** | SL: **`546.87 cents`** | TP: **`458.25 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`444.76 - 457.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 31/08** | Asia 07-11 | 540.50 | 544.25 | 537.25 | **540.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Asia 11-15 | 540.75 | 543.50 | 537.00 | **540.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 31/08** | London 15-19 | 540.25 | 543.25 | 536.25 | **541.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | Pre-NY 19-21 | 541.00 | 545.50 | 536.00 | **541.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Open 21-23 | 541.75 | 547.25 | 535.50 | **544.00** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 31/08** | NY Close 23-01 | 544.00 | 547.00 | 539.75 | **544.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 07-11 | 544.25 | 547.50 | 537.75 | **545.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Asia 11-15 | 545.00 | 548.00 | 540.50 | **544.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 01/09** | London 15-19 | 544.50 | 548.50 | 538.75 | **545.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | Pre-NY 19-21 | 545.00 | 547.50 | 541.75 | **545.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Open 21-23 | 545.50 | 549.00 | 539.50 | **546.50** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 01/09** | NY Close 23-01 | 546.50 | 549.25 | 544.00 | **546.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Asia 07-11 | 546.50 | 549.25 | 544.00 | **546.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | Asia 11-15 | 546.00 | 549.00 | 542.75 | **545.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 02/09** | London 15-19 | 545.75 | 549.75 | 540.50 | **546.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | Pre-NY 19-21 | 546.25 | 551.00 | 539.25 | **548.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Open 21-23 | 548.25 | 556.25 | 541.25 | **549.75** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 02/09** | NY Close 23-01 | 549.75 | 554.25 | 545.50 | **549.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 07-11 | 549.25 | 551.50 | 546.50 | **549.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 03/09** | Asia 11-15 | 549.00 | 551.00 | 544.50 | **549.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | London 15-19 | 549.25 | 553.00 | 546.50 | **549.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | Pre-NY 19-21 | 549.75 | 552.75 | 545.25 | **550.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Open 21-23 | 550.00 | 554.25 | 546.75 | **550.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 03/09** | NY Close 23-01 | 550.75 | 554.25 | 548.50 | **550.75** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Asia 07-11 | 550.75 | 554.50 | 547.25 | **550.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | Asia 11-15 | 550.50 | 554.00 | 547.25 | **550.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 04/09** | London 15-19 | 550.25 | 553.25 | 547.50 | **550.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | Pre-NY 19-21 | 550.50 | 553.50 | 547.75 | **550.50** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 04/09** | NY Open 21-23 | 550.50 | 554.50 | 547.00 | **551.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 04/09** | NY Close 23-01 | 551.00 | 555.00 | 549.25 | **550.75** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 772.25 cents | **Dự báo Chốt Phiên:** **`776.19 cents`** (+3.94).
*   **Thanh khoản phiên chốt:** Volume: **`2,459`** (Chênh lệch: **`-99,009`**) | OI: **`275,530`** (Chênh lệch: **`+1,349`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$95.43** | **+0.82%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.47** | **-0.20%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (775.30) > `EMA_50` (773.44).
*   **Động lượng & Dao động:** RSI (14) = **`45.65`** | ATR (14) = **`6.04`** cents | Volatility = **`4.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`765.75`** | S2: **`645.25`** || Kháng cự R1: **`780.00`** | R2: **`795.00`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`775.30 - 773.44 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`804.06 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `765.75 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`763.75 - 765.75 cents`** | SL: **`639.21 cents`** | TP: **`780.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`780.00 - 782.00 cents`** | SL: **`786.04 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`621.08 - 645.25 cents`**
