...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 19:00 ICT ngày 14/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$87.15 / thùng** | **+0.09%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.61** | **-0.35%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$87.15` (+0.09%)** | DXY: **`99.61` (-0.35%)** | Lúa mì CBOT: **`666.50¢` (+4.33%)**.
...
*Cập nhật tự động lúc 19:00 ICT ngày 14/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **14/08/2026** | **ZC** | **476.25 ¢** | **477.57 ¢ (+1.32)** | 🐂 Bullish (475.36 > 472.73) | 1.00 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-14082026) |
| **14/08/2026** | **ZW** | **666.50 ¢** | **668.52 ¢ (+2.02)** | 🐂 Bullish (659.56 > 654.01) | 4.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-14082026) |
| **14/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **474.25 - 475.36 cents (Canh mua vùng hỗ trợ)** | **454.54 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `477.25 cents` \| TP2: `492.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **472.75 - 474.25 cents** | **455.27 cents (Chống quét SL tuyệt đối)** | **491.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **659.56 - 654.01 cents (Canh bán hồi kỹ thuật H1)** | **717.13 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `664.00 cents` \| TP2: `626.75 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **662.00 - 664.00 cents** | **622.83 cents** | **668.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **668.50 - 670.50 cents** | **672.42 cents** | **626.75 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
...
*   **Giá Chốt Phiên (Close):** 476.25 cents | **Dự báo Chốt Phiên:** **`477.57 cents`** (+1.32).
*   **Thanh khoản phiên chốt:** Volume: **`41,436`** (Chênh lệch: **`-388,345`**) | OI: **`871,840`** (Chênh lệch: **`+551,672`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$87.15** | **+0.09%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.61** | **-0.35%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (475.36) > `EMA_50` (472.73).
*   **Động lượng & Dao động:** RSI (14) = **`55.80`** | ATR (14) = **`1.48`** cents | Volatility = **`1.00 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`474.25`** | S2: **`456.75`** || Kháng cự R1: **`477.25`** | R2: **`492.00`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`474.25 - 475.36 cents (Canh mua vùng hỗ trợ)`** | SL: **`454.54 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `477.25 cents` / `492.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`472.75 - 474.25 cents`** | SL: **`455.27 cents (Chống quét SL tuyệt đối)`** | TP: **`491.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 17/08** | Asia 07-11 | 476.25 | 480.00 | 473.00 | **476.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | Asia 11-15 | 476.50 | 479.25 | 472.75 | **476.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 17/08** | London 15-19 | 476.00 | 479.00 | 472.00 | **476.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | Pre-NY 19-21 | 476.75 | 481.25 | 471.75 | **477.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Open 21-23 | 477.50 | 483.00 | 471.25 | **479.75** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Close 23-01 | 479.75 | 482.75 | 475.50 | **480.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 07-11 | 480.00 | 483.25 | 473.50 | **480.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 11-15 | 480.75 | 483.75 | 476.25 | **480.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 18/08** | London 15-19 | 480.25 | 484.25 | 474.50 | **480.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Pre-NY 19-21 | 480.75 | 483.25 | 477.50 | **481.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Open 21-23 | 481.25 | 484.75 | 475.25 | **482.25** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Close 23-01 | 482.25 | 485.00 | 479.75 | **482.25** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Asia 07-11 | 482.25 | 485.00 | 479.75 | **481.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | Asia 11-15 | 481.75 | 484.75 | 478.50 | **481.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | London 15-19 | 481.50 | 485.50 | 476.25 | **482.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Pre-NY 19-21 | 482.00 | 486.75 | 475.00 | **484.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | NY Open 21-23 | 484.00 | 492.00 | 477.00 | **485.50** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | NY Close 23-01 | 485.50 | 490.00 | 481.25 | **485.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 20/08** | Asia 07-11 | 485.00 | 487.25 | 482.25 | **484.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 20/08** | Asia 11-15 | 484.75 | 486.75 | 480.25 | **485.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | London 15-19 | 485.00 | 488.75 | 482.25 | **485.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | Pre-NY 19-21 | 485.50 | 488.50 | 481.00 | **485.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Open 21-23 | 485.75 | 490.00 | 482.50 | **486.50** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Close 23-01 | 486.50 | 490.00 | 484.25 | **486.50** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Asia 07-11 | 486.50 | 490.25 | 483.00 | **486.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | Asia 11-15 | 486.25 | 489.75 | 483.00 | **486.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | London 15-19 | 486.00 | 489.00 | 483.25 | **486.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Pre-NY 19-21 | 486.25 | 489.25 | 483.50 | **486.25** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 21/08** | NY Open 21-23 | 486.25 | 490.25 | 482.75 | **486.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | NY Close 23-01 | 486.75 | 490.75 | 485.00 | **486.50** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 666.50 cents | **Dự báo Chốt Phiên:** **`668.52 cents`** (+2.02).
*   **Thanh khoản phiên chốt:** Volume: **`13,455`** (Chênh lệch: **`-144,058`**) | OI: **`99,530`** (Chênh lệch: **`-14,611`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$87.15** | **+0.09%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.61** | **-0.35%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (659.56) > `EMA_50` (654.01).
*   **Động lượng & Dao động:** RSI (14) = **`67.21`** | ATR (14) = **`3.92`** cents | Volatility = **`4.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`664.00`** | S2: **`626.75`** || Kháng cự R1: **`668.50`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`659.56 - 654.01 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`717.13 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `664.00 cents` / `626.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`662.00 - 664.00 cents`** | SL: **`622.83 cents`** | TP: **`668.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`668.50 - 670.50 cents`** | SL: **`672.42 cents`** | TP: **`626.75 cents (Thuận xu hướng giảm ngắn hạn)`**.
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 17/08** | Asia 07-11 | 666.50 | 677.75 | 661.00 | **665.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 17/08** | Asia 11-15 | 665.75 | 673.25 | 659.75 | **665.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 17/08** | London 15-19 | 665.25 | 679.00 | 650.50 | **667.25** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | Pre-NY 19-21 | 667.25 | 680.50 | 659.00 | **668.50** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Open 21-23 | 668.50 | 685.00 | 658.00 | **673.00** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 17/08** | NY Close 23-01 | 673.00 | 680.75 | 662.00 | **674.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 07-11 | 674.25 | 682.50 | 663.75 | **676.00** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Asia 11-15 | 676.00 | 688.25 | 666.25 | **675.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 18/08** | London 15-19 | 675.00 | 685.50 | 660.25 | **677.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | Pre-NY 19-21 | 677.25 | 687.75 | 671.00 | **678.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Open 21-23 | 678.00 | 692.25 | 663.25 | **680.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 18/08** | NY Close 23-01 | 680.00 | 686.50 | 673.25 | **680.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Asia 07-11 | 680.25 | 690.50 | 672.25 | **680.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Asia 11-15 | 680.75 | 687.75 | 674.75 | **680.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | London 15-19 | 680.00 | 693.50 | 667.00 | **681.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | Pre-NY 19-21 | 681.75 | 691.00 | 671.00 | **682.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 19/08** | NY Open 21-23 | 682.25 | 694.50 | 668.00 | **680.75** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 19/08** | NY Close 23-01 | 680.75 | 687.75 | 671.25 | **681.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | Asia 07-11 | 681.25 | 691.75 | 674.00 | **681.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 20/08** | Asia 11-15 | 681.00 | 690.75 | 671.25 | **681.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | London 15-19 | 681.50 | 692.25 | 674.25 | **682.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | Pre-NY 19-21 | 682.25 | 688.75 | 673.75 | **682.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Open 21-23 | 682.75 | 693.75 | 671.00 | **686.25** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 20/08** | NY Close 23-01 | 686.25 | 691.75 | 678.50 | **687.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Asia 07-11 | 687.00 | 696.25 | 680.50 | **686.25** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | Asia 11-15 | 686.25 | 693.75 | 680.25 | **685.25** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | London 15-19 | 685.25 | 692.25 | 671.75 | **686.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | Pre-NY 19-21 | 686.00 | 695.25 | 678.75 | **685.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 21/08** | NY Open 21-23 | 685.75 | 694.25 | 671.75 | **687.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 21/08** | NY Close 23-01 | 687.50 | 693.75 | 681.00 | **686.75** | **-0.75¢** 🔴 | 🔴 BEAR |
