...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 21:01 ICT ngày 10/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$85.94 / thùng** | **+0.00%** | 📉 **Trung lập:** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **99.79** | **+0.00%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$85.94` (+0.00%)** | DXY: **`99.79` (+0.00%)** | Lúa mì CBOT: **`650.50¢` (+0.00%)**.
...
*Cập nhật tự động lúc 21:01 ICT ngày 10/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **10/08/2026** | **ZC** | **438.25 ¢** | **439.13 ¢ (+0.88)** | 🐂 Bullish (440.92 > 440.77) | 4.50 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-10082026) |
| **10/08/2026** | **ZW** | **650.25 ¢** | **653.05 ¢ (+2.80)** | 🐂 Bullish (647.38 > 643.96) | 6.25 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-10082026) |
| **10/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCU26)** | **437.00 - 440.92 cents (Canh mua vùng hỗ trợ)** | **424.09 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `439.25 cents` \| TP2: `468.00 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCU26)** | **435.50 - 437.00 cents** | **424.98 cents (Chống quét SL tuyệt đối)** | **467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCU26)** | **439.25 - 440.75 cents** | **441.02 cents** | **427.75 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **440.10 - 447.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWU26)** | **647.38 - 643.96 cents (Canh bán hồi kỹ thuật H1)** | **716.92 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `647.00 cents` \| TP2: `602.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWU26)** | **645.00 - 647.00 cents** | **598.47 cents** | **652.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWU26)** | **652.50 - 654.50 cents** | **656.28 cents** | **602.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **603.64 - 618.00 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 438.25 cents | **Dự báo Chốt Phiên:** **`439.13 cents`** (+0.88).
*   **Thanh khoản phiên chốt:** Volume: **`24,808`** (Chênh lệch: **`+23,048`**) | OI: **`483,093`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$85.94** | **+0.00%** | Giá dầu Tăng hỗ trợ biên lợi nhuận pha chế Ethanol, kéo theo nhu cầu ngô tích cực. |
| **USD Index** | **99.79** | **+0.00%** | DXY Tăng làm giảm sức cạnh tranh xuất khẩu của ngô Mỹ so với Brazil/Argentina. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (440.92) > `EMA_50` (440.77).
*   **Động lượng & Dao động:** RSI (14) = **`38.92`** | ATR (14) = **`1.77`** cents | Volatility = **`4.50 cents`**.
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCU26):**
    ...
    *   *Thiết lập:* Entry: **`437.00 - 440.92 cents (Canh mua vùng hỗ trợ)`** | SL: **`424.09 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `439.25 cents` / `468.00 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCU26):**
    *   *Long:* Entry: **`435.50 - 437.00 cents`** | SL: **`424.98 cents (Chống quét SL tuyệt đối)`** | TP: **`467.00 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`439.25 - 440.75 cents`** | SL: **`441.02 cents`** | TP: **`427.75 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`440.10 - 447.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 650.25 cents | **Dự báo Chốt Phiên:** **`653.05 cents`** (+2.80).
*   **Thanh khoản phiên chốt:** Volume: **`30,779`** (Chênh lệch: **`+27,607`**) | OI: **`175,454`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$85.94** | **+0.00%** | Giá dầu Tăng tăng premium rủi ro địa chính trị và logistics Biển Đen, hỗ trợ giá lúa mì. |
| **USD Index** | **99.79** | **+0.00%** | DXY Tăng khiến lúa mì Mỹ đắt đỏ hơn đối với các khách hàng truyền thống như Ai Cập/Châu Á. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (647.38) > `EMA_50` (643.96).
*   **Động lượng & Dao động:** RSI (14) = **`58.60`** | ATR (14) = **`3.78`** cents | Volatility = **`6.25 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`647.00`** | S2: **`602.25`** || Kháng cự R1: **`652.50`** | R2: **`711.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWU26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`647.38 - 643.96 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`716.92 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `647.00 cents` / `602.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWU26):**
    *   *Long:* Entry: **`645.00 - 647.00 cents`** | SL: **`598.47 cents`** | TP: **`652.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`652.50 - 654.50 cents`** | SL: **`656.28 cents`** | TP: **`602.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`603.64 - 618.00 cents`**
...
| Ngày Giao Dịch | Phiên (Session) | Mở (Open) | Cao (High) | Thấp (Low) | Đóng (Close) | Thay đổi | Bias |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 10/08** | Asia 07-11 | 650.25 | 661.50 | 644.75 | **649.50** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | Asia 11-15 | 649.50 | 657.00 | 643.50 | **649.00** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 10/08** | London 15-19 | 649.00 | 662.75 | 634.25 | **651.00** | **+2.00¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | Pre-NY 19-21 | 651.00 | 664.25 | 642.75 | **652.25** | **+1.25¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Open 21-23 | 652.25 | 668.75 | 641.75 | **656.75** | **+4.50¢** 🟢 | 🟢 BULL |
| **Mon 10/08** | NY Close 23-01 | 656.75 | 664.50 | 645.75 | **658.00** | **+1.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 07-11 | 658.00 | 666.25 | 647.50 | **659.75** | **+1.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Asia 11-15 | 659.75 | 672.00 | 650.00 | **658.75** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Tue 11/08** | London 15-19 | 658.75 | 669.25 | 644.00 | **661.00** | **+2.25¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | Pre-NY 19-21 | 661.00 | 671.50 | 654.75 | **661.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Open 21-23 | 661.75 | 676.00 | 647.00 | **663.75** | **+2.00¢** 🟢 | 🟢 BULL |
| **Tue 11/08** | NY Close 23-01 | 663.75 | 670.25 | 657.00 | **664.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 07-11 | 664.00 | 674.25 | 656.00 | **664.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Asia 11-15 | 664.50 | 671.50 | 658.50 | **663.75** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | London 15-19 | 663.75 | 677.25 | 650.75 | **665.50** | **+1.75¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | Pre-NY 19-21 | 665.50 | 674.75 | 654.75 | **666.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 12/08** | NY Open 21-23 | 666.00 | 678.25 | 651.75 | **664.50** | **-1.50¢** 🔴 | 🔴 BEAR |
| **Wed 12/08** | NY Close 23-01 | 664.50 | 671.50 | 655.00 | **665.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Asia 07-11 | 665.00 | 675.50 | 657.75 | **664.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 13/08** | Asia 11-15 | 664.75 | 674.50 | 655.00 | **665.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | London 15-19 | 665.25 | 676.00 | 658.00 | **666.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | Pre-NY 19-21 | 666.00 | 672.50 | 657.50 | **666.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Open 21-23 | 666.50 | 677.50 | 654.75 | **670.00** | **+3.50¢** 🟢 | 🟢 BULL |
| **Thu 13/08** | NY Close 23-01 | 670.00 | 675.50 | 662.25 | **670.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Asia 07-11 | 670.75 | 680.00 | 664.25 | **670.00** | **-0.75¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | Asia 11-15 | 670.00 | 677.50 | 664.00 | **669.00** | **-1.00¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | London 15-19 | 669.00 | 676.00 | 655.50 | **669.75** | **+0.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | Pre-NY 19-21 | 669.75 | 679.00 | 662.50 | **669.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 14/08** | NY Open 21-23 | 669.50 | 678.00 | 655.50 | **671.25** | **+1.75¢** 🟢 | 🟢 BULL |
| **Fri 14/08** | NY Close 23-01 | 671.25 | 677.50 | 664.75 | **670.50** | **-0.75¢** 🔴 | 🔴 BEAR |
