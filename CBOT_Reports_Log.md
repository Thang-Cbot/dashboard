...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 17:01 ICT ngày 17/09/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$100.09 / thùng** | **-5.42%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
| **Chỉ số DXY (USD Index)** | **100.18** | **-0.13%** | 📉 **Trung lập - Tiêu cực (Sức ép xuất khẩu):** DXY neo cao khiến hàng Mỹ kém cạnh tranh hơn ở thị trường quốc tế, cản trở xuất khẩu ngắn hạn. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$100.09` (-5.42%)** | DXY: **`100.18` (-0.13%)** | Lúa mì CBOT: **`729.50¢` (-0.20%)**.
...
*Cập nhật tự động lúc 17:01 ICT ngày 17/09/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **17/09/2026** | **ZC** | **535.25 ¢** | **535.86 ¢ (+0.61)** | 🐂 Bullish (534.28 > 533.55) | 1.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-17092026) |
| **17/09/2026** | **ZW** | **729.50 ¢** | **731.77 ¢ (+2.27)** | 🐂 Bullish (729.20 > 728.18) | 4.50 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-17092026) |
| **17/09/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **533.25 - 534.28 cents (Canh mua vùng hỗ trợ)** | **467.46 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `536.50 cents` \| TP2: `549.75 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCZ26)** | **531.75 - 533.25 cents** | **468.47 cents (Chống quét SL tuyệt đối)** | **548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCZ26)** | **536.50 - 538.00 cents** | **538.53 cents** | **471.50 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **462.39 - 470.50 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **729.20 - 728.18 cents (Canh bán hồi kỹ thuật H1)** | **802.41 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `726.00 cents` \| TP2: `661.75 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **724.00 - 726.00 cents** | **656.81 cents** | **733.00 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **733.00 - 735.00 cents** | **737.94 cents** | **661.75 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
| **ZW** | **Long dài hạn (DCA) (ZWZ26)** | **642.00 - 661.75 cents** | Không áp dụng | Mục tiêu dài hạn | Canh mua DCA dài hạn quyết liệt (lệch pha cơ hội vĩ mô). |
| :---: | :---: | :---: | :---: | :---: | :--- |
...
*   **Giá Chốt Phiên (Close):** 535.25 cents | **Dự báo Chốt Phiên:** **`535.86 cents`** (+0.61).
*   **Thanh khoản phiên chốt:** Volume: **`17,196`** (Chênh lệch: **`-185,112`**) | OI: **`949,969`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$100.09** | **-5.42%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
| **USD Index** | **100.18** | **-0.13%** | DXY Giảm hỗ trợ xuất khẩu ngô Mỹ cạnh tranh tốt hơn. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (534.28) > `EMA_50` (533.55).
*   **Động lượng & Dao động:** RSI (14) = **`54.19`** | ATR (14) = **`2.03`** cents | Volatility = **`1.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`533.25`** | S2: **`470.50`** || Kháng cự R1: **`536.50`** | R2: **`549.75`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`533.25 - 534.28 cents (Canh mua vùng hỗ trợ)`** | SL: **`467.46 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `536.50 cents` / `549.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCZ26):**
    *   *Long:* Entry: **`531.75 - 533.25 cents`** | SL: **`468.47 cents (Chống quét SL tuyệt đối)`** | TP: **`548.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`536.50 - 538.00 cents`** | SL: **`538.53 cents`** | TP: **`471.50 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`462.39 - 470.50 cents`**
...
*   **Giá Chốt Phiên (Close):** 729.50 cents | **Dự báo Chốt Phiên:** **`731.77 cents`** (+2.27).
*   **Thanh khoản phiên chốt:** Volume: **`8,701`** (Chênh lệch: **`-62,108`**) | OI: **`259,397`** (Chênh lệch: **`+0`**)
*   **Mô hình nến H1:** **`Không phát hiện mô hình nến đặc biệt`**
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$100.09** | **-5.42%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
| **USD Index** | **100.18** | **-0.13%** | DXY Giảm kích thích nhu cầu nhập khẩu lúa mì Mỹ trên thị trường quốc tế. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (729.20) > `EMA_50` (728.18).
*   **Động lượng & Dao động:** RSI (14) = **`51.00`** | ATR (14) = **`4.94`** cents | Volatility = **`4.50 cents`**.
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`729.20 - 728.18 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`802.41 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `726.00 cents` / `661.75 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`724.00 - 726.00 cents`** | SL: **`656.81 cents`** | TP: **`733.00 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`733.00 - 735.00 cents`** | SL: **`737.94 cents`** | TP: **`661.75 cents (Thuận xu hướng giảm ngắn hạn)`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`642.00 - 661.75 cents`**
