...
*Cập nhật tự động qua `macro_tracker.py` vào lúc 15:14 ICT ngày 25/08/2026*

| Chỉ số Vĩ mô | Mức giá hiện tại | Biến động 24h | Xu hướng & Đánh giá tác động đến Nông sản |
| :--- | :---: | :---: | :--- |
| **Dầu thô Brent (BZ=F)** | **$90.27 / thùng** | **-2.06%** | 📈 **Tích cực (Bullish):** Giá dầu duy trì ở mức cao hỗ trợ mạnh mẽ cho biofuels như Ethanol (ZC) và Biodiesel (ZS). Chi phí sản xuất neo cao tạo mức sàn hỗ trợ giá. |
...
*   **Giá trị biến động 24h:** Dầu Brent: **`$90.27` (-2.06%)** | DXY: **`99.06` (+0.06%)** | Lúa mì CBOT: **`698.50¢` (+2.42%)**.
...
*Cập nhật tự động lúc 15:14 ICT ngày 25/08/2026 — Nguồn: NOAA, USDA, BOM Australia*
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **25/08/2026** | **ZC** | **517.75 ¢** | **519.54 ¢ (+1.79)** | 🐂 Bullish (517.18 > 512.55) | 0.75 cents | Rình mua (Long on dip) | [Xem Ngô (ZC)](#2-báo-cáo-mã-zc-ngô---phiên-chốt-25082026) |
| **25/08/2026** | **ZW** | **698.50 ¢** | **700.74 ¢ (+2.24)** | 🐂 Bullish (702.58 > 701.88) | 1.75 cents | Bán khống hồi (Short on rally) | [Xem Lúa mì (ZW)](#3-báo-cáo-mã-zw-lúa-mì---phiên-chốt-25082026) |
| **25/08/2026** 
---
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZC** | **Long ngắn hạn (Intraday) (ZCZ26)** | **511.50 - 517.18 cents (Canh mua vùng hỗ trợ)** | **453.73 cents (Dưới cản S2 + 1.5x ATR)** | TP1: `522.00 cents` \| TP2: `524.25 cents` | CANH LONG ngắn hạn tại vùng hỗ trợ kỹ thuật H1 khi giá điều chỉnh sâu. |
| **ZC** | **Long trung hạn (Swing) (ZCH27)** | **524.75 - 526.25 cents** | **470.96 cents (Chống quét SL tuyệt đối)** | **537.75 cents (Ăn trọn biên độ ngô ~10.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S2 Price Action cứng (biên dưới). |
| **ZC** | **Short trung hạn (Swing) (ZCH27)** | **536.50 - 538.00 cents** | **538.54 cents** | **474.00 cents** | LỆNH SHORT trung hạn ở kháng cự R2 Price Action (biên trên). |
| **ZC** | **Long dài hạn (DCA) (ZCZ26)** | **447.85 - 457.25 cents** | Không áp dụng | Mục tiêu dài hạn | Mua gom dài hạn phòng thủ La Niña và tồn kho thấp kỷ lục. |
| :---: | :---: | :---: | :---: | :---: | :--- |
| **ZW** | **Short ngắn hạn (Intraday) (ZWZ26)** | **702.58 - 701.88 cents (Canh bán hồi kỹ thuật H1)** | **733.97 cents (Trên kháng cự R2 + 1.5x ATR)** | TP1: `696.50 cents` \| TP2: `645.25 cents` | LỆNH SHORT ngắn hạn thuận xu hướng khi hồi kỹ thuật H1. |
| **ZW** | **Long trung hạn (Swing) (ZWZ26)** | **694.50 - 696.50 cents** | **641.43 cents** | **702.50 cents (Đón sóng hồi trung hạn ~14.5 giá)** | LỆNH LONG trung hạn ở hỗ trợ S1/S2 đón sóng hồi trung hạn ~14.5 giá. |
| **ZW** | **Short trung hạn (Swing) (ZWZ26)** | **702.50 - 704.50 cents** | **706.32 cents** | **645.25 cents (Thuận xu hướng giảm ngắn hạn)** | LỆNH SHORT trung hạn thuận xu hướng ngắn hạn khi chạm kháng cự R1/R2. |
...
*   **Giá Chốt Phiên (Close):** 517.75 cents | **Dự báo Chốt Phiên:** **`519.54 cents`** (+1.79).
*   **Thanh khoản phiên chốt:** Volume: **`30,597`** (Chênh lệch: **`-257,194`**) | OI: **`947,155`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$90.27** | **-2.06%** | Giá dầu Giảm làm giảm biên lợi nhuận pha chế Ethanol, tạo sức ép lên nhu cầu ngô. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (517.18) > `EMA_50` (512.55).
*   **Động lượng & Dao động:** RSI (14) = **`53.30`** | ATR (14) = **`2.35`** cents | Volatility = **`0.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`511.50`** | S2: **`457.25`** || Kháng cự R1: **`522.00`** | R2: **`524.25`**
...
*   🚀 **Long ngắn hạn (Intraday) (Ngắn hạn - HĐ ZCZ26):**
    ...
    *   *Thiết lập:* Entry: **`511.50 - 517.18 cents (Canh mua vùng hỗ trợ)`** | SL: **`453.73 cents (Dưới cản S2 + 1.5x ATR)`** | TP: `522.00 cents` / `524.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZCH27):**
    *   *Long:* Entry: **`524.75 - 526.25 cents`** | SL: **`470.96 cents (Chống quét SL tuyệt đối)`** | TP: **`537.75 cents (Ăn trọn biên độ ngô ~10.5 giá)`**.
    *   *Short:* Entry: **`536.50 - 538.00 cents`** | SL: **`538.54 cents`** | TP: **`474.00 cents`**.
*   🚀 **Long dài hạn (DCA) (Dài hạn - HĐ ZCZ26):**
    *   *Chiến lược:* Mua tích lũy phòng thủ rủi ro địa chính trị và thời tiết vĩ mô.
    *   *Thiết lập:* Entry gom: **`447.85 - 457.25 cents`**
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Mon 24/08** | Asia 07-11 | 517.75 | 521.50 | 514.50 | **518.00** | **+0.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Asia 11-15 | 518.00 | 520.75 | 514.25 | **517.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Mon 24/08** | London 15-19 | 517.50 | 520.50 | 513.50 | **518.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | Pre-NY 19-21 | 518.25 | 522.75 | 513.25 | **519.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Open 21-23 | 519.00 | 524.50 | 512.75 | **521.25** | **+2.25¢** 🟢 | 🟢 BULL |
| **Mon 24/08** | NY Close 23-01 | 521.25 | 524.25 | 517.00 | **521.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 07-11 | 521.50 | 524.75 | 515.00 | **522.25** | **+0.75¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Asia 11-15 | 522.25 | 525.25 | 517.75 | **521.75** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Tue 25/08** | London 15-19 | 521.75 | 525.75 | 516.00 | **522.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | Pre-NY 19-21 | 522.25 | 524.75 | 519.00 | **522.75** | **+0.50¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Open 21-23 | 522.75 | 526.25 | 516.75 | **523.75** | **+1.00¢** 🟢 | 🟢 BULL |
| **Tue 25/08** | NY Close 23-01 | 523.75 | 526.50 | 521.25 | **523.75** | **+0.00¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Asia 07-11 | 523.75 | 526.50 | 521.25 | **523.25** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | Asia 11-15 | 523.25 | 526.25 | 520.00 | **523.00** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Wed 26/08** | London 15-19 | 523.00 | 527.00 | 517.75 | **523.50** | **+0.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | Pre-NY 19-21 | 523.50 | 528.25 | 516.50 | **525.50** | **+2.00¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Open 21-23 | 525.50 | 533.50 | 518.50 | **527.00** | **+1.50¢** 🟢 | 🟢 BULL |
| **Wed 26/08** | NY Close 23-01 | 527.00 | 531.50 | 522.75 | **526.50** | **-0.50¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 07-11 | 526.50 | 528.75 | 523.75 | **526.25** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Thu 27/08** | Asia 11-15 | 526.25 | 528.25 | 521.75 | **526.50** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | London 15-19 | 526.50 | 530.25 | 523.75 | **527.00** | **+0.50¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | Pre-NY 19-21 | 527.00 | 530.00 | 522.50 | **527.25** | **+0.25¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Open 21-23 | 527.25 | 531.50 | 524.00 | **528.00** | **+0.75¢** 🟢 | 🟢 BULL |
| **Thu 27/08** | NY Close 23-01 | 528.00 | 531.50 | 525.75 | **528.00** | **+0.00¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Asia 07-11 | 528.00 | 531.75 | 524.50 | **527.75** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | Asia 11-15 | 527.75 | 531.25 | 524.50 | **527.50** | **-0.25¢** 🔴 | 🔴 BEAR |
| **Fri 28/08** | London 15-19 | 527.50 | 530.50 | 524.75 | **527.75** | **+0.25¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | Pre-NY 19-21 | 527.75 | 530.75 | 525.00 | **527.75** | **+0.00¢** 🟢 | 🔴 BEAR |
| **Fri 28/08** | NY Open 21-23 | 527.75 | 531.75 | 524.25 | **528.25** | **+0.50¢** 🟢 | 🟢 BULL |
| **Fri 28/08** | NY Close 23-01 | 528.25 | 532.25 | 526.50 | **528.00** | **-0.25¢** 🔴 | 🔴 BEAR |
...
*   **Giá Chốt Phiên (Close):** 698.50 cents | **Dự báo Chốt Phiên:** **`700.74 cents`** (+2.24).
*   **Thanh khoản phiên chốt:** Volume: **`6,759`** (Chênh lệch: **`-59,526`**) | OI: **`255,781`** (Chênh lệch: **`+0`**)
...
| :--- | :---: | :---: | :--- |
| **Dầu Brent** | **$90.27** | **-2.06%** | Giá dầu Giảm giảm bớt premium rủi ro địa chính trị, tạo áp lực chốt lời lúa mì. |
...
*   **Chỉ báo EMA H1:** `EMA_21` (702.58) > `EMA_50` (701.88).
*   **Động lượng & Dao động:** RSI (14) = **`41.34`** | ATR (14) = **`3.82`** cents | Volatility = **`1.75 cents`**.
*   **Vùng cản Pivot:** Hỗ trợ S1: **`696.50`** | S2: **`645.25`** || Kháng cự R1: **`702.50`** | R2: **`728.25`**
...
*   🚀 **Short ngắn hạn (Intraday) (Ngắn hạn - HĐ ZWZ26):**
    *   *Chiến lược:* Giao dịch chớp nhoáng theo biên độ H1.
    *   *Thiết lập:* Entry: **`702.58 - 701.88 cents (Canh bán hồi kỹ thuật H1)`** | SL: **`733.97 cents (Trên kháng cự R2 + 1.5x ATR)`** | TP: `696.50 cents` / `645.25 cents`.
*   🚀 **Trung hạn (Swing Trades - HĐ ZWZ26):**
    *   *Long:* Entry: **`694.50 - 696.50 cents`** | SL: **`641.43 cents`** | TP: **`702.50 cents (Đón sóng hồi trung hạn ~14.5 giá)`**.
    *   *Short:* Entry: **`702.50 - 704.50 cents`** | SL: **`706.32 cents`** | TP: **`645.25 cents (Thuận xu hướng giảm ngắn hạn)`**.
